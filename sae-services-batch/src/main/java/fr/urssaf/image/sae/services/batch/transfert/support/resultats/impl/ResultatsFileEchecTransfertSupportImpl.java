...
public class ResultatsFileEchecTransfertSupportImpl implements
    ...
    *         false sinon.
    */
   private boolean isDocumentDansListe(ConcurrentLinkedQueue<?> listIntDocs,
   ...
   private IndexReference addTagsNonIntegratedDocumentByTagName(
         String baliseName, XMLEvent xmlEvent, CaptureMasseErreur erreur,
