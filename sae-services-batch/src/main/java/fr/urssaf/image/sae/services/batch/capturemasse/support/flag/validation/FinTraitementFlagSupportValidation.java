 ...
 * {@link fr.urssaf.image.sae.services.batch.capturemasse.support.flag.FinTraitementFlagSupport}
...
public class FinTraitementFlagSupportValidation {
   ...
   private static final String WRITE_METHOD = "execution(void fr.urssaf.image.sae.services.batch.capturemasse.support.flag.FinTraitementFlagSupport.writeFinTraitementFlag(*))"
         + " && args(ecdeDirectory)";
