 ...
 * {@link fr.urssaf.image.sae.services.batch.capturemasse.support.ecde.EcdeSommaireFileSupport}
...
public class EcdeSommaireFileSupportValidation {
   ...
   private static final String CONVERT_METHOD = "execution(java.io.File fr.urssaf.image.sae.services.batch.capturemasse.support.ecde.EcdeSommaireFileSupport.convertURLtoFile(*))"
         + " && args(sommaireURL)";
