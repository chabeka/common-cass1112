...
public class SuppressionMasseSearchException extends Exception {
   ...
   *          cause mère
   */
  public SuppressionMasseSearchException(final Throwable cause) {
   ...
   *          cause mère
   */
  public SuppressionMasseSearchException(final String message) {
    super("Aucun document correspondant à la requête ne sera supprimé dans la Ged Nationale : " + message);
  }
