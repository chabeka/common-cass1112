...
public class Integration254Test {
   ...
   private static final String LOG_WARN = "La ou les métadonnées suivantes, "
         + "obligatoires lors de l'archivage, ne sont pas renseignées : "
         + "CodeOrganismeGestionnaire, CodeRND, TypeHash";
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/254/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/254/documents/doc132.PDF");
      ...
      resAttestation1 = new ClassPathResource(
            "testhautniveau/254/documents/doc70.PDF");
      fileAttestation1 = new File(repEcde, "doc70.PDF");
      FileUtils.copyURLToFile(resAttestation1.getURL(), fileAttestation1);

      resAttestation1 = new ClassPathResource(
            "testhautniveau/254/documents/doc77.PDF");
   ...
   private void checkFiles() throws IOException {
      ...
      String sha1Attendu = "e24bdbe809fb25d6fd808fae95fc58775e346ac9";
   ...
   private void checkTracabilite(UUID idTdm, URI urlSommaire) {
      ...
      traceAssertUtils
            .verifieTraceCaptureMasseDansRegTechnique(
                  ...
                  urlSommaire,
                  Arrays
                        .asList("fr.urssaf.image.sae.services.exception.capture.RequiredArchivableMetadataEx: La ou les métadonnées suivantes, obligatoires lors de l'archivage, ne sont pas renseignées : CodeOrganismeGestionnaire, CodeRND, TypeHash"));
