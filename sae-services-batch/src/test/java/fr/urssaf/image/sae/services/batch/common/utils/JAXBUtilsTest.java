...
public final class JAXBUtilsTest {
   ...
   public static <T> void marshal(JAXBElement<T> rootElement,
         OutputStream output, URL xsdSchema, boolean isSommaire)
      ...
      if (isSommaire) {
         context = JAXBContext
               .newInstance(new Class[] { fr.urssaf.image.sae.services.batch.capturemasse.modele.sommaire.ObjectFactory.class });
      } else {
         context = JAXBContext.newInstance(new Class[] { ObjectFactory.class });
      }
