...
import fr.urssaf.image.sae.batch.documents.executable.multithreading.PurgeCorbeilleRunnable;
...
public class TraitementServiceImpl implements TraitementService {
   ...
   */
  @Override
  public void deleteDocumentsCorbeille(final DeleteDocsParametres parametres) {
    final String trcPrefix = "deleteDocumentsCorbeille()";
    // -- Overture connexion dfce
    getDfceService().ouvrirConnexion();
  ...
  private void waitFinTraitementPurgeCorbeille(
                                               final DocumentsThreadExecutor poolThread) {
    poolThread.shutdown();

    // -- On attend la fin de l'execution du poolThead
    poolThread.waitFinishProcess();
