...
<%@ attribute name="objetFormulaire" required="true" type="fr.urssaf.image.sae.integration.ihmweb.formulaire.TransfertMasseFormulaire" %>
...
Etape <c:out value="${numeroEtape}"/> : Appel du service web de transfert de masse
</h4>
...
<div class="row">
	...
	<input class="btn btn-primary submit" type="submit"
	   value="Appel du service web de transfert de masse"
