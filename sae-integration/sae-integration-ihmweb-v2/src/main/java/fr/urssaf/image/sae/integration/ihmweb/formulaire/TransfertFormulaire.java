 ...
 * "transfert"<br>
 * <br>
 * Un objet de cette classe s'associe au tag "transfert.tag" (attribut
 * "objetFormulaire")
 */
public class TransfertFormulaire extends GenericForm {
    ...
    *           formulaire pere
    */
   public TransfertFormulaire(TestWsParentFormulaire parent) {
      super(parent);
   }
