...
public interface SaeServicePortType {
     ...
     * 				
     */
    @WebMethod(action = "rechercheParIterateurV2")
    @WebResult(name = "rechercheParIterateurResponse", targetNamespace = "http://www.cirtil.fr/saeService", partName = "output")
    public RechercheParIterateurResponseType rechercheParIterateurV2(

        @WebParam(partName = "input", name = "rechercheParIterateurV2", targetNamespace = "http://www.cirtil.fr/saeService")
        RechercheParIterateurV2RequestType input
    );
     ...
     * 				
     */
    @WebMethod(action = "suppressionArchivageMasse")
    @WebResult(name = "suppressionArchivageMasseResponse", targetNamespace = "http://www.cirtil.fr/saeService", partName = "output")
    public SuppressionArchivageMasseResponseType suppressionArchivageMasse(

        @WebParam(partName = "input", name = "suppressionArchivageMasse", targetNamespace = "http://www.cirtil.fr/saeService")
        SuppressionArchivageMasseRequestType input
    );
     ...
     * 				
     */
    @WebMethod(action = "suppressionMasseV2")
    @WebResult(name = "suppressionMasseResponse", targetNamespace = "http://www.cirtil.fr/saeService", partName = "output")
    public SuppressionMasseResponseType suppressionMasseV2(

        @WebParam(partName = "input", name = "suppressionMasseV2", targetNamespace = "http://www.cirtil.fr/saeService")
        SuppressionMasseV2RequestType input
    );
