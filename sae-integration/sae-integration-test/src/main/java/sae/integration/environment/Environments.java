...
public class Environments {
   ...
   static {
      ...
      GNT_INT_PAJE = new EnvironmentBuilder()
            ...
            .setEnvCode("INTEGRATION_CLIENTE_PAJE_GNT")
      ...
      GNS_INT_PAJE = new EnvironmentBuilder()
            ...
            .setEnvCode("INTEGRATION_CLIENTE_PAJE_GNS")
      ...
      GNT_INT_CESU = new EnvironmentBuilder()
            ...
            .setEnvCode("INTEGRATION_CLIENTE_CESU_GNT")
      ...
      GNS_INT_CESU = new EnvironmentBuilder()
            ...
            .setEnvCode("INTEGRATION_CLIENTE_CESU_GNS")
      ...
      GNT_INT_INTERNE = new EnvironmentBuilder()
            ...
            .setEnvCode("INTEGRATION_INTERNE_GNT")
      ...
      GNS_INT_INTERNE = new EnvironmentBuilder()
            ...
            .setEnvCode("INTEGRATION_INTERNE_GNS")
      ...
      GNT_INT_NAT_C1 = new EnvironmentBuilder()
            ...
            .setEnvCode("INTEGRATION_NATIONALE_C1_GNT")
