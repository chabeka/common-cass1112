 ...
 */
public class ModificationMasseDebugTest {

   private static final Logger LOGGER = LoggerFactory.getLogger(ModificationMasseDebugTest.class);

   @Test
   /**
    * Le traitement de masse est lancé normalement (sans debug) sur le serveur distant
    */
   public void remoteNoDebugTest() throws Exception {
      ...
      modificationOK(environnementGNT, gntService, withRemoteDebug);
   }
   ...
   @Test
   /**
    * Le sommaire est préparé et le job enregistré, mais le process du traitement de masse n'est pas lancé en automatique
    * Il faut le lancer manuellement localement, en passant l'id du job en paramètre
    */
   public void localDebugTest() throws Exception {
    ...
    * Le process du traitement de masse doit ensuite être lancé localement en mode debug
    * On vérifie ensuite que les 3 documents sont bien modifiés
    */
   private void modificationOK(final Environment environnementGNT, final SaeServicePortType gntService, final boolean withRemoteDebug) throws Exception {
