...
public class ArchivageUnitaireEnBoucleTest {
   ...
   public static void setup() {
      ...
      // environment = Environments.GNS_PREPROD;
      environment = Environments.FRONTAL_PREPROD;
      ...
      service = SaeServiceStubFactory.getServiceForInjecteur(environment.getUrl());
   }
