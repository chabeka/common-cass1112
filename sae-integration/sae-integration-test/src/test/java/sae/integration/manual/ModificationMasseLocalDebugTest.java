...
/**
 * Pour tester le debug local d'un traitement de masse
 */
public class ModificationMasseLocalDebugTest {

   private static final Logger LOGGER = LoggerFactory.getLogger(ModificationMasseLocalDebugTest.class);
    ...
    * Le process du traitement de masse n'est pas lancé : il faut le lancer manuellement localement
    */
