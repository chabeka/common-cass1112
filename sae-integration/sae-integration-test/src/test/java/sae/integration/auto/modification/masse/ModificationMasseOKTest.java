...
/**
 * Test les traitements de modification de masse
 */
public class ModificationMasseOKTest {

   private static final Logger LOGGER = LoggerFactory.getLogger(ModificationMasseOKTest.class);
