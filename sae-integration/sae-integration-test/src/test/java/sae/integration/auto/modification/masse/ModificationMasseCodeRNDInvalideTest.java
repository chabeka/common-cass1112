...
/**
 * Test un traitement de modification de masse qui tente de modifier un code RND en
 * passant une valeur qui n'existe pas dans l'ADRN
 */
public class ModificationMasseCodeRNDInvalideTest {

   private static final Logger LOGGER = LoggerFactory.getLogger(ModificationMasseCodeRNDInvalideTest.class);
    ...
    * Sur le 2ème document, on tente de modifier la méta CodeRND, mais en mettant une valeur incorrecte
    * On vérifie que les documents 1 et 3 sont bien modifiés, mais pas le 2ème
    * 
    * @throws Exception
    */
   public void modificationCodeRNDInvalide() throws Exception {
      ...
      final String inexistantRNDCode = "25.68.48";
      SoapBuilder.addMeta(modifiedMetas1, "CodeRND", inexistantRNDCode);
      ...
      try (final JobManager job = new JobManager(environnementGNT)) {
         ...
         assertThat(libErreur, containsString("Le code RND " + inexistantRNDCode + " n'est pas autorisé à l'archivage (code inexistant)"));
