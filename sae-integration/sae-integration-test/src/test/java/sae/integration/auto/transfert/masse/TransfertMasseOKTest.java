...
public class TransfertMasseOKTest {
    ...
    * On crée un sommaire avec 2 documents à transférer, et un à supprimer.
    * On vérifie que les 2 documents arrivent bien en GNS, et que le document supprimé est bien supprimé
    * 
    * @throws Exception
    */
   public void transfertOK() throws Exception {
      ...
      try (final JobManager job = new JobManager(environnementGNT)) {
         ...
         // On vérifie que le document 0 a bien été transféré, avec les bonnes métadonnées
