...
<table border="0" cellpadding="0" style="width: 100%;">
	<tr style="width: 100%;">
		...
		<td style="width: 25%; text-align: right;"><a
			href='listeTests.do?action=detail&id=<c:out value="${requestScope['id']}"/>'>Retour &agrave; la liste des tests</a><input type="hidden" name="id"
			value='<c:out value="${requestScope['id']}" />' />
		</td>
	</tr>
	<tr>
		<td colspan="2" align="right"><a href='listeTests.do'>Retour &agrave; la liste des cat&eacute;gories de tests</a></td>
	</tr>
	<tr>
