...
<%@ attribute name="objetFormulaire" required="true" type="fr.urssaf.image.sae.integration.ihmweb.formulaire.ConsultationAffichableFormulaire" %>
      ...
      <td style="width:50%;">
         <table border=0 cellspacing=3 cellpadding=3 style="width:100%;">
            ...
            <tr>
               ...
               <td>
                  <form:input path="${pathFormulaire}.nombrePages" cssStyle="width:100%;" readonly="${readonly}" />
               </td>
            </tr>
...
<input
   style="width:100%;"
   type="submit"
   value="Appel du service web de consultationAffichable"
