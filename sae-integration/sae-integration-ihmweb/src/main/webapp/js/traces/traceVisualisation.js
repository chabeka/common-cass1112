   ...
   tpl = new Ext.XTemplate(
        ...
        '<tpl for="traces">',
           ...
           '<div class="trace" style="float:left">',
              '<div class="detail" style="width:150px;">{identifiant}</div>',
              '<div class="detail" style="width:150px;">{codeEvt}</div>',
              '<div class="detail" style="width:200px;">{[new Date(values.timestamp)]}</div>',
              ...
              '</div>',
              '<div class="detail" style="width:100px;">',
                 '<tpl if="stacktrace!=null"><a href="#" onclick="javascript:getPopUp(&quot;{identifiant}&quot;);" >affichier la trace</a></tpl>',
              '</div>',              
              '<div class="detail" style="width:100px;">',                 
                 '<div><a href="#" onclick="javascript:getPopUpInfo(&quot;{identifiant}&quot;);" >afficher les infos</a></div>',
              '</div>',
              '</div>',
              '</tpl>',
           '</tpl>',
...
Ext.Ajax.request( {
   ...
   success : function(response, opts) {
     ...
     var tplTraceInstancie = createTraceTable(jsonData);
