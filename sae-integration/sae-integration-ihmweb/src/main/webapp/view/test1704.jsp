...
<form:form method="post" modelAttribute="formulaire">
	...
	<sae:recherche numeroEtape="2" pathFormulaire="rechFormulaire"
		objetFormulaire="${formulaire.rechFormulaire}" />
		
	<sae:modification numeroEtape="3"
		objetFormulaire="${formulaire.modification}"
		pathFormulaire="modification" />

	<sae:recherche numeroEtape="4" pathFormulaire="rechFormulaireApresModif"
		objetFormulaire="${formulaire.rechFormulaireApresModif}" />
