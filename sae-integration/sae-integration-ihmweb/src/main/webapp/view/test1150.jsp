...
<form:form method="post" modelAttribute="formulaire">
   ...
   <form:hidden path="etape" />
	...
	<sae:vi objetFormulaire="${formulaire.viFormulaire}"
	...
	<sae:captureMasse numeroEtape="2"
		objetFormulaire="${formulaire.captureMasse}"
		pathFormulaire="captureMasse" />


	<sae:recherche numeroEtape="3"
		objetFormulaire="${formulaire.rechercheFormulaire}"
		pathFormulaire="rechercheFormulaire" readonly="false" />
