...
<form:form method="post" modelAttribute="formulaire">
	...
	<sae:captureMasseResultat numeroEtape="2"
		...
		pathFormulaire="captureMasseResultat" />
			...
			<sae:recherche
	   numeroEtape="3"
	   pathFormulaire="rechercheFormulaire"
   ...
   />
	...
	<sae:consultation numeroEtape="4" pathFormulaire="consultationFormulaire"
		objetFormulaire="${formulaire.consultationFormulaire}" />
