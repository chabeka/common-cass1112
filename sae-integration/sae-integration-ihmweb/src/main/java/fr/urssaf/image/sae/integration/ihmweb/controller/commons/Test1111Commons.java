...
/**
 * Méthodes communes pour les tests 1111a et 1111b
 */
@Component
public class Test1111Commons {

   
   private static final String NUMERO_TEST_A = "1111a";
   private static final String NUMERO_TEST_B = "1111b";
   
   private static final String NOM_TEST_A = "Test 1111-Droits-Conformite-Consultation-ATT-AEPL";
   private static final String NOM_TEST_B = "Test 1111-Droits-Conformite-Consultation-MTOM-ATT-AEPL";
   
   private static final String VI_ISSUER = "INT_CS_ATT_AEPL";
   private static final String VI_PAGM_CAPTURE = "INT_PAGM_ATT_AEPL_ARCH";
   private static final String VI_PAGM_CONSULTATION = "INT_PAGM_ATT_AEPL_CONSULT";
   
   private static final String FICHIER_CAPTURE_UNITAIRE = "SAE_INTEGRATION/20110822/Droit-1111-Droits-Conformite-Consultation-ATT-AEPL/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf";
   
   private static final String CODE_RND = "2.3.1.1.13";
