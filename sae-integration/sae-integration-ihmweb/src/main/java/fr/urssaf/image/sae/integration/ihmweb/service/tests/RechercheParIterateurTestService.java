...
public class RechercheParIterateurTestService {
   ...
   private RechercheParIterateurResponse appelWsOpRechercheParIterateur(
      ...
      RechercheParIterateurResponse response = null;
      ...
      try {
         ...
         response = service.rechercheParIterateur(paramsService);
    ...
    *           le formulaire
    */
   public final void appelWsOpRechercheParIterateurTestLibre(
         String urlServiceWeb, RechercheParIterateurFormulaire formulaire) {

      appelWsOpRechercheParIterateurTestLibre(urlServiceWeb, formulaire, null);
   }
   ...
   public final void appelWsOpRechercheParIterateurTestLibre(
      ...
      appelWsOpRechercheParIterateur(urlServiceWeb, ViStyle.VI_OK, viParams,
    ...
    * @return la réponse de l'opération "recherche avec nb de résultats", ou
    *         null si une exception s'est produite
    */
   // public final RechercheParIterateurResponse
   // appelWsOpRechercheAvecNbResReponseCorrecteAttendue(
    ...
    *         null si une exception s'est produite
    */
   // public final RechercheNbResResponse
   // appelWsOpRechercheAvecNbResReponseCorrecteAttendue(
   // String urlServiceWeb, RechercheFormulaire formulaire,
   // Integer nbResultatsAttendus, Boolean flagResultatsTronquesAttendu,
   ...
   // appelWsOpRechercheAvecNbResultats(urlServiceWeb,
   ...
   private void wsVerifieRetour(ResultatTest resultatTest,
      ...
      if ((response != null) && (response.getRechercheNbResResponse() != null)) {
         ...
         } else if ((nbResultatsAttendus == null || nbResultatsAttendus == 0)
               && resultats == null) {
    ...
    *           attendue
    */
   // public final void appelWsOpRechercheAvecNbResSoapFault(String
   // urlServiceWeb,
   ...
   //
   // // Appel de la méthode "générique" de test
   // appelWsOpRechercheAvecNbResultats(urlServiceWeb, viStyle, null,
   // formulaire, listener,
   // null);
   // }

   /**
    * Test d'appel à l'opération "recherche avec nb res" du service web
    * SaeService.<br>
    * <br>
    * On s'attend à obtenir une SoapFault.
    * 
   ...
   //
   // // Appel de la méthode "générique" de test
   // appelWsOpRechercheAvecNbResultats(urlServiceWeb, viStyle, viParams,
   // formulaire, listener,
   // null);
   // }
