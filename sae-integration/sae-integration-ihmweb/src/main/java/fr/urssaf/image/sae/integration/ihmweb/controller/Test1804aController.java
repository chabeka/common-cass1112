...
/**
 * 1804-1-FCP-CU-OK-Identification-NonValidation-Strict-FMT354-OK
 */
@Controller
@RequestMapping(value = "test1804a")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1804aController extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/FCP-1804-1-FCP-CU-OK-Identification-NonValidation-Strict-FMT354-OK/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1804-1-FCP-CU-OK-Identification-NonValidation-Strict-FMT354-OK");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1804-1-FCP-CU-OK-Identification-NonValidation-Strict-FMT354-OK");
