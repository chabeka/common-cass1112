...
/**
 * 1206-PKI-NAT-Verification-OK-Nom-Certificat-OK-Flag-OK
 */
@Controller
@RequestMapping(value = "test1206")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1206Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1206-PKI-NAT-Verification-OK-Nom-Certificat-OK-Flag-OK/");
   }
   ...
   protected final TestFormulaireDrCmRe getFormulairePourGet() {
      ...
      viForm.setIssuer("CS_DEV_TOUTES_ACTIONS_NAT");
      viForm.setRecipient(SaeIntegrationConstantes.VI_DEFAULT_RECIPIENT);
      viForm.setAudience(SaeIntegrationConstantes.VI_DEFAULT_AUDIENCE);
      PagmList pagmList = new PagmList();
      viForm.setPagms(pagmList);
      pagmList.add("PAGM_TOUTES_ACTIONS_NAT");
      viForm
            .setIdCertif(SaeIntegrationConstantes.PKI_IGC_GAMMEIMAGE);
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination",
         "Test 1206-PKI-NAT-Verification-OK-Nom-Certificat-OK-Flag-OK");
