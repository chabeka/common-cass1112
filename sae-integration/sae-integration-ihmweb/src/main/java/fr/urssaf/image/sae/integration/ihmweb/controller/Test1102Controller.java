...
import fr.urssaf.image.sae.integration.ihmweb.formulaire.Test1102Formulaire;
...
public class Test1102Controller extends
      AbstractTestWsController<Test1102Formulaire> {
    ...
    */
   @Override
   protected final Test1102Formulaire getFormulairePourGet() {

      Test1102Formulaire formulaire = new Test1102Formulaire();
    ...
    */
   @Override
   protected final void doPost(Test1102Formulaire formulaire) {
