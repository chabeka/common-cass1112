...
/**
 * 2202-IsolationDonnees-CS-Avec-Domaine-Cotisant
 */
@Controller
@RequestMapping(value = "test2202")
public class Test2202Controller extends AbstractTestWsController<TestWSIsolationDonneesFormulaire> {
    ...
    */
   private final String metaDenomination = "Test 2203-IsolationDonnees-CS-Avec-Domaine-Cotisant-" + date;
   ...
   protected final TestWSIsolationDonneesFormulaire getFormulairePourGet() {
      ...
      pagmList.add("INT_PAGM_ATT_VIGI_D_COTISANT_ARCH_UNIT");
      
      viForm.setPagms(pagmList);
      viForm.setIssuer("INT_CS_ATT_VIGI_D_COTISANT");
