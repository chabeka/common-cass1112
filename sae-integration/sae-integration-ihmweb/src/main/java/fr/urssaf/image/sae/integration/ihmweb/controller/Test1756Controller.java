...
/**
 * 1756-Ged-Technique-KO-Ajout-Valeur-Meta-Vide-DFCE-KO
 */
@Controller
@RequestMapping(value = "test1756")
public class Test1756Controller extends
   ...
   protected final Test1755Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1756-Ged-Technique-KO-Ajout-Valeur-Meta-Vide-DFCE-KO/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1756-Ged-Technique-KO-Ajout-Valeur-Meta-Vide-DFCE-KO");
