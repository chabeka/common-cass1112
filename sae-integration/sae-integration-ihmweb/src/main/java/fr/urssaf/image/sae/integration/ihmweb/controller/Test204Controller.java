...
/**
 * 204-CaptureMasse-OK-Tor-10-repertoire-anti-slash
 */
@Controller
...
public class Test204Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/CaptureMasse-204-CaptureMasse-OK-Tor-10-repertoire-anti-slash/");
   }
   ...
   private void etape4Consultation(TestStockageMasseAllFormulaire formulaire) {
      ...
      valeursMetaAttendus.add(new MetadonneeValeur("Denomination","Test 204-CaptureMasse-OK-Tor-10-repertoire-anti-slash"));
