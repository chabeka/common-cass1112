...
/**
 * 1204-PKI-CS-ANCIEN-SYSTEME-VI-OK
 */
@Controller
@RequestMapping(value = "test1204")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1204Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1204-PKI-CS-ANCIEN-SYSTEME-VI-OK/");
   }
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination",
         "Test 1204-PKI-CS-ANCIEN-SYSTEME-VI-OK");
