...
/**
 * 1824-2-FCP-CM-OK-Identification-Validation-Monitor-FMT354-KO
 */
@Controller
@RequestMapping(value = "test1824b")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1824bController extends
   ...
   protected String getNomVue() {
      return "testFcpCmReCoTrace";
   }

   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1824-2-FCP-CM-OK-Identification-Validation-Monitor-FMT354-KO/");
   }
   ...
   protected final TestFormulaireFcpCmReCo getFormulairePourGet() {
      ...
      pagmList.add("INT_PAGM_FORMAT_FMT_354_TTM_ARCH_MASSE");
