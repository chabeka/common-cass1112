 ...
 */
@Controller
@RequestMapping(value = "test2353")
public class Test2353Controller extends AbstractTestWsController<TestWsRechercheParIterateurFormulaire> {
   ...
   protected final TestWsRechercheParIterateurFormulaire getFormulairePourGet() {
      ...
      metaVal.setValeur("Test 2353-Recherche-Iterateur-KO-MetadonneeConsultInexistante");
