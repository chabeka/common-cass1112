...
/**
 * 1825-1-FCP-CM-OK-Identification-Validation-Strict-FMT354-OK
 */
@Controller
@RequestMapping(value = "test1825a")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1825aController extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1825-1-FCP-CM-OK-Identification-Validation-Strict-FMT354-OK/");
   }
