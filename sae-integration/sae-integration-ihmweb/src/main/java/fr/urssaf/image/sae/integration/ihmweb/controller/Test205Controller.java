...
public class Test205Controller extends
   ...
   private void etape4Consultation(TestStockageMasseAllFormulaire formulaire) {
      ...
      valeursMetaAttendus.add(new MetadonneeValeur("Denomination","Test 205-CaptureMasse-OK-Tor-3-repertoire-anti-slash-meme-doc"));
