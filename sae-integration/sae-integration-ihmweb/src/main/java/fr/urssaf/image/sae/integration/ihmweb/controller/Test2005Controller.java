...
/**
 * 2005-ConsultationAffichable-OK-page-debut-1-30-pages 
 */
@Controller
@RequestMapping(value = "test2005")
public class Test2005Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2005-consultationAffichable-OK-page-debut-1-30-pages");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         formConsultEtp2.setNombrePages(30);
      }
