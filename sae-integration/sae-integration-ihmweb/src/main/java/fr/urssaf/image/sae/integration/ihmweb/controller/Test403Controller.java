...
public class Test403Controller extends
      AbstractTestWsController<Test403Formulaire> {
   ...
   protected final Test403Formulaire getFormulairePourGet() {
      ...
      formCapture
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Consultation-403-Consultation-OK-TouteMetadonneeConsultable/documents/doc1.PDF"));
   ...
   private void etape1captureUnitaire(Test403Formulaire formulaire) {
   ...
   private void etape2consultation(Test403Formulaire formulaire) {
      ...
      // Les valeurs des métadonnées attendues (uniquement pour les valeurs
      // prédictibles)
      List<MetadonneeValeur> metaAttendues = new ArrayList<MetadonneeValeur>();
      metaAttendues.add(new MetadonneeValeur("ApplicationProductrice",
            "ADELAIDE"));
      metaAttendues.add(new MetadonneeValeur("ApplicationTraitement",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("CodeActivite", "3"));
      metaAttendues.add(new MetadonneeValeur("CodeCategorieV2",
            StringUtils.EMPTY));
      ...
      metaAttendues.add(new MetadonneeValeur("CodeProduitV2", "QD75A"));
      metaAttendues.add(new MetadonneeValeur("CodeTraitementV2", "RD75.L02"));
      ...
      // metaAttendues.add(new MetadonneeValeur("DateDebutConservation", ""));
      // // => non prédictible
      // metaAttendues.add(new MetadonneeValeur("DateFinConservation", "")); //
      // => non prédictible
      metaAttendues
      ...
      metaAttendues.add(new MetadonneeValeur("IdTraitementMasse",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("JetonDePreuve",
            "1A2B3C4D5E6F7G8H9I"));
      metaAttendues.add(new MetadonneeValeur("NbPages", "2"));
      metaAttendues
            .add(new MetadonneeValeur("NniEmployeur", StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("NomFichier", "doc1.PDF"));
      metaAttendues.add(new MetadonneeValeur("NumeroCompteExterne",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("NumeroCompteInterne",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("NumeroIntControle",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("NumeroPersonne",
            StringUtils.EMPTY));
      metaAttendues
            .add(new MetadonneeValeur("NumeroRecours", StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("NumeroStructure",
            StringUtils.EMPTY));
      ...
      metaAttendues.add(new MetadonneeValeur("RIBA", "99/39405R00006204505"));
      metaAttendues.add(new MetadonneeValeur("ReferenceDocumentaire",
            "2131179500003"));
      metaAttendues.add(new MetadonneeValeur("RUM",
            "24534Y8465435413Y012312356690123"));
      ...
      metaAttendues.add(new MetadonneeValeur("SiteAcquisition",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("TailleFichier", "56587"));
      metaAttendues.add(new MetadonneeValeur("Titre",
            "Attestation de vigilance"));
      metaAttendues.add(new MetadonneeValeur("TracabilitePostArchivage",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("TracabilitePreArchivage",
            StringUtils.EMPTY));
      metaAttendues.add(new MetadonneeValeur("TypeHash", "SHA-1"));
      metaAttendues.add(new MetadonneeValeur("VersionRND", getTestConfig()
            .getVersionRND()));
