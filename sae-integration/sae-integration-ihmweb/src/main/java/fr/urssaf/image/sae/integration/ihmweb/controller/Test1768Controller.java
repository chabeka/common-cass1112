...
/**
 *    1768-Ged-Technique-KO-Modification-Valeur-CodeRND-Inconnu
 */
@Controller
@RequestMapping(value = "test1768")
public class Test1768Controller extends
   ...
   protected final Test1755Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1768-Ged-Technique-KO-Modification-Valeur-CodeRND-Inconnu/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1768-Ged-Technique-KO-Modification-Valeur-CodeRND-Inconnu");
      ...
      metaModif.add("CodeRND", "0.0.0.0.0");
   ...
   private void modification(String urlWebService,
      ...
      getModificationTestService().appelWsOpModificationSoapFault(
            ...
            "sae_ModificationCodeRndInterdit",
