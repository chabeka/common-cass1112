...
/**
 * 2058-ConsultationAffichable-KO-MetadonneeNonConsultable-MTOM
 */
@Controller
@RequestMapping(value = "test2058")
public class Test2058Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2058-ConsultationAffichable-KO-MetadonneeNonConsultable-MTOM");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         codesMetas.add("StartPage");
         codesMetas.add("VersionNumber");
