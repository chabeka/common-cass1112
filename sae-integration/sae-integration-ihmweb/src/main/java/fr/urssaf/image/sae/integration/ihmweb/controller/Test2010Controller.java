...
/**
 * 2010-ConsultationAffichable-OK-nb-pages-sup 
 */
@Controller
@RequestMapping(value = "test2010")
public class Test2010Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2010-ConsultationAffichable-OK-nb-pages-sup");
