...
/**
 * 1132-Droits-Conformite-All-PRMD-DYNA
 */
@Controller
@RequestMapping(value = "test1132")
public class Test1132Controller extends
   ...
   protected final TestFormulaireAll getFormulairePourGet() {
      ...
      formCapture
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1132-Droits-Conformite-All-PRMD-DYNA/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf"));
      ...
      formCapture.getMetadonnees().add("Denomination",
            "Test 1132-Droits-Conformite-All-PRMD-DYNA");
      formCapture.getMetadonnees().add("NumeroRecours", "11");
      formCapture.getMetadonnees().modifieValeurMeta("DateCreation", "2007-04-01");
      ...
      formCaptMasseDecl
            .setUrlSommaire(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1132-Droits-Conformite-All-PRMD-DYNA/sommaire.xml"));
