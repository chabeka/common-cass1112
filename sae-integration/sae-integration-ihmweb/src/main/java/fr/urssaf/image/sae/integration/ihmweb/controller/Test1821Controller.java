...
/**
 * 1821-FCP-CM-OK-NonIdentification-NonValidation-FMT354
 */
@Controller
@RequestMapping(value = "test1821")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1821Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1821-FCP-CM-OK-NonIdentification-NonValidation-FMT354/");
   }
   ...
   protected final TestFormulaireFcpCmReCo getFormulairePourGet() {
      ...
      pagmList.add("INT_PAGM_FORMAT_FMT_354_FF_ARCH_MASSE");
