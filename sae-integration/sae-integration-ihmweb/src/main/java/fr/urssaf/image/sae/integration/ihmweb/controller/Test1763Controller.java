...
/**
 *    1763-Ged-Technique-KO-Modification-Meta-Inexistante
 */
@Controller
@RequestMapping(value = "test1763")
public class Test1763Controller extends
   ...
   protected final Test1701Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1763-Ged-Technique-KO-Modification-Meta-Inexistante/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination","Test 1763-Ged-Technique-KO-Modification-Meta-Inexistante");
      ...
      codeMetadonneeList.add("NbPages");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1763-Ged-Technique-KO-Modification-Meta-Inexistante");
