...
/**
 * 1813-FCP-CM-OK-NonIdentification-Validation-Monitor-FMT354
 */
@Controller
@RequestMapping(value = "test1813")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1813Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1813-FCP-CM-OK-NonIdentification-Validation-Monitor-FMT354/");
   }
   ...
   protected final TestFormulaireFcpCmReCo getFormulairePourGet() {
      ...
      viForm.setIssuer("INT_CS_FORMAT_FMT_354_FTM");
      viForm.setRecipient(SaeIntegrationConstantes.VI_DEFAULT_RECIPIENT);
      viForm.setAudience(SaeIntegrationConstantes.VI_DEFAULT_AUDIENCE);
      PagmList pagmList = new PagmList();
      viForm.setPagms(pagmList);
      pagmList.add("INT_PAGM_FORMAT_FMT_354_FTM_ARCH_MASSE");
