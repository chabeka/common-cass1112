 ...
 */
@Controller
@RequestMapping(value = "test1901")
public class Test1901Controller extends
   ...
   protected final TestWsTransfertFormulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination", "Test 1901-Transfert-OK");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1901-Transfert-OK");
