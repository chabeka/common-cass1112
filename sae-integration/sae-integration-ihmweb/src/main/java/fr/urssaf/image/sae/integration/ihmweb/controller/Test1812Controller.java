...
/**
 * 1812-FCP-CM-OK-Identification-NonValidation-FMT354
 */
@Controller
@RequestMapping(value = "test1812")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1812Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1812-FCP-CM-OK-Identification-NonValidation-FMT354/");
   }
