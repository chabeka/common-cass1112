...
/**
 * 1805-1-FCP-CU-OK-Identification-Validation-Monitor-FMT354-OK
 */
@Controller
@RequestMapping(value = "test1805a")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1805aController extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/FCP-1805-1-FCP-CU-OK-Identification-Validation-Monitor-FMT354-OK/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1805-1-FCP-CU-OK-Identification-Validation-Monitor-FMT354-OK");
      metadonnees.add("FormatFichier", "fmt/354");
      metadonnees.add("Hash", "eb7a1c266654812b8c417be6958c165cf0628bf8");
      ...
      viForm.setIssuer("INT_CS_FORMAT_FMT_354_TTM");
      viForm.setRecipient(SaeIntegrationConstantes.VI_DEFAULT_RECIPIENT);
      viForm.setAudience(SaeIntegrationConstantes.VI_DEFAULT_AUDIENCE);
      PagmList pagmList = new PagmList();
      viForm.setPagms(pagmList);
      pagmList.add("INT_PAGM_FORMAT_FMT_354_TTM_ARCH_UNIT");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1805-1-FCP-CU-OK-Identification-Validation-Monitor-FMT354-OK");
