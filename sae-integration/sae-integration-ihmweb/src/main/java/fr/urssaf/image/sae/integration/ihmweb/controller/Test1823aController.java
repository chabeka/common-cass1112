...
/**
 * 1823-1-FCP-CM-OK-Identification-NonValidation-Strict-FMT354-OK
 */
@Controller
@RequestMapping(value = "test1823a")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1823aController extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1823-1-FCP-CM-OK-Identification-NonValidation-Strict-FMT354-OK/");
   }
