...
/**
 * 1822-2-FCP-CM-OK-Identification-NonValidation-Monitor-FMT354-KO
 */
@Controller
@RequestMapping(value = "test1822b")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1822bController extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1822-2-FCP-CM-OK-Identification-NonValidation-Monitor-FMT354-KO/");
   }
