...
/**
 * 2052-ConsultationAffichable-KO-no-page-sup-nb-page
 */
@Controller
@RequestMapping(value = "test2052")
public class Test2052Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2052-ConsultationAffichable-KO-no-page-sup-nb-page");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         formConsultEtp2.setNumeroPage(50);
