...
/**
 * 286-CaptureMasse-Pile-KO-Reste-Reserve
 */
@Controller
@RequestMapping(value = "test286")
public class Test286Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/CaptureMasse-286-CaptureMasse-Pile-KO-Reste-Reserve/");
   }
