...
/**
 *    1758-Ged-Technique-KO-Suppression-Valeur-Meta-DFCE-KO
 */
@Controller
@RequestMapping(value = "test1758")
public class Test1758Controller extends
   ...
   protected final Test1755Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1758-Ged-Technique-KO-Suppression-Valeur-Meta-DFCE-KO/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1758-Ged-Technique-KO-Suppression-Valeur-Meta-DFCE-KO");
