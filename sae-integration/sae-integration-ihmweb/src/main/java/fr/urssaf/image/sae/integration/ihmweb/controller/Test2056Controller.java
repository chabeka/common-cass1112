...
/**
 * 2056-ConsultationAffichable-KO-MetadonneeConsultInexistante-MTOM
 */
@Controller
@RequestMapping(value = "test2056")
public class Test2056Controller extends AbstractTestWsController<Test2001Formulaire> {
