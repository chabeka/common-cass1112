...
/**
 * 218-CaptureMasse-OK-RND-Mandat-SEPA
 */
@Controller
@RequestMapping(value = "test218")
public class Test218Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/CaptureMasse-218-CaptureMasse-OK-MANDAT-SEPA/");
   }
   ...
   private void etape4Consultation(TestStockageMasseAllFormulaire formulaire) {
      ...
      valeursMetaAttendus.add(new MetadonneeValeur("Denomination","Test 218-CaptureMasse-OK-MANDAT-SEPA"));
