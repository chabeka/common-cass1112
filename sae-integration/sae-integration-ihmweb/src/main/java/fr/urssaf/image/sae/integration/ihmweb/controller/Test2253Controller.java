...
/**
 * 2253-IsolationDonnees-CS-Meta-DomaineRH
 */
@Controller
@RequestMapping(value = "test2253")
public class Test2253Controller extends AbstractTestWsController<TestWSIsolationDonneesFormulaire> {
   ...
   protected final TestWSIsolationDonneesFormulaire getFormulairePourGet() {
      ...
      metadonnees.add("DomaineRH", "true");
   ...
   private void captureUnitaireAppelWs(TestWSIsolationDonneesFormulaire formulaire) {
      ...
      getCaptureUnitaireTestService().appelWsOpCaptureUnitaireSoapFault(
            urlWs, formCapture, ViStyle.VI_OK, viForm, soapFaultAttendu, new String[]{"DomaineRH"});
   }
}
