...
/**
 * Méthodes communes pour les tests 1131a et 1131b
 */
@Component
public class Test1131Commons {

   
   private static final String NUMERO_TEST_A = "1131a";
   private static final String NUMERO_TEST_B = "1131b";
   
   private static final String NOM_TEST_A = "Test 1131-Droits-Conformite-Consultation-PRMD-DYNA";
   private static final String NOM_TEST_B = "Test 1131-Droits-Conformite-Consultation-MTOM-PRMD-DYNA";
   
   private static final String VI_ISSUER = "INT_CS_PRMD_DYNA_CODERND";
   private static final String VI_PAGM_CAPTURE = "INT_PAGM_PRMD_DYNA_CODERND_ARCH";
   private static final String VI_PAGM_CONSULTATION = "INT_PAGM_PRMD_DYNA_CODERND_CONSULT";
   
   private static final String FICHIER_CAPTURE_UNITAIRE = "SAE_INTEGRATION/20110822/Droit-1131-Droits-Conformite-Consultation-PRMD-DYNA/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf";
