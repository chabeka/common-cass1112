...
/**
 * 1824-1-FCP-CM-OK-Identification-Validation-Monitor-FMT354-OK
 */
@Controller
@RequestMapping(value = "test1824a")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1824aController extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1824-1-FCP-CM-OK-Identification-Validation-Monitor-FMT354-OK/");
   }
   ...
   private void etape4consultation(TestFormulaireFcpCmReCo formulaire) {
      ...
      metaAttendues.add(new MetadonneeValeur("Hash", "eb7a1c266654812b8c417be6958c165cf0628bf8"));
