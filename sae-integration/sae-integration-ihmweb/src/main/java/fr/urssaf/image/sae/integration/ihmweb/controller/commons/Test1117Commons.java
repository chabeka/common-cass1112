...
/**
 * Méthodes communes pour les tests 1117a et 1117b
 */
@Component
public class Test1117Commons {

   
   private static final String NUMERO_TEST_A = "1117a";
   private static final String NUMERO_TEST_B = "1117b";
   
   private static final String NOM_TEST_A = "Test 1117-Droits-Conformite-Consultation-UNE_META";
   private static final String NOM_TEST_B = "Test 1117-Droits-Conformite-Consultation-MTOM-UNE_META";
   
   private static final String VI_ISSUER = "INT_CS_UNE_META";
   private static final String VI_PAGM_CAPTURE = "INT_PAGM_UNE_META_ARCH_UNIT";
   private static final String VI_PAGM_CONSULTATION = "INT_PAGM_UNE_META_CONSULT";
   
   private static final String FICHIER_CAPTURE_UNITAIRE = "SAE_INTEGRATION/20110822/Droit-1117-Droits-Conformite-Consultation-UNE-META/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf";
