...
/**
 * 1951-T-KO-STOCKAGE-GNS-KO
 */
@Controller
@RequestMapping(value = "test1951")
public class Test1951Controller extends
   ...
   protected final TestWsTransfertFormulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination", "Test 1951-Transfert-KO-STOCKAGE-GNS-KO");
   ...
   protected final void doPost(TestWsTransfertFormulaire formulaire) {
      ...
      if ("1".equals(etape)) {
         ...
         rechercheGNS(formulaire.getUrlServiceWeb(), formulaire.getRechercheGns());
      }
   }
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1951-Transfert-KO-STOCKAGE-GNS-KO");
