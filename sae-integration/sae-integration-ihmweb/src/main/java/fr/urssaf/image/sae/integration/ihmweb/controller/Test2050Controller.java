...
/**
 * 2050-ConsultationAffichable-KO-fichier-non-convertible
 */
@Controller
@RequestMapping(value = "test2050")
public class Test2050Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      formCapture.setUrlEcde(
            getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/ConsulationAffichable-2050-CA-KO-fichier-non-convertible/documents/doc1.doc"));
      ...
      metadonnees.add("Denomination","Test 2050-consultationAffichable-KO-fichier-non-convertible");
      metadonnees.add("FormatFichier","fmt/353");
      metadonnees.add("Hash","60877f6342296493a545298dd40890e216b41eac");
