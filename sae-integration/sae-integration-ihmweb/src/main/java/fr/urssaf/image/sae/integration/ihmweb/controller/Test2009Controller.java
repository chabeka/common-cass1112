...
/**
 * 2009-ConsultationAffichable-OK-nb-pages 
 */
@Controller
@RequestMapping(value = "test2009")
public class Test2009Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2009-ConsultationAffichable-OK-nb-pages");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         formConsultEtp2.setNombrePages(43);
      }
