...
/**
 * 255-CaptureMasse-KO-Tor-MetadonneeInconnue
 */
@Controller
@RequestMapping(value = "test2652")
public class Test2652Controller extends AbstractTestWsController<TestStockageMasseAllFormulaire> {
   /**
    * 
    */
   ...
   private String getDebutUrlEcde() {
      return getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/IdGed-2652-IdGed-ArchivageMasse-KO-IdGed/");
   }
   ...
   private void etape2captureMasseResultats(
      ...
      erreurType
      .setLibelle("Une erreur interne à l'application est survenue lors de la "
            + "capture du document doc1.PDF. Détails : La métadonnée SM_UUID "
      ...
      getCaptureMasseTestService().testResultatsTdmReponseKOAttendue(
            formulaire, WAITED_COUNT, documentType, 9);
