...
/**
 * 2252-IsolationDonnees-CS-Meta-DomaineComptable
 */
@Controller
@RequestMapping(value = "test2252")
public class Test2252Controller extends AbstractTestWsController<TestWSIsolationDonneesFormulaire> {
   ...
   protected final TestWSIsolationDonneesFormulaire getFormulairePourGet() {
      ...
      metadonnees.add("DomaineComptable", "true");
   ...
   private void captureUnitaireAppelWs(TestWSIsolationDonneesFormulaire formulaire) {
      ...
      getCaptureUnitaireTestService().appelWsOpCaptureUnitaireSoapFault(
            urlWs, formCapture, ViStyle.VI_OK, viForm, soapFaultAttendu, new String[]{"DomaineComptable"});
   }
}
