...
/**
 * 2204-IsolationDonnees-CS-Avec-Domaine-RH
 */
@Controller
@RequestMapping(value = "test2204")
public class Test2204Controller extends AbstractTestWsController<TestWSIsolationDonneesFormulaire> {
    ...
    */
   private final String metaDenomination = "Test 2204-IsolationDonnees-CS-Avec-Domaine-RH-" + date;
   ...
   protected final TestWSIsolationDonneesFormulaire getFormulairePourGet() {
      ...
      String reqLucene = "Denomination:\"" + metaDenomination+"\" AND DomaineRH:true";
      ...
      pagmList.add("INT_PAGM_ATT_VIGI_D_RH_ARCH_UNIT");
      
      viForm.setPagms(pagmList);
      viForm.setIssuer("INT_CS_ATT_VIGI_D_RH");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("DomaineRH", "true");
