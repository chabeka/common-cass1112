...
/**
 * 1118-Droits-Conformite-All-UNE-META
 */
@Controller
@RequestMapping(value = "test1118")
public class Test1118Controller extends
   ...
   protected final TestFormulaireAll getFormulairePourGet() {
      ...
      formCapture
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1118-Droits-Conformite-All-UNE-META/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf"));
      ...
      formCapture.getMetadonnees().add("Denomination",
            "Test 1118-Droits-Conformite-All-UNE-META");
      ...
      formCaptMasseDecl
            .setUrlSommaire(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1118-Droits-Conformite-All-UNE-META/sommaire.xml"));
