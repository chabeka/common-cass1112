...
/**
 * 1151-Droits-Archivage-Unitaire-KO-PAGM-Inconnu
 */
@Controller
@RequestMapping(value = "test1151")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1151Controller extends
   ...
   protected final Test1151Formulaire getFormulairePourGet() {
      ...
      captureUnitaire
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1151-Droits-Archivage-Unitaire-KO-PAGM-Inconnu/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf"));
      ...
      metadonnees.add(new MetadonneeValeur("Denomination", "Test 1151-Droits-Archivage-Unitaire-KO-PAGM-Inconnu"));
   ...
   private void etape1CaptureUnitaireAppelWs(String urlWebService,
      ...
      getCaptureUnitaireTestService().appelWsOpCaptureUnitaireSoapFault(
            ...
            formulaire.getParent().getViFormulaire(), "vi_InvalidPagm",
            result);
