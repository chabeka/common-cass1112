...
/**
 * 2060-ConsultationAffichable-KO-no-page-0-MTOM 
 */
@Controller
@RequestMapping(value = "test2060")
public class Test2060Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2060-ConsultationAffichable-KO-premiere-page-0-MTOM");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         formConsultEtp2.setNumeroPage(0);
