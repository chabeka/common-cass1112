...
/**
 * 2505-Note-Transfert-Plusieurs-Notes-OK
 */
@Controller
@RequestMapping(value = "test2505")
public class Test2505Controller extends
...
//   protected final TestWsTransfertFormulaire getFormulairePourGet() {
     ...
     TestWsTransfertFormulaire formulaire = new TestWsTransfertFormulaire();
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Note-2505-Note-Transfert-Plusieurs-Notes-OK/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination", "Test 2505-Note-Transfert-Plusieurs-Notes-OK");
      metadonnees.add("FormatFichier", "fmt/354");
      metadonnees.add("Hash", "a2f93f1f121ebba0faef2c0596f2f126eacae77b");
      metadonnees.add("NbPages", "2");
      metadonnees.add("Note", "Note classique test 2505");      
   ...
   private void etape1captureUnitaireAppelWs(TestWsTransfertFormulaire formulaire) {
    ...
    if (!TestStatusEnum.Echec.equals(resultatTest.getStatus())) {
     // initialise l'UUID du document pour l'étape 2
       ...
       formAjoutNote.setNote("Note en plus test 2505");
   ...
   private void etape2ajoutNoteAppelWS(TestWsTransfertFormulaire formulaire) {
      ...
      // initialise l'UUID du document pour l'étape 3 de transert
      TransfertFormulaire formTransfert = formulaire.getTransfert();
      formTransfert.setIdDocument(UUID.fromString(ajoutNoteForm.getIdArchivage()));
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 2505-Note-Transfert-Plusieurs-Notes-OK");
