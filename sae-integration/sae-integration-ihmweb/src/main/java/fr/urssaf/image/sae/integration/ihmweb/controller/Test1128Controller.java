...
/**
 * 1128-Droits-Conformite-Archivage-Masse-PRMD-DYNA
 */
@Controller
@RequestMapping(value = "test1128")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1128Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/Droit-1128-Droits-Conformite-Archivage-Masse-PRMD-DYNA/");
   }
   ...
   protected final TestFormulaireDrCmRe getFormulairePourGet() {
      ...
      pagmList.add("INT_PAGM_PRMD_DYNA_CODERND_ARCH_MASSE");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination",
            "Test 1128-Droits-Conformite-Archivage-Masse-PRMD-DYNA");
