...
/**
 * 2250-IsolationDonnees-CS-Plusieurs-Domaines
 */
@Controller
@RequestMapping(value = "test2250")
public class Test2250Controller extends AbstractTestWsController<TestWSIsolationDonneesFormulaire> {
   ...
   protected final TestWSIsolationDonneesFormulaire getFormulairePourGet() {
      ...
      pagmList.add("INT_PAGM_ATT_VIGI_D3_ALL");
      
      viForm.setPagms(pagmList);
      viForm.setIssuer("INT_CS_ATT_VIGI_D3");
   ...
   private void captureUnitaireAppelWs(TestWSIsolationDonneesFormulaire formulaire) {
      ...
      final String soapFaultAttendu = "sae_PagmIncompatibles";
      
      //-- Lance le test
      getCaptureUnitaireTestService().appelWsOpCaptureUnitaireSoapFault(
            urlWs, formCapture, ViStyle.VI_OK, viForm, soapFaultAttendu, new String[]{""});
   }
}
