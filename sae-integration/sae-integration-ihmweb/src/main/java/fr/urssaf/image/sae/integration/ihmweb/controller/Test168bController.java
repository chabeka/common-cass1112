...
/**
 * 168-CaptureUnitaire-KO-CodeRND-Inconnu-DFCE-avec-MTOM
 */
@Controller
@RequestMapping(value = "test168b")
public class Test168bController extends
   ...
   protected final TestWsCaptureUnitaireFormulaire getFormulairePourGet() {
      ...
      formCapture.setModeCapture(ModeArchivageUnitaireEnum.archivageUnitairePJContenuAvecMtom);
      ...
      metadonnees.add(new MetadonneeValeur("Denomination","Test 168-CaptureUnitaire-KO-CodeRND-Inconnu-DFCE-avec-MTOM"));
