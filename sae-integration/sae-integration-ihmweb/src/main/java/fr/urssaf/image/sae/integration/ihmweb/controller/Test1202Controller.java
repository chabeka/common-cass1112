...
/**
 * 1202-PKI-Verification-OK-Nom-Certificat-KO-Flag-OK
 */
@Controller
@RequestMapping(value = "test1202")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1202Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1202-PKI-Verification-OK-Nom-Certificat-KO-Flag-OK/");
   }
   ...
   protected final TestFormulaireDrCmRe getFormulairePourGet() {
      ...
      viForm.setIssuer("INT_CS_ATT_VIGI_PKI_TRUE_TEST2");
      viForm.setRecipient(SaeIntegrationConstantes.VI_DEFAULT_RECIPIENT);
      viForm.setAudience(SaeIntegrationConstantes.VI_DEFAULT_AUDIENCE);
      PagmList pagmList = new PagmList();
      viForm.setPagms(pagmList);
      pagmList.add("INT_PAGM_ATT_VIGI_PKI_TRUE_TEST2_ARCH_MASSE");
      viForm
   ...
   protected final void doPost(TestFormulaireDrCmRe formulaire) {
      ...
      if ("1".equals(etape)) {
         ...
         formulaire.getViFormulaire().setIssuer("CS_DEV_TOUTES_ACTIONS");
         PagmList pagmList = new PagmList();
   ...
   private void etape1captureMasseAppelWs(String urlWebService,
      ...
      String[] arguments = { "Le nom du certificat utilisé pour signer le VI ne correspond pas au nom défini dans le Contrat de Service" };
