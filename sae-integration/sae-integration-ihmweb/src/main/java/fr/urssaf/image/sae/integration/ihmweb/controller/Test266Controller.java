...
public class Test266Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/CaptureMasse-266-CaptureMasse-KO-AutreModeToutOuRien/");
   }
