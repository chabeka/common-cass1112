...
public class Test262Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/CaptureMasse-262-CaptureMasse-KO-Tor-FichierInexistant/");
   }
