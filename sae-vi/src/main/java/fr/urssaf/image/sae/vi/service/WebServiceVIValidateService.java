...
public interface WebServiceVIValidateService {
  ...
  void validateCertificates(ServiceContract contract, SignatureVerificationResult result)
   ...
   /**
   * Permet d'ajouter un log dans un fichier de log spécialement configuré
   * lorsque les certificats des clients approchent de la date de fin de validité
   * 
   * @param result
   *          certificats utilisés
   * @param contract
