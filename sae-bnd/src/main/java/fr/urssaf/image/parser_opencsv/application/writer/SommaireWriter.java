...
public class SommaireWriter {
   ...
   public SommaireWriter() {
      super();
   }

   public SommaireWriter(final String sommairePath) throws IOException {
      this();
    ...
    * @throws XMLStreamException
    */
   public void addSommaireHeader() throws XMLStreamException {
