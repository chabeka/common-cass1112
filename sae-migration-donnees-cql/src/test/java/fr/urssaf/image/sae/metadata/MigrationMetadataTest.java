...
public class MigrationMetadataTest {
  ...
  public void migrationFromThriftToCql() {
    try {
      ...
      migrationMetadata.migrationFromThriftToCql(javers);
      ...
      MigrationMetadataTest.LOGGER.debug("exception=" + ex);
  ...
  public void migrationFromCqlTothrift() {
    ...
    populateTableCql();
    migrationMetadata.migrationFromCqlTothrift(javers);
    final List<MetadataReference> listThrift = supportThrift.findAll();
    final List<MetadataReference> listCql = supportCql.findAll();
  ...
  public void diffAddTest() {
    ...
    final List<MetadataReference> listCql = supportCql.findAll();
    final Diff diff = migrationMetadata.compareMetadatas(listThrift, listCql, javers);
