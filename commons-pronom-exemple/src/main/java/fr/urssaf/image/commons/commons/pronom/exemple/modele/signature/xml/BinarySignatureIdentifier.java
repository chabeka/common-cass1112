...
import fr.urssaf.image.commons.commons.pronom.exemple.exception.SignatureParseException;
...
/**
 * Pour identifier de facon binaire les signature d'un fichier.
 */
public final class BinarySignatureIdentifier implements PronomCore {
