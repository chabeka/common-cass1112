/* Generated By:JavaCC: Do not edit this line. ExtractorTokenManager.java */
package net.padaf.preflight.javacc.extractor;
import java.io.*;
import java.util.ArrayList;
import java.util.List;

/** Token Manager. */
public class ExtractorTokenManager implements ExtractorConstants
{
         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 0:
                  ...
                  break;
               case 1:
                  if ((0x7e000000000000L & l) != 0L && kind > 6)
                     kind = 6;
                  break;
               case 2:
                  if (curChar == 49)
...
void MoreLexicalActions()
{
   ...
   switch(jjmatchedKind)
   {
      case 9 :
         ...
         jjimageLen = 0;
                                aTrailer.append(image.charAt(image.length()-1));
         break;
      default :
         break;
   }
   ...
   switch(jjmatchedKind)
   {
      case 8 :
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                                      aTrailer = new StringBuilder(50);
         break;
      case 10 :
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
                                                 lTrailers.add(aTrailer.toString()); aTrailer = null;
         break;
      default :
         break;
   }
