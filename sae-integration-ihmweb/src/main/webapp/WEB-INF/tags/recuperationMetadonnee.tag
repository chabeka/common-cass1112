...
<%@ attribute name="objetFormulaire" required="true" type="fr.urssaf.image.sae.integration.ihmweb.formulaire.RecuperationMetadonneeFormulaire" %>
...
Etape <c:out value="${numeroEtape}"/> : Appel du service web de recuperation des metadonnees</h4>
...
<input
   ...
   type="submit"
   value="Appel du service web de recuperation des metadonnees"
