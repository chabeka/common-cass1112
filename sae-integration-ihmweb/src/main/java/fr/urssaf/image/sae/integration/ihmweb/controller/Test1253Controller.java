...
/**
 * 1253-PKI-Verification-KO-Nom-Certificat-VI-OK-Flag-OK
 */
@Controller
@RequestMapping(value = "test1253")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1253Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1253-PKI-Verification-KO-Nom-Certificat-VI-OK-Flag-OK/");
   }
