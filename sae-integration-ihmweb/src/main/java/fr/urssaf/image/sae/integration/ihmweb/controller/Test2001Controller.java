...
/**
 * 2001-ConsultationAffichable-OK-avec-mtom 
 */
@Controller
@RequestMapping(value = "test2001")
public class Test2001Controller extends AbstractTestWsController<Test2001Formulaire> {
...
//      Le SHA-1 évolue à chaque convertion du fichier de TIF en PDF, la date change donc le sha-1 aussi
