 ...
 */
@Controller
@RequestMapping(value = "test2351")
public class Test2351Controller extends AbstractTestWsController<TestWsRechercheParIterateurFormulaire> {
   ...
   protected final TestWsRechercheParIterateurFormulaire getFormulairePourGet() {
      ...
      metaVal.setCode("Toto");
      metaVal.setValeur("Test 2351-Recherche-Iterateur-KO-MetadonneeRechercheInexistante");
