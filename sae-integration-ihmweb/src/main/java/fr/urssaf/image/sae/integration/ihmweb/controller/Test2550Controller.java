...
import fr.urssaf.image.sae.integration.ihmweb.formulaire.Test2550Formulaire;
...
/**
 * 2550-Note-Ajout-Cassandra-KO
 */
@Controller
@RequestMapping(value = "test2550")
public class Test2550Controller extends AbstractTestWsController<Test2550Formulaire> {
    ...
    */
   @Override
   protected final Test2550Formulaire getFormulairePourGet() {
      
      Test2550Formulaire formulaire = new Test2550Formulaire();
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Note-2550-Note-Ajout-Cassandra-KO/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination", "Test 2550-Ajout-Cassandra-KO");
    ...
    */
   @Override
   protected final void doPost(Test2550Formulaire formulaire) {
   ...
   private void etape1captureUnitaireAppelWs(Test2550Formulaire formulaire) {
    ...
    if (!TestStatusEnum.Echec.equals(resultatTest.getStatus())) {
     // initialise l'UUID du document pour l'étape 2
       ...
       formAjoutNote.setNote("Note classique test 2550");
   ...
   private void etape2ajoutNoteAppelWS(Test2550Formulaire formulaire) {
      ...
      String idSoapFault = "sae_ErreurInterneAjoutNote";
 // CAS OK     getAjoutNoteTestService().appelWsOpAjoutNoteTestLibre(
          //  urlServiceWeb, null, ajoutNoteForm);
       getAjoutNoteTestService().appelWsOpAjoutNoteTestSoapFault(
            urlServiceWeb, ajoutNoteForm, ViStyle.VI_OK, null, idSoapFault, null);
   ...
   private void etape3consultationAppelWS(Test2550Formulaire formulaire) throws IntegrationException {
