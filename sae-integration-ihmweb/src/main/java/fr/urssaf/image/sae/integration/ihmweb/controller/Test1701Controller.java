...
/**
 * 1701-Ged-Technique-OK-Suppression-Valeur-Meta
 */
@Controller
@RequestMapping(value = "test1701")
public class Test1701Controller extends
   ...
   protected final Test1701Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1701-Ged-Technique-OK-Suppression-Valeur-Meta/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1701-Ged-Technique-OK-Meta-Retrait-Valeur");
