...
/**
 * 2203-IsolationDonnees-CS-Avec-Domaine-Comptable
 */
@Controller
@RequestMapping(value = "test2203")
public class Test2203Controller extends AbstractTestWsController<TestWSIsolationDonneesFormulaire> {
    ...
    */
   private final String metaDenomination = "Test 2203-IsolationDonnees-CS-Avec-Domaine-Comptable-" + date;
   ...
   protected final TestWSIsolationDonneesFormulaire getFormulairePourGet() {
      ...
      String reqLucene = "Denomination:\"" + metaDenomination+"\" AND DomaineComptable:true";
      ...
      pagmList.add("INT_PAGM_ATT_VIGI_D_COMPTABLE_ARCH_UNIT");
      
      viForm.setPagms(pagmList);
      viForm.setIssuer("INT_CS_ATT_VIGI_D_COMPTABLE");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("DomaineCotisant", "");
      valeursAttendues.add("DomaineTechnique", "");
      valeursAttendues.add("DomaineComptable", "true");
