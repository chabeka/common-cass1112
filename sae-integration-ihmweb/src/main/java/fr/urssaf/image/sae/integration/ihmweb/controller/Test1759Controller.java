...
/**
 * 1759-Ged-Technique-KO-AMS-Meme-Meta
 */
@Controller
@RequestMapping(value = "test1759")
public class Test1759Controller extends
   ...
   protected final Test1701Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1759-Ged-Technique-KO-AMS-Meme-Meta/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1759-Ged-Technique-KO-AMS-Meme-Meta");
