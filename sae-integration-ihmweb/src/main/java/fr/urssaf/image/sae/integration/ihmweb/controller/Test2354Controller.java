 ...
 */
@Controller
@RequestMapping(value = "test2354")
public class Test2354Controller extends AbstractTestWsController<TestWsRechercheParIterateurFormulaire> {
   ...
   protected final TestWsRechercheParIterateurFormulaire getFormulairePourGet() {
      ...
      metaVal.setValeur("Test 2354-Recherche-Iterateur-KO-MetadonneeConsultNonAutorisee");
