...
/**
 * 1252-PKI-Verification-KO-Nom-Certificat-CS-OK-Flag-KO
 */
@Controller
@RequestMapping(value = "test1252")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1252Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1252-PKI-Verification-KO-Nom-Certificat-CS-OK-Flag-KO/");
   }
   ...
   protected final TestFormulaireDrCmRe getFormulairePourGet() {
      ...
      viForm.setIssuer("INT_CS_ATT_VIGI_PKI_FALSE_TEST4");
      viForm.setRecipient(SaeIntegrationConstantes.VI_DEFAULT_RECIPIENT);
      viForm.setAudience(SaeIntegrationConstantes.VI_DEFAULT_AUDIENCE);
      PagmList pagmList = new PagmList();
      viForm.setPagms(pagmList);
      pagmList.add("INT_PAGM_ATT_VIGI_PKI_FALSE_TEST4_ARCH_MASSE");
      viForm
