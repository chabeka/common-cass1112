...
/**
 * 278-CaptureMasse-Pile-KO-CassandraKO
 */
@Controller
@RequestMapping(value = "test278")
public class Test278Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/CaptureMasse-278-CaptureMasse-Pile-KO-CassandraKO/");
   }
