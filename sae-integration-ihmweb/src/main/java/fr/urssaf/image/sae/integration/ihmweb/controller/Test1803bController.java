 ...
 */
@Controller
@RequestMapping(value = "test1803b")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1803bController extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/FCP-1803-2-FCP-CU-OK-Identification-NonValidation-Monitor-FMT354-KO/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1803-2-FCP-CU-OK-Identification-NonValidation-Monitor-FMT354-KO");
      metadonnees.add("FormatFichier", "fmt/354");
      metadonnees.add("Hash", "00546ce53ea521c48e902251257d3a6a4fd7fad7");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1803-2-FCP-CU-OK-Identification-NonValidation-Monitor-FMT354-KO");
