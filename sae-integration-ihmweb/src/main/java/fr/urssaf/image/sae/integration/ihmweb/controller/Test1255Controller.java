...
/**
 * 1255-PKI-CS-ANCIEN-SYSTEME-VI-KO
 */
@Controller
@RequestMapping(value = "test1255")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1255Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1255-PKI-CS-ANCIEN-SYSTEME-VI-KO/");
   }
