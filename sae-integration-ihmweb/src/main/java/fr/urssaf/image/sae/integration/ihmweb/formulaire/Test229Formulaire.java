 ...
 */
public class Test229Formulaire extends TestWsParentFormulaire {
   ...
   private List<ConsultationFormulaire> consultFormulaireList = new ArrayList<ConsultationFormulaire>();

   private final ComptagesTdmFormulaire comptagesFormulaire = new ComptagesTdmFormulaire(this);



   public Test229Formulaire() {
      super();
    ...
    */
   public final List<ConsultationFormulaire> getConsultFormulaireList() {
      return this.consultFormulaireList;
   }
   
   public void setConsultFormulaireList(List<ConsultationFormulaire> consult){
      this.consultFormulaireList = consult;
   }
