...
import fr.urssaf.image.sae.integration.ihmweb.formulaire.SoapFormulaire;
...
import fr.urssaf.image.sae.integration.ihmweb.saeservice.modele.SaeServiceStub.RecuperationMetadonnees;
import fr.urssaf.image.sae.integration.ihmweb.saeservice.modele.SaeServiceStub.RecuperationMetadonneesResponse;
...
@Service
public class RecuperationMetadonneeTestService {
   ...
   private RecuperationMetadonneeResultat appelWsOpRecuperationMetadonnee(String urlServiceWeb,
         ViStyle viStyle, ViFormulaire viParams,
         RecuperationMetadonneeFormulaire formulaire, WsTestListener wsListener) {

      // Initialise le résultat
      RecuperationMetadonneeResultat result = null;
      //formulaire.setParent(new TestWsParentFormulaire());
      //formulaire.getParent().setSoapFormulaire(new SoapFormulaire());
      ...
      SaeServiceLogUtils.logAppelRecuperationMetadonnee(log, formulaire);
...
//         RecuperationMetadonnee paramsService = SaeServiceObjectFactory
//                  .buildConsultationGNTGNSRequest(formulaire.getIdArchivage(),
//                        formulaire.getCodeMetadonnees());

            // Appel du service web
         
         RecuperationMetadonnees metaRequest = new RecuperationMetadonnees();
         RecuperationMetadonneesResponse response = service
                  .recuperationMetadonnees(metaRequest);

            // Transtypage de l'objet de la couche ws vers l'objet du modèle
            result = fromRecuperationMetadonneeAncienService(response);
         ...
         log
               .appendLogLn("Détails de la réponse obtenue de l'opération \"recuperationMetadonnee\" :");
         SaeServiceLogUtils.logResultatRecuperationMetadonnee(resultatTest, result);
    ...
    *           le formulaire
    */
   public final void appelWsOpRecuperationMetadonneeTestLibre(String urlServiceWeb,
         RecuperationMetadonneeFormulaire formulaire) {

      appelWsOpRecuperationMetadonneeTestLibre(urlServiceWeb, formulaire, null);
    ...
    */
   public final void appelWsOpRecuperationMetadonneeTestLibre(String urlServiceWeb,
         RecuperationMetadonneeFormulaire formulaire, ViFormulaire viParams) {
      ...
      appelWsOpRecuperationMetadonnee(urlServiceWeb, ViStyle.VI_OK, viParams, formulaire,
            testLibre);
    ...
    *           attendue
    */
   public final void appelWsOpRecuperationMetadonneeSoapFault(String urlServiceWeb,
         RecuperationMetadonneeFormulaire formulaire, ViFormulaire viParams) {
      ...
      // Appel de la méthode "générique" de test
      appelWsOpRecuperationMetadonnee(urlServiceWeb, ViStyle.VI_OK, viParams, formulaire, testLibre);
    ...
    */
   public final void appelWsOpRecuperationMetadonneeSoapFault(String urlServiceWeb,
         RecuperationMetadonneeFormulaire formulaire, ViStyle viStyle,
      ...
      // Appel de la méthode "générique" de test
      appelWsOpRecuperationMetadonnee(urlServiceWeb, viStyle, null, formulaire, testAuth);
    ...
    */
   public final void appelWsOpRecuperationMetadonneeSoapFault(String urlServiceWeb,
         RecuperationMetadonneeFormulaire formulaire, ViStyle viStyle, ViFormulaire viParams,
         String idSoapFaultAttendu, final Object[] argsMsgSoapFault) {
      ...
      // Appel de la méthode "générique" de test
      appelWsOpRecuperationMetadonnee(urlServiceWeb, viStyle, viParams, formulaire, testAuth);

   }

//   private void wsVerifieRetour(RecuperationMetadonneeFormulaire formulaire,
//         RecuperationMetadonneeResultat response, String sha1attendu,
...
//   }
    ...
    *         s'est produite
    */
   public final RecuperationMetadonneeResultat appelWsOpRecuperationMetadonneeReponseCorrecteAttendue(
         String urlServiceWeb, RecuperationMetadonneeFormulaire formulaire,
         String sha1attendu) {

      return appelWsOpRecuperationMetadonneeReponseCorrecteAttendue(urlServiceWeb,
   ...
   public final RecuperationMetadonneeResultat appelWsOpRecuperationMetadonneeReponseCorrecteAttendue(
      ...
      // Appel de la méthode "générique" de test
      RecuperationMetadonneeResultat response = appelWsOpRecuperationMetadonnee(urlServiceWeb,
   ...
   private RecuperationMetadonneeResultat fromRecuperationMetadonneeAncienService(
         RecuperationMetadonneesResponse response) {

      // Création de l'objet résultat
      RecuperationMetadonneeResultat result = new RecuperationMetadonneeResultat();


      // Extrait les métadonnées
      ListeMetadonneeDispoType metadonnees = response.getRecuperationMetadonneesResponse()
            .getMetadonnees();
...
//   private RecuperationMetadonneeResultat fromRecuperationMetadonneeNouveauService(
//         RecuperationMetadonneesResponse response) {
//
//      // Création de l'objet résultat
...
//      DataHandler contenu = response.getConsultationGNTGNSResponse().getContenu();
//      result.setContenu(contenu);
//
//      // Extrait les métadonnées
//      ListeMetadonneeType metadonnees = response.getConsultationGNTGNSResponse()
//            .getMetadonnees();
//      result.setMetadonnees(metadonnees);
//
//      // Renvoie du résultat
...
//         List<MetadonneeValeur> metaAttendues, ListeMetadonneeDispoType metaObtenues) {
//
//      boolean testKo = false;
//
//      ResultatTestLog log = resultatTest.getLog();
