...
/**
 * 1825-2-FCP-CM-OK-Identification-Validation-Strict-FMT354-KO
 */
@Controller
@RequestMapping(value = "test1825b")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1825bController extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/FCP-1825-2-FCP-CM-OK-Identification-Validation-Strict-FMT354-KO/");
   }
   ...
   protected final TestFormulaireFcpCmReCo getFormulairePourGet() {
      ...
      pagmList.add("INT_PAGM_FORMAT_FMT_354_TTS_ARCH_MASSE");
