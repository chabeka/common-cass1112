...
/**
 * 2653-IdGed-Transfert-KO-IdGed-Existant
 */
@Controller
@RequestMapping(value = "test2653")
public class Test2653Controller extends
   ...
   protected final TestWsTransfertFormulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/IdGed-2653-IdGed-Transfert-KO-IdGed-Existant/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination", "Test 2653-IdGed-Transfert-KO-IdGed-Existant");
      metadonnees.add("FormatFichier", "fmt/354");
      metadonnees.add("Hash", "a2f93f1f121ebba0faef2c0596f2f126eacae77b");
      metadonnees.add("IdGed", "f8325fc9-b12a-44ed-8072-8344d2460000");
...
//      pagmList.add("INT_PAGM_CS_TRANSFERT_TRANSFERT");
   ...
   private void rechercheGNT(String urlServiceWeb, RechercheFormulaire formulaire) {
      ...
      RechercheResponse response = getRechercheTestService()
            .appelWsOpRechercheReponseCorrecteAttendue(urlServiceWeb,
                  formulaire, nbResAttendus, false, null);
   ...
   private void rechercheGNS(String urlServiceWeb, RechercheFormulaire formulaire) {
      ...
      //-- Appel de la méthode de test
      getRechercheTestService().appelWsOpRechercheReponseCorrecteAttendue(urlServiceWeb,
            formulaire, nbResAttendus, false, null);
   }
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 2653-IdGed-Transfert-KO-IdGed-Existant");
      valeursAttendues.add("DureeConservation", "1095");
      valeursAttendues.add("IdGed", "f8325fc9-b12a-44ed-8072-8344d2460000");
