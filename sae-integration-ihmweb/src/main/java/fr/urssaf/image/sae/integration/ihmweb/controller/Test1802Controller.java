...
/**
 * 1802-FCP-CU-OK-NonIdentification-NonValidation-FMT354-OK
 */
@Controller
@RequestMapping(value = "test1802")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1802Controller extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/FCP-1802-FCP-CU-OK-NonIdentification-NonValidation-FMT354/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1802-FCP-CU-OK-NonIdentification-NonValidation-FMT354");
      metadonnees.add("FormatFichier", "fmt/354");
      metadonnees.add("Hash", "108acacac3cafc1efe4178b49cef5d9ff767bb7b");
      ...
      viForm.setIssuer("INT_CS_FORMAT_FMT_354_FF");
      viForm.setRecipient(SaeIntegrationConstantes.VI_DEFAULT_RECIPIENT);
      viForm.setAudience(SaeIntegrationConstantes.VI_DEFAULT_AUDIENCE);
      PagmList pagmList = new PagmList();
      viForm.setPagms(pagmList);
      pagmList.add("INT_PAGM_FORMAT_FMT_354_FF_ARCH_UNIT");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1802-FCP-CU-OK-NonIdentification-NonValidation-FMT354");
