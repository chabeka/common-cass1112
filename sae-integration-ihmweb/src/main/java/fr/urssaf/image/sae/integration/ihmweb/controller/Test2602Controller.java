...
/**
 * 2602-IdGed-Transfert-OK-IdGed
 */
@Controller
@RequestMapping(value = "test2602")
public class Test2602Controller extends
   ...
   protected final TestWsTransfertFormulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/IdGed-2602-IdGed-Transfert-OK-IdGed/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination", "Test 2602-IdGed-Transfert-OK-IdGed");
...
//      pagmList.add("PAGM_TOUTES_ACTIONS");
   ...
   private void rechercheGNS(String urlServiceWeb, RechercheFormulaire formulaire) {
      ...
      ViFormulaire viParams = formulaire.getParent().getViFormulaire();
      
      // Appel de la méthode de test
      RechercheResponse response = getRechercheTestService()
         .appelWsOpRechercheReponseCorrecteAttendue(
            urlServiceWeb, formulaire, nbResultatsAttendus, false, null, viParams);
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 2602-IdGed-Transfert-OK-IdGed");
