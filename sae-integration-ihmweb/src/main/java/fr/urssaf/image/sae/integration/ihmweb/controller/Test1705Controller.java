...
import fr.urssaf.image.sae.integration.ihmweb.formulaire.Test1705Formulaire;
...
/**
 * 1705-Ged-Technique-OK-Suppression-Valeur-Meta-Vide
 */
@Controller
@RequestMapping(value = "test1705")
public class Test1705Controller extends
      AbstractTestWsController<Test1705Formulaire> {
    ...
    */
   @Override
   protected final Test1705Formulaire getFormulairePourGet() {

      
      Test1705Formulaire formulaire = new Test1705Formulaire();
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1705-Ged-Technique-OK-Suppression-Valeur-Meta-vide/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1705-Ged-Technique-OK-Suppression-Valeur-Meta-Vide");
    ...
    */
   @Override
   protected final void doPost(Test1705Formulaire formulaire) {
   ...
   private void etape1captureUnitaireAppelWs(Test1705Formulaire formulaire) {
