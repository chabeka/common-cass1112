...
import fr.urssaf.image.sae.integration.ihmweb.formulaire.Test2503Formulaire;
 ...
 */
@Controller
@RequestMapping(value = "test2503")
public class Test2503Controller extends AbstractTestWsController<Test2503Formulaire> {
    ...
    */
   @Override
   protected final Test2503Formulaire getFormulairePourGet() {
      
      Test2503Formulaire formulaire = new Test2503Formulaire();
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Note-2503-Note-Ajout-En-Plus-OK/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination", "Test 2503-Note-Ajout-En-Plus-OK");
      metadonnees.add("FormatFichier", "fmt/354");
      metadonnees.add("Hash", "a2f93f1f121ebba0faef2c0596f2f126eacae77b");
      metadonnees.add("NbPages", "2");
      metadonnees.add("Note", "Note classique test 2503");
    ...
    */
   @Override
   protected final void doPost(Test2503Formulaire formulaire) {
      
      String etape = formulaire.getEtape();
      if (etape.equals("1")){
         //-- Appel du ws de capture unitaire
         etape1captureUnitaireAppelWs(formulaire);
      } else
      {  if (("2".equals(etape))){
            //-- Appel au ws d'ajout d'une note
   ...
   private void etape1captureUnitaireAppelWs(Test2503Formulaire formulaire) {
    ...
    if (!TestStatusEnum.Echec.equals(resultatTest.getStatus())) {
     // initialise l'UUID du document pour l'étape 2
       ...
       formAjoutNote.setNote("Test 2503-Note-Ajout-En-Plus-OK");
   ...
   private void etape2ajoutNoteAppelWS(Test2503Formulaire formulaire) {
   ...
   private void etape3consultationAppelWS(Test2503Formulaire formulaire) throws IntegrationException {
      ...
      if(metaObtenues.size() > 0){
         ...
         String laNote = "{\"contenu\":\"Note classique test 2503\",\"dateCreation\":\"2015-09-14 13:16:22\",\"auteur\":\"_ADMIN\"}";
         try {
            Note note = mapper.readValue(laNote, Note.class);
            
            if(note.getContenu().equals("Note classique test 2503")){
