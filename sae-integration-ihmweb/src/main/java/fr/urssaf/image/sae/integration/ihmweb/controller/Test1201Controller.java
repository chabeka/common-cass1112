...
/**
 * 1201-PKI-Verification-OK-Nom-Certificat-OK-Flag-OK
 */
@Controller
@RequestMapping(value = "test1201")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1201Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1201-PKI-Verification-OK-Nom-Certificat-OK-Flag-OK/");
   }
   ...
   protected final TestFormulaireDrCmRe getFormulairePourGet() {
      ...
      viForm.setIssuer("INT_CS_ATT_VIGI_PKI_TRUE_TEST1");
      viForm.setRecipient(SaeIntegrationConstantes.VI_DEFAULT_RECIPIENT);
      viForm.setAudience(SaeIntegrationConstantes.VI_DEFAULT_AUDIENCE);
      PagmList pagmList = new PagmList();
      viForm.setPagms(pagmList);
      pagmList.add("INT_PAGM_ATT_VIGI_PKI_TRUE_TEST1_ARCH_MASSE");
      viForm
   ...
   protected final void doPost(TestFormulaireDrCmRe formulaire) {
      ...
      if ("1".equals(etape)) {
         ...
         PagmList pagmList = new PagmList();
         pagmList.add("INT_PAGM_ATT_VIGI_PKI_TRUE_TEST1_ALL");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination",
         "Test 1201-PKI-Verification-OK-Nom-Certificat-OK-Flag-OK");
