...
/**
 * 2012-ConsultationAffichable-OK-num-page-et-nb-pages-sup
 */
@Controller
@RequestMapping(value = "test2012")
public class Test2012Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2012-ConsultationAffichable-OK-num-page-et-nb-pages-sup");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         formConsultEtp2.setNumeroPage(10);
