...
/**
 * 1806-1-FCP-CU-OK-Identification-Validation-Strict -FMT354-OK
 */
@Controller
@RequestMapping(value = "test1806a")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1806aController extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/FCP-1806-1-FCP-CU-OK-Identification-Validation-Strict-FMT354-OK/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1806-1-FCP-CU-OK-Identification-Validation-Strict-FMT354-OK");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1806-1-FCP-CU-OK-Identification-Validation-Strict-FMT354-OK");
