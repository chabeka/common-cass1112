...
/**
 * 1762-Ged-Technique-KO-MS-Meme-Meta
 */
@Controller
@RequestMapping(value = "test1762")
public class Test1762Controller extends
   ...
   protected final Test1701Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1762-Ged-Technique-KO-MS-Meme-Meta/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination","Test 1762-Ged-Technique-KO-MS-Meme-Meta");
