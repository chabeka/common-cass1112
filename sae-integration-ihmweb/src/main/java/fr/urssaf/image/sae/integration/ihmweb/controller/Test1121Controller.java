...
/**
 * 1121-Droits-Conformite-Archivage-PLUSIEURS-META
 */
@Controller
@RequestMapping(value = "test1121")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1121Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/Droit-1121-Droits-Conformite-Archivage-PLUSIEURS-META/");
   }
   ...
   protected final TestFormulaireDrCuCmRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1121-Droits-Conformite-Archivage-PLUSIEURS-META/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf"));
      ...
      captUnit.getMetadonnees().add("Denomination",
            "Test 1121-Droits-Conformite-Archivage-PLUSIEURS-META");
