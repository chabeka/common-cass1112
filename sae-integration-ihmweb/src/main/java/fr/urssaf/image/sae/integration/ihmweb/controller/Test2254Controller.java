...
/**
 * 2254-IsolationDonnees-CS-Meta-DomaineTechnique
 */
@Controller
@RequestMapping(value = "test2254")
public class Test2254Controller extends AbstractTestWsController<TestWSIsolationDonneesFormulaire> {
   ...
   protected final TestWSIsolationDonneesFormulaire getFormulairePourGet() {
      ...
      metadonnees.add("CodeRND", "7.7.8.8.1");
      metadonnees.add("DomaineTechnique", "true");
   ...
   private void captureUnitaireAppelWs(TestWSIsolationDonneesFormulaire formulaire) {
      ...
      getCaptureUnitaireTestService().appelWsOpCaptureUnitaireSoapFault(
            urlWs, formCapture, ViStyle.VI_OK, viForm, soapFaultAttendu, new String[]{"DomaineTechnique"});
   }
}
