...
/**
 * 2014-ConsultationAffichable-OK- pages-negatif-sup-nb-pages
 */
@Controller
@RequestMapping(value = "test2014")
public class Test2014Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2014-ConsultationAffichable-OK- pages-negatif-sup-nb-pages");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         //formConsultEtp2.setNumeroPage();
         formConsultEtp2.setNombrePages(-50);
      }
