...
/**
 *    1761-Ged-Technique-KO-AS-Meme-Meta
 */
@Controller
@RequestMapping(value = "test1761")
public class Test1761Controller extends
   ...
   protected final Test1701Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1761-Ged-Technique-KO-AS-Meme-Meta/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination","Test 1761-Ged-Technique-KO-AS-Meme-Meta");
