...
/**
 * 1127-Droits-Conformite-Archivage-Unitaire-PRMD-DYNA
 */
@Controller
@RequestMapping(value = "test1127")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1127Controller extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1127-Droits-Conformite-Archivage-Unitaire-PRMD-DYNA/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf"));
      ...
      captUnit.getMetadonnees().add("Denomination",
            "Test 1127-Droits-Conformite-Archivage-Unitaire-PRMD-DYNA");
      ...
      pagmList.add("INT_PAGM_PRMD_DYNA_CODERND_ARCH_UNIT");
