...
/**
 * 1113-Droits-Conformite-Archivage-Unitaire-UNE-META
 */
@Controller
@RequestMapping(value = "test1113")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1113Controller extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Droit-1113-Droits-Conformite-Archivage-Unitaire-UNE-META/documents/ADELPF_710_PSNV211157BPCA1L0000.pdf"));
      ...
      captUnit.getMetadonnees().add("Denomination",
            "Test 1113-Droits-Conformite-Archivage-Unitaire-UNE-META");
