...
/**
 * 1251-PKI-Verification-KO-Nom-Certificat-CS-OK-Flag-OK
 */
@Controller
@RequestMapping(value = "test1251")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1251Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService()
            .construitUrlEcde(
                  "SAE_INTEGRATION/20110822/PKI-1251-PKI-Verification-KO-Nom-Certificat-CS-OK-Flag-OK/");
   }
