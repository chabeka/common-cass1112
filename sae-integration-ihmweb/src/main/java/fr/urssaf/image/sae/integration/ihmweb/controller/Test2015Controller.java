...
/**
 * 2015-ConsultationAffichable-OK-no_page-1-nb-page-negatif
 */
@Controller
@RequestMapping(value = "test2015")
public class Test2015Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2015-ConsultationAffichable-OK-no_page-1-nb-page-negatif");
