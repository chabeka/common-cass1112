...
/**
 *    1757-Ged-Technique-KO-Modification-Valeur-Meta-DFCE-KO
 */
@Controller
@RequestMapping(value = "test1757")
public class Test1757Controller extends
   ...
   protected final Test1755Formulaire getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/Ged-Technique-1757-Ged-Technique-KO-Modification-Valeur-Meta-DFCE-KO/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1757-Ged-Technique-KO-Modification-Valeur-Meta-DFCE-KO");
