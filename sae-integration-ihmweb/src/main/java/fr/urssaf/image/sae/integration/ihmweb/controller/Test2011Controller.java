...
/**
 * 2011-ConsultationAffichable-OK-page-34-nb-pages-10
 */
@Controller
@RequestMapping(value = "test2011")
public class Test2011Controller extends AbstractTestWsController<Test2001Formulaire> {
   ...
   protected final Test2001Formulaire getFormulairePourGet() {
      ...
      metadonnees.add("Denomination","Test 2011-ConsultationAffichable-OK-page-34-nb-pages-10");
   ...
   private void etape1captureUnitaire(
      ...
      if (formCaptureEtp1.getResultats().getStatus().equals(TestStatusEnum.Succes)) {
         ...
         formConsultEtp2.setNumeroPage(34);
