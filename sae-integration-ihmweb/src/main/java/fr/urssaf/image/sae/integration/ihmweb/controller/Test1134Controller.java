...
/**
 * 1134-Droits-Conformite-Archivage-Masse-PRMD-DYNA-MULTI
 */
@Controller
@RequestMapping(value = "test1134")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1134Controller extends
   ...
   private String getDebutUrlEcde() {
      return getEcdeService().construitUrlEcde("SAE_INTEGRATION/20110822/Droit-1134-Droits-Conformite-Archivage-Masse-PRMD-DYNA-MULTI/");
   }
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination",
            "Test 1134-Droits-Conformite-Archivage-Masse-PRMD-DYNA-MULTI");
