 ...
 */
@Controller
@RequestMapping(value = "test1805b")
@SuppressWarnings( { "PMD.AvoidDuplicateLiterals" })
public class Test1805bController extends
   ...
   protected final TestFormulaireDrCuRe getFormulairePourGet() {
      ...
      captUnit
            .setUrlEcde(getEcdeService()
                  .construitUrlEcde(
                        "SAE_INTEGRATION/20110822/FCP-1805-2-FCP-CU-OK-Identification-Validation-Monitor-FMT354-KO/documents/doc1.PDF"));
      ...
      metadonnees.add("Denomination",
            "Test 1805-2-FCP-CU-OK-Identification-Validation-Monitor-FMT354-KO");
   ...
   private void verifieResultatN(int numeroResultatRecherche,
      ...
      valeursAttendues.add("Denomination", "Test 1805-2-FCP-CU-OK-Identification-Validation-Monitor-FMT354-KO");
