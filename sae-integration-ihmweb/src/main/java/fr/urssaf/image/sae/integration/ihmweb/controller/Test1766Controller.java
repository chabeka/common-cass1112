...
/**
 * 1766-Ged-Technique-KO-Ajout-Meta-Doc-Inexistant
 */
@Controller
@RequestMapping(value = "test1766")
public class Test1766Controller extends
   ...
   protected final TestWsModificationFormulaire getFormulairePourGet() {
      ...
      metadonnees.add(new MetadonneeValeur("Periode", "1512"));
