...
public class VentilationFondsDocProdTest {
   ...
   private static String NOMFICHIER = "20161110_fonds_doc_cspp_gnt_pour_ventilation.csv";
   private static String NOMFICHIERVENTIL = "20161111_ventilation_taille.csv";
   private static String NOMFICHIER_DOC_SANS_DOMAINE = "20150716_ventilation_doc_sans_domaine.csv";
   private static String NOMFICHIER_FORMAT_PDF = "20150331_ventilation_doc_format_pdf.csv";
   private static String NOMFICHIER_DOC_AVEC_DATE_RECEPTION = "20150401_docs_avec_date_reception.csv";
   private static String NOMFICHIER_DOC_AVEC_PERIODE = "20150401_docs_avec_periode.csv";
   private static String NOMFICHIER_CPT_DOC_PAR_SIREN = "20151203_nb_doc_par_siren.csv";
   private static String NOMFICHIER_DOC_TAILLE_SUP_1M = "20160405_doc_taille_sup_1M.csv";
   private static String NOMFICHIER_CODE_ORGA_GEST = "20160624_code_orga_gest.csv";
   private static String NOMFICHIER_CODE_ORGA_PROP = "20160624_code_orga_prop.csv";
