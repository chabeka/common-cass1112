 ...
 * fr
 * .urssaf.image.sae.regionalisation.fond.documentaire.service.DocumentService.<br>
 * La validation est basée sur la programmation aspect
 * 
 * 
 */
@Aspect
public class DocumentServiceValidation {

   private static final String CLASS = "fr.urssaf.image.sae.regionalisation.fond.documentaire.service.DocumentService.";
