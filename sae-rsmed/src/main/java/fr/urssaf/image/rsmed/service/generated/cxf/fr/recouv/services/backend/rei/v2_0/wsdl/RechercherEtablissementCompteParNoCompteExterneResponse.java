 ...
 *       &lt;sequence&gt;
 *         &lt;element name="denominationEtablissement" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "RechercherEtablissementCompteParNoCompteExterneResponse")
public class RechercherEtablissementCompteParNoCompteExterneResponse {

    protected String denominationEtablissement;
    @XmlElement(required = true)
    protected RedevabiliteType redevabilite;

    /**
     * Obtient la valeur de la propriété denominationEtablissement.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    public String getDenominationEtablissement() {
        return denominationEtablissement;
    }

    /**
     * Définit la valeur de la propriété denominationEtablissement.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setDenominationEtablissement(String value) {
        this.denominationEtablissement = value;
    }
