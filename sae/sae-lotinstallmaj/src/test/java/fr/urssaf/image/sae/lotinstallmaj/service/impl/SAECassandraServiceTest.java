...
public class SAECassandraServiceTest {
   ...
   public void createColumnFamillyFromDefinitionTestException() {
      ...
      final ColumnFamilyDefinition c = HFactory.createColumnFamilyDefinition("LotInstallMaj",
                                                                             "DroitContratService", ComparatorType.UTF8TYPE);

      // liste des CF existants
      final List<ColumnFamilyDefinition> cfDefsTrue = new ArrayList<ColumnFamilyDefinition>();
      // DroitContratService
      cfDefsTrue.add(c);

      // liste des CF inexistants
      final List<ColumnFamilyDefinition> cfDefsFalse = new ArrayList<ColumnFamilyDefinition>();
   ...
   public void createColumnFamillyFromDefinition3foisTestException()
      ...
      final ColumnFamilyDefinition cfDefs = HFactory.createColumnFamilyDefinition(
