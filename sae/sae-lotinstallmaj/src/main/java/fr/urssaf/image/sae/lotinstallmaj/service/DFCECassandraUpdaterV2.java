...
public abstract class DFCECassandraUpdaterV2 {
   ...
   public final boolean isReadyForUpdate() throws MajLotUnknownDFCEVersion {
      ...
      // Récupération de la version actuelle de DFCE
      long dfceBdVersion = getDatabaseVersionDFCE();
      if (dfceBdVersion == 0) {
         // Si base SAE créée et la version de la base est >= 33 ==> version dfce = 3, mais la version
         // de DFCE n'est pas encore inscrite en base de données
