...
public enum LotVersion {
  ...
  CASSANDRA_DFCE_201100("CASSANDRA_DFCE_201100", 34, "Met la base Cassandra du SAE en version 34 :\r\n" +
      ...
      + "- Ajout de la métadonnée DateNaissanceCotisant et de l'index composite DomaineCotisant-CodeOrganismeProprietaire-DateNaissanceCotisant-DateArchivage\r\n"
      + "- Ajout des formats eml et rtf");
