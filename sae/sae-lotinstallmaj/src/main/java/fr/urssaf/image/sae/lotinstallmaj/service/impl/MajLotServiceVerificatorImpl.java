...
public class MajLotServiceVerificatorImpl implements MajLotServiceVerificator {
   ...
   * Verifie que le code pour la trace de déblocage, la nouvelle méta 
  ...
  private boolean verifyVersion34() {
    ...
    // verifier la creation de la méta DateNaissanceCotisant
  ...
  private boolean verifyVersion32() {
    ...
    // DomaineCotisant-CodeOrganismeProprietaire-CodeProduitV2-CodeTraitementV2-DateArchivage
    /*
