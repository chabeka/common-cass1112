...
public class ReferentielServiceUtilsCQL {
   ...
   private static final String FORMAT_RTF = "id-rtf";
   ...
   public void addReferentielFormatV8() {
      // RTF
      // TODO: creer les format
      final FormatFichier formatFichierRTF = new FormatFichier();
      formatFichierRTF.setDescription("Fichier PNG");
      formatFichierRTF.setExtension("application/rtf");
      formatFichierRTF.setTypeMime("image/png");
      formatFichierRTF.setVisualisable(Boolean.TRUE);
      formatFichierRTF.setAutoriseGED(Boolean.TRUE);
