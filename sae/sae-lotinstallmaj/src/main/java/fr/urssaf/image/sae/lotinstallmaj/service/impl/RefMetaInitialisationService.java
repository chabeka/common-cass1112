...
public final class RefMetaInitialisationService {
  ...
  private static final String FICHIER_METADONNEES = "Metadonnees.4.4.xml";

  private static final String NOM_FICHIER_INDEX_COMPOSITE = "IndexesComposites4.4.xml";
   ...
   */
  public void initialiseRefMeta(final Keyspace keyspace) {
  ...
  private void persisteMetadonnees(final Keyspace keyspace, final List<MetadataReference> metadonnees) {
