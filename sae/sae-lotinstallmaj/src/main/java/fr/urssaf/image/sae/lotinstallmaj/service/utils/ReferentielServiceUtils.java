...
public class ReferentielServiceUtils {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV1(final Keyspace keyspace) {
    ...
    CassandraUtils.addColumn(REG_TECHNIQUE,
                             allInfos,
                             StringSerializer.get(),
                             ListSerializer.get(),
                             updater);
    ...
    CassandraUtils.addColumn(JOURN_EVT,
                             allInfos,
                             StringSerializer.get(),
                             ListSerializer.get(),
                             updater);
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV2(final Keyspace keyspace) {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV3(final Keyspace keyspace) {
    ...
    CassandraUtils.addColumn(REG_TECHNIQUE,
                             ...
                             ListSerializer.get(),
                             updater);
    CassandraUtils.addColumn("REG_EXPLOITATION",
                             allInfos,
                             StringSerializer.get(),
                             ListSerializer.get(),
                             updater);
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV4(final Keyspace keyspace) {
   ...
   */
  public static void addReferentielEvenementV5(final Keyspace keyspace) {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV6(final Keyspace keyspace) {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV7(final Keyspace keyspace) {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV8(final Keyspace keyspace) {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV9(final Keyspace keyspace) {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV10(final Keyspace keyspace) {
   ...
   *          Keyspace
   */
  public static void addReferentielEvenementV11(final Keyspace keyspace) {
  ...
  public static void addReferentielFormatV4(final Keyspace keyspace) {
    ...
    addNewColumnToReferentielFormat(cfTmpl,
                                    nouveauFormat,
                                    new ReferentielFormat(
                                                          "Tous fichiers PDF sans précision de version",
                                                          FORMAT_PDF,
                                                          "application/pdf",
                                                          Boolean.TRUE,
                                                          null,
  ...
  public static void addReferentielFormatV6(final Keyspace keyspace) {
    ...
    addNewColumnToReferentielFormat(cfTmpl,
                                    formatKey,
                                    "Fichier MS Word version 97/2003",
                                    "doc",
                                    "application/msword",
                                    Boolean.TRUE);
    ...
    addNewColumnToReferentielFormat(cfTmpl,
                                    formatKey,
                                    "Fichier MS Excel version 97/2003",
                                    "xls",
    ...
    addNewColumnToReferentielFormat(
                                    cfTmpl,
                                    formatKey,
                                    "Fichier MS Excel version 2007 et +",
                                    "xlsx",
    ...
    addNewColumnToReferentielFormat(cfTmpl,
                                    formatKey,
                                    "Fichier tableur (Comma Separated Values)",
                                    "csv",
                                    "text/csv",
                                    Boolean.TRUE);
    ...
    addNewColumnToReferentielFormat(cfTmpl,
                                    formatKey,
                                    "Fichier MS PowerPoint version 97/2003",
                                    "ppt",
  ...
  public static void modifyReferentielFormatFmt353(final Keyspace keyspace) {
    ...
    CassandraUtils.addColumn(LIBELLE_EXTENSION,
                             "tif,tiff",
                             StringSerializer.get(),
                             StringSerializer.get(),
                             updater);
  ...
  public static void addFormatControleProfil(final Keyspace keyspace) {
    ...
    CassandraUtils.addColumn("controlProfil",
                             profil,
                             StringSerializer.get(),
                             FormatProfilSerializer.get(),
                             updater);
    cfTmpl.update(updater);
  ...
  private static void addNewColumnToReferentielFormat(
                                                      final ColumnFamilyTemplate<String, String> cfTmpl, final String formatKey,
                                                      final String description, final String extension, final String typeMime,
                                                      final Boolean visualisable, final Boolean autoriseEnGed) {
    final ReferentielFormat refFormat = new ReferentielFormat(description,
                                                              extension,
                                                              typeMime,
                                                              visualisable,
                                                              autoriseEnGed);
  ...
  private static void addNewColumnToReferentielFormat(
                                                      final ColumnFamilyTemplate<String, String> cfTmpl, final String formatKey,
                                                      final ReferentielFormat refFormat) {
  ...
  private static void addNewDefaultColumnToReferentielFormat(
                                                             ...
                                                             final ReferentielFormat refFormat) {
    final String description = refFormat.getDescription();
    ...
    final String extension = refFormat.getExtension();
    ...
    final String typeMime = refFormat.getTypeMime();
    if (typeMime != null && !typeMime.isEmpty()) {
      CassandraUtils.addColumn("typeMime",
                               typeMime,
                               StringSerializer.get(),
                               StringSerializer.get(),
                               updater);
    ...
    final Boolean visualisable = refFormat.getVisualisable();
    if (visualisable != null) {
      CassandraUtils.addColumn("visualisable",
                               visualisable,
                               StringSerializer.get(),
                               BooleanSerializer.get(),
                               updater);
   ...
   *          Template updater
   */
  private static void addColumnAutoriseGED(final String identifiant, final Boolean value,
                                           final ColumnFamilyTemplate<String, String> cfTmpl) {
