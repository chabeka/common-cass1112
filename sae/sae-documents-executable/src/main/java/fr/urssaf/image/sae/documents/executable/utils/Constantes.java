...
public final class Constantes {
  ...
  // Les tableaux sont mis en private car le contenu peut être modifié,
  // on utilise des getter avec clone
  private static final String[] METADONNEES_DEFAULT = new String[] {
                                                                    "SM_DOCUMENT_TYPE", "SM_ARCHIVAGE_DATE", "cse", "apr", "atr",
                                                                    Constantes.METADONNEES_FORMAT_FICHIER };

  private static final String[] METADONNEES_NON_AUTORISEES = new String[] {
  ...
  public static String[] getMETADONNEES_DEFAULT() {
    return METADONNEES_DEFAULT.clone();
  }

  public static String[] getMETADONNEES_NON_AUTORISEES() {
    return METADONNEES_NON_AUTORISEES.clone();
  }

  /*
   * // Ajout synchronized car SimpleDateFormat n'est pas ThreadSafe
   * public synchronized static SimpleDateFormat getFORMATTER_DATE() {
