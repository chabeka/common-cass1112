  ...
  public final void addDocumentAttachment(final UUID docUuid,
    ...
    Validate.notNull(docUuid,
                     StorageMessageHandler.getMessage(CODE_ERROR,
                                                      "add.document.attache.docuuid.required",
                                                      "ajoutdocattache.impact",
                                                      "ajoutdocattache.docuuid.action"));

    Validate.notNull(docUuid.toString(),
    ...
    Validate.notEmpty(docName,
                      StorageMessageHandler.getMessage(CODE_ERROR,
                                                       "add.document.attache.docname.required",
                                                       "ajoutdocattache.impact",
    ...
    Validate.notEmpty(extension,
                      StorageMessageHandler.getMessage(CODE_ERROR,
                                                       ...
                                                       "ajoutdocattache.impact",
                                                       "ajoutdocattache.extension.action"));

    Validate.notNull(contenu,
                     StorageMessageHandler.getMessage(CODE_ERROR,
                                                      "add.document.attache.contenu.required",
                                                      "ajoutdocattache.impact",
