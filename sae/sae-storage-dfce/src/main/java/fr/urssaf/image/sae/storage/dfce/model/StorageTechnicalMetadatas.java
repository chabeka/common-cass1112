...
public enum StorageTechnicalMetadatas {
   ...
   DATE_DEBUT_CONSERVATION("DateDebutConservation", SystemFieldName.SM_LIFE_CYCLE_REFERENCE_DATE.toString()),
   // Gel du document
   GEL("Gel", "gel"),
   // DocFormatOrigine
   ...
   // DateModification
   DATE_MODIFICATION("DateModification", SystemFieldName.SM_MODIFICATION_DATE.toString()),
   // Pas de valeur
   NOVALUE("", ""),
   ...
   // Date de déplacement du document dans la corbeille
   DATE_MISE_EN_CORBEILLE("DateMiseEnCorbeille", "dmc");
