...
public class ValidationServiceImplCqlTest extends AbstractReferentielFormatCqlTest {
  ...
  public void validateFile_success_FichierValide()
    ...
    final boolean avecFile = Boolean.TRUE;
  ...
  public void validateStream_success_FichierValide()
    ...
    final boolean avecFile = Boolean.FALSE;
    validateFileOuStream_success_FichierValide(avecFile);

  }

  private void validateFileOuStream_success_FichierValide(final boolean avecFile)
      throws UnknownFormatException, ValidatorInitialisationException,
      ValidatorUnhandledException, IOException {
  ...
  private void validateFileOuFlux_succes_FichierNonValide(final boolean avecFile)
      throws UnknownFormatException, ValidatorInitialisationException,
      ValidatorUnhandledException, IOException {
  ...
  private void validateFileOuStream_failure_FormatInexistantDansReferentielFormats(
                                                                                   final boolean avecFile) throws ValidatorInitialisationException,
  ValidatorUnhandledException, IOException {
