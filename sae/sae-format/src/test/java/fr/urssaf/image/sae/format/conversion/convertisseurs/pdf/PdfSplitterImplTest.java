...
public class PdfSplitterImplTest {
  ...
  public void convertirFichierFile_success() throws ConversionParametrageException, IOException {
    ...
    final ClassPathResource ressource = new ClassPathResource("/conversion/fichier.pdf");

    // Appel de la méthode à tester
    final byte[] result = pdfSplitterImpl.convertirFichier(ressource.getFile(), null, null);
  ...
  public void convertirFichierFile_erreurParametrage() throws ConversionParametrageException, IOException {
    ...
    // Appel de la méthode à tester
    pdfSplitterImpl.convertirFichier(ressource.getFile(), null, Integer.valueOf(0));
  ...
  public void convertirFichierFile_erreurConversion()
    ...
    EasyMock.expect(serviceConversion.splitPdf((File) EasyMock.anyObject(), (Integer) EasyMock.anyObject(), (Integer) EasyMock.anyObject()))
            .andThrow(new FormatConversionException("test-unitaire"))
            .once();

    EasyMock.replay(serviceConversion);

    final PdfSplitterImpl convertisseur = new PdfSplitterImpl(serviceConversion);
  ...
  public void convertirFichierByte_success() throws ConversionParametrageException, IOException {
    ...
    // Appel de la méthode à tester
    final byte[] result = pdfSplitterImpl.convertirFichier(fichier, null, null);
  ...
  public void convertirFichierByte_erreurParametrage() throws ConversionParametrageException, IOException {
    ...
    // Appel de la méthode à tester
    pdfSplitterImpl.convertirFichier(fichier, null, Integer.valueOf(0));
  ...
  public void convertirFichierByte_erreurConversion()
    ...
    EasyMock.expect(serviceConversion.splitPdf((byte[]) EasyMock.anyObject(), (Integer) EasyMock.anyObject(), (Integer) EasyMock.anyObject()))
            .andThrow(new FormatConversionException("test-unitaire"))
            .once();
