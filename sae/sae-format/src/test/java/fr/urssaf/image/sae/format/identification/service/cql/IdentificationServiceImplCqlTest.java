...
public class IdentificationServiceImplCqlTest extends AbstractReferentielFormatCqlTest {
  ...
  public void identifyFile_success_idOK_surFichier()
    ...
    final IdentificationResult result = identificationService.identifyFile(
  ...
  public void identifyFile_success_idOK_surFlux()
    ...
    // Appel de la méthode à tester
    final IdentificationResult result = identificationService.identifyStream(
