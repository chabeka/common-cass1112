...
public class PdfaIdentifierImplTest {
   ...
   @Test
   public void identifyFileFailureIdFormatErrone() throws IdentificationRuntimeException, IOException {
      ...
      Assert.assertEquals(MESSAGE_ERRONE,
            ETAPE1,
            etape0.getEtape());
      Assert.assertEquals(RESULTAT_ERRONE,
            PUUID_FMT354,
            etape0.getResultat());
   ...
   @Test
   public void identifyFileSuccess() throws IdentificationRuntimeException, IOException {
   ...
   @Test
   public void identifyFileSuccessCompatiblefmt18() throws IdentificationRuntimeException, IOException {
   ...
   @Test
   public void identifyFileSuccessCompatiblefmt95() throws IdentificationRuntimeException, IOException {
   ...
   public void identifyStreamFailureIdFormatErrone() throws IOException {
      ...
      IdentificationResult identificationResult = pdfaIdentifier.identifyStream(
            "idFormat", inputStream);
   ...
   @Test
   public void identifyStreamSuccessCompatiblefmt95() throws IOException {
