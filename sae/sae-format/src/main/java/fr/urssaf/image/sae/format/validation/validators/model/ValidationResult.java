...
public class ValidationResult {
    ...
    * Constructeur
    *  
    * @param valid : si le fichier est valide
    * @param details : les anomalies
    */
   ...
   /**
    * Méthode permettant d’avoir la trace d’exécution du processus de validation en cas d’échec.
    * 
    * @return List {@link EtapeEtResultat} permettant d'avoir trace et resultat
    */
