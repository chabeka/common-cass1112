...
public class ReferentielFormatDao extends AbstractDao<String, String> {
   ...
   */
  @Autowired
  public ReferentielFormatDao(final Keyspace keyspace) {
    super(keyspace);
  }
   ...
   */
  public final void addNewFormat(final ColumnFamilyUpdater<String, String> updater,
                                 final String idFormat, final String typeMime, final String extension,
                                 final String description, final Boolean autorisedGED, final Boolean visualisable,
                                 final String validator,
                                 final String identification, final String conversion, final Long clock) {
   ...
   */
  public final void mutatorSuppressionRefFormat(final Mutator<String> mutator,
                                                final String idFormat, final long clock) {
