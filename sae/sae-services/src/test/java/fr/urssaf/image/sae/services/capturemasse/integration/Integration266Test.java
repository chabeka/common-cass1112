...
public class Integration266Test {
   ...
   private static final String LOG_WARN = "Aucun document du sommaire ne sera intégré dans le SAE (mode PARTIEL non accepté).";
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/266/sommaire.xml");
