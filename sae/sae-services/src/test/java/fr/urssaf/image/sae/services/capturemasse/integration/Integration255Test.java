...
public class Integration255Test {
   ...
   private static final String LOG_WARN = "La ou les métadonnées suivantes "
         + "n'existent pas dans le référentiel des métadonnées : Tata, Titi";
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/255/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/255/documents/doc132.PDF");
      ...
      resAttestation1 = new ClassPathResource(
            "testhautniveau/255/documents/doc70.PDF");
      fileAttestation1 = new File(repEcde, "doc70.PDF");
      FileUtils.copyURLToFile(resAttestation1.getURL(), fileAttestation1);

      resAttestation1 = new ClassPathResource(
            "testhautniveau/255/documents/doc77.PDF");
   ...
   private void checkFiles() throws IOException {
      ...
      String sha1Attendu = "428c01420367359b1861ed8ed53f1c57cf8e48a6";
   ...
   private void checkTracabilite(UUID idTdm, URI urlSommaire) {
      ...
      traceAssertUtils
            .verifieTraceCaptureMasseDansRegTechnique(
                  ...
                  urlSommaire,
                  Arrays
                        .asList("fr.urssaf.image.sae.services.exception.capture.UnknownMetadataEx: La ou les métadonnées suivantes n'existent pas dans le référentiel des métadonnées : Tata, Titi"));
