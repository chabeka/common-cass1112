...
@DirtiesContext
public class Integration206Test {
   ...
   private static final Logger LOGGER = LoggerFactory
         .getLogger(Integration206Test.class);
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/206/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/206/documents/doc1.PDF");
   ...
   private void checkFiles() throws IOException {
      ...
      String sha1Attendu = "d6b7d4ee6b506bf747a09bab420d105bd8818539";
