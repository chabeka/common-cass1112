 ...
 */
public class SAEControlesCaptureServiceImplCqlTest extends AbstractServiceCqlTest {
  ...
  public final void setSaeControlesCaptureService(
                                                  final SAEControlesCaptureService saeControlesCaptureService) {
  ...
  public final void requiredArchivableMetadataFailed()
    ...
    for (final SAEMetadata metadata : saeDocument.getMetadatas()) {
  ...
  public final void checkHashCodeMetadataForStorage_failure_FileNotFound()
    ...
    } catch (final SAECaptureServiceRuntimeException e) {
