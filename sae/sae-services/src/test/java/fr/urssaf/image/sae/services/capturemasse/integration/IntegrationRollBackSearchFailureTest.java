...
public class IntegrationRollBackSearchFailureTest {
   ...
   private void initSearchUnknownLuceneMetadataEx()
   ...
   @SuppressWarnings("unchecked")
   private void initSearchSyntaxLuceneEx()
         throws MetaDataUnauthorizedToSearchEx,
         MetaDataUnauthorizedToConsultEx, UnknownDesiredMetadataEx,
         UnknownLuceneMetadataEx, SyntaxLuceneEx, SAESearchServiceEx {
      EasyMock.expect(
   ...
   @SuppressWarnings("unchecked")
   private void initSearchSAESearchServiceEx()
         throws MetaDataUnauthorizedToSearchEx,
         MetaDataUnauthorizedToConsultEx, UnknownDesiredMetadataEx,
         UnknownLuceneMetadataEx, SyntaxLuceneEx, SAESearchServiceEx {
      EasyMock.expect(
   ...
   @SuppressWarnings("unchecked")
   private void initSearchMetaDataUnauthorizedToSearchEx()
         throws MetaDataUnauthorizedToSearchEx,
         MetaDataUnauthorizedToConsultEx, UnknownDesiredMetadataEx,
         UnknownLuceneMetadataEx, SyntaxLuceneEx, SAESearchServiceEx {
      EasyMock.expect(
   ...
   @SuppressWarnings("unchecked")
   private void initSearchUnknownDesiredMetadataEx()
         throws MetaDataUnauthorizedToSearchEx,
         MetaDataUnauthorizedToConsultEx, UnknownDesiredMetadataEx,
         UnknownLuceneMetadataEx, SyntaxLuceneEx, SAESearchServiceEx {
      EasyMock.expect(
   ...
   @SuppressWarnings("unchecked")
   private void initSearchMetaDataUnauthorizedToConsultEx()
         throws MetaDataUnauthorizedToSearchEx,
         MetaDataUnauthorizedToConsultEx, UnknownDesiredMetadataEx,
         UnknownLuceneMetadataEx, SyntaxLuceneEx, SAESearchServiceEx {
      EasyMock.expect(
