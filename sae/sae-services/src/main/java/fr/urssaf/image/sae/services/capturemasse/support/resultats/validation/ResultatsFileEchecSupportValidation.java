...
public class ResultatsFileEchecSupportValidation {
   ...
   private static final String WRITE_VRTL_METHOD = "execution(void fr.urssaf.image.sae.services.capturemasse.support.resultats.ResultatsFileEchecSupport.writeVirtualResultatsFile(*,*,*,*))"
         + " && args(ecdeDirectory,sommaireFile,erreur, nombreDocsTotal)";
