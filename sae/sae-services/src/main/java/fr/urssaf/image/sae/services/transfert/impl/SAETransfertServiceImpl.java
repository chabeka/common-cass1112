...
public class SAETransfertServiceImpl extends AbstractSAEServices implements SAETransfertService {
  ...
  @Autowired
  public SAETransfertServiceImpl(final JournalEvtServiceThriftImpl journalEvtThriftService,
                                 final JournalEvtCqlServiceImpl journalEvtCqlService,
  ...
  private String getJournalSaeEventsAsJson(final UUID idArchive) throws TransfertException {
    ...
    try {
      final ObjectMapper mapper = new ObjectMapper();
      final String modeApi = modeApiService.getModeAPI(Constantes.CF_TRACE_JOURNAL_EVT);
