...
public interface SAEDocumentAttachmentService {
    ...
    * @throws EmptyFileNameEx
    *            Le nom du fichier est vide
    * @throws CaptureBadEcdeUrlEx L'URL du document est incorrecte
    */
   @PreAuthorize("hasRole('ajout_doc_attache')")
   void addDocumentAttachmentUrl(UUID docUuid, URI ecdeURL) throws SAEDocumentAttachmentEx,
         ArchiveInexistanteEx, EmptyDocumentEx, EmptyFileNameEx, CaptureBadEcdeUrlEx;
