...
public class SAEConsultationServiceValidation {
   ...
   */
  @Before(METHOD)
  public final void consultation(final UUID idArchive) {
   ...
   */
  @Before(MAIN_METHOD)
  public final void consultation(final ConsultParams consultParams) {
  ...
  public final void consultationAffichable(final ConsultParams consultParams) {
