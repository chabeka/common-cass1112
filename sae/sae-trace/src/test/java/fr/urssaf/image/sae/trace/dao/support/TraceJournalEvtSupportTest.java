...
public class TraceJournalEvtSupportTest {
  ...
  public void testCreateFindSuccess() {
    ...
    final TraceJournalEvt securite = support.find(uuid);
    checkBean(securite, uuid);

    final List<TraceJournalEvtIndex> list = support.findByDate(DATE);
  ...
  public void testCreateFindByPlageSuccess() {
    ...
    final TraceJournalEvt exploitation = support.find(uuid);
  ...
  private void checkBean(final TraceJournalEvt securite, final UUID uuid) {
  ...
  private void checkBeanIndex(final TraceJournalEvtIndex index, final UUID uuid) {
