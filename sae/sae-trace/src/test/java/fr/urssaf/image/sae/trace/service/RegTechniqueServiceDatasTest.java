...
public class RegTechniqueServiceDatasTest {
   ...
   public void testAucunRetourBorneInferieure() {
      ...
      final List<TraceRegTechniqueIndex> result = service.lecture(dateStart, dateFin,
                                                                  10, true);
   ...
   public void testRetour3ElementsMemeJour() {
      ...
      final List<TraceRegTechniqueIndex> result = service.lecture(dateStart, dateEnd,
                                                                  10, true);
      Assert.assertNotNull("il doit y avoir un résultat");
      Assert.assertEquals("le nombre d'éléments de la liste doit etre correct",
                          3, result.size());
   ...
   private void createTrace(final Date date, final String suffixe) {
      final TraceRegTechnique trace = new TraceRegTechnique(timeUUIDSupport
