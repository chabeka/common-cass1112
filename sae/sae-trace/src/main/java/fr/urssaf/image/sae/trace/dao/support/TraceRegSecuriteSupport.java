...
public class TraceRegSecuriteSupport extends
   ...
   */
  @Autowired
  public TraceRegSecuriteSupport(final TraceRegSecuriteDao dao,
                                 final TraceRegSecuriteIndexDao indexDao,
  ...
  protected Iterator<TraceRegSecuriteIndex> getIterator(
                                                        final SliceQuery<String, UUID, TraceRegSecuriteIndex> sliceQuery) {
