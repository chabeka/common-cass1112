...
public class TraceRegSecuriteSupport extends AbstractTraceSupport<TraceRegSecurite, TraceRegSecuriteIndex> {
	 ...
	 */
	@Autowired
	public TraceRegSecuriteSupport(TraceRegSecuriteDao dao, TraceRegSecuriteIndexDao indexDao,
	 ...
	 */
	@Override
	protected void completeCreateTrace(ColumnFamilyUpdater<UUID, String> updater, TraceRegSecurite trace, long clock) {
	 ...
	 */
	@Override
	protected Iterator<TraceRegSecuriteIndex> getIterator(SliceQuery<String, UUID, TraceRegSecuriteIndex> sliceQuery) {
