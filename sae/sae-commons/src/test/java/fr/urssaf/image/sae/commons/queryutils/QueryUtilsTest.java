...
public class QueryUtilsTest {
  ...
  public void getCompositeKeyFieldName() {
    // test de recupération de l'id sur la classe contenant la clé de partition
    final List<Field> partitionkeys = ColumnUtil.getCompositePartionKeyField(TestAvecCompsiteKey.class, PartitionKey.class);
    ...
    // test de recupération de la clé depuis la classe héritant de la classe contenant la clé de partition
    final List<Field> partitionkeyTest2 = ColumnUtil.getCompositePartionKeyField(TestAvecCompsiteKey1.class, PartitionKey.class);
