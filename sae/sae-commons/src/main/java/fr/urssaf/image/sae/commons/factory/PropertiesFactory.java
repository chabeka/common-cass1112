...
public class PropertiesFactory {
   ...
   public final static PropertyPlaceholderConfigurer load(
      ...
      // Fichier de configuration DFCE
      String dfceConfigPath = getCheminFichierConfig(saeConfigResource,
      ...
      String cassandraConfigPath = getCheminFichierConfig(saeConfigResource,
   ...
   private static String getCheminFichierConfig(
