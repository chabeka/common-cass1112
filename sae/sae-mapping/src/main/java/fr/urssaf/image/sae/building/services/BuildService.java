...
public interface BuildService {
   ...
   /**
    * Service permettant de construire un objet de type {@link LuceneCriteria} à
    * partir d’une requête lucène.
    * 
    * @param luceneQuery
    ...
    * {@link PaginatedLuceneCriteria} à partir d’une requête lucène.
    * 
    * @param luceneQuery
    *           : La requête lucene contenant les codes courts des métadonnées.
    *@param limit
    ...
    * partir de l'identifiant unique d'un document UUID.
    * 
    * @param uuid
