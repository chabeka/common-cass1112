...
public class MappingDocumentServiceValidation {
  ...
  public final void saeDocumentToStorageDocumentValidation(
    ...
    Validate.notNull(saeDoc,
                     MappingMessageHandler.getMessage(
                                                      "mapping.document.required",
                                                      SAEDocument.class.getName()));
    Validate.notNull(saeDoc.getMetadatas(),
                     MappingMessageHandler.getMessage(
                                                      "mapping.document.metadata.required",
                                                      SAEDocument.class.getName()));
  }
  ...
  public final void storageDocumentToSaeDocumentValidation(
    ...
    Validate.notNull(storageDoc,
                     MappingMessageHandler.getMessage(
                                                      "mapping.document.required",
                                                      StorageDocument.class.getName()));
    Validate.notNull(storageDoc.getMetadatas(),
                     MappingMessageHandler
                                          .getMessage("mapping.document.required",
  ...
  public final void untypedDocumentToSaeDocumentValidation(
    ...
    Validate.notNull(untyped,
                     MappingMessageHandler.getMessage(
                                                      "mapping.document.required",
                                                      UntypedDocument.class.getName()));
    Validate.notNull(untyped.getUMetadatas(),
                     MappingMessageHandler
                                          .getMessage("mapping.document.required",
                                                      UntypedDocument.class
                                                                           .getName()));
  }
  ...
  public final void saeVirtualDocumentToVirtualStoragDocument(
    ...
    Validate.notNull(document,
                     MappingMessageHandler.getMessage(
                                                      "mapping.document.required",
                                                      SAEVirtualDocument.class.getName()));

    Validate.notNull(document.getMetadatas(),
                     MappingMessageHandler
                                          .getMessage("mapping.metadata.required"));

    Validate.notNull(document.getReference(),
                     MappingMessageHandler
                                          .getMessage("mapping.reference.required",
                                                      SAEVirtualDocument.class
                                                                              .getName()));
  }
  ...
  public final void untypedVirtualDocumentToSaeVirtualDocument(
    ...
    Validate.notNull(document.getuMetadatas(),
                     MappingMessageHandler
                                          .getMessage("mapping.metadata.required"));
  }
  ...
  public final void saeMetadatasToStorageMetadatas(
    ...
    Validate.notEmpty(metadatas,
                      MappingMessageHandler.getMessage(
                                                       "mapping.metadata.required",
                                                       SAEDocument.class.getName()));
  }
}
