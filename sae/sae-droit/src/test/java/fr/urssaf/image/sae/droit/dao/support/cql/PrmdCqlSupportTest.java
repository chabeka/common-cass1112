...
public class PrmdCqlSupportTest {
  ...
  @Autowired
  private PrmdCqlSupport support;
  ...
  public void testCreateFindAll() {
    ...
    final List<Prmd> list = support.findAll(10);
    ...
    for (int i = 1; i < 4; i++) {
      ...
      final String lucene = "lucene" + i;
      final String bean = "bean" + i;
      final String cle = "cle" + i;
      final String valeur = "valeur" + i;
