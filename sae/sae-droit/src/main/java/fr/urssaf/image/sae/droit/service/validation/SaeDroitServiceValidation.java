...
public class SaeDroitServiceValidation {
  ...
  public final void checkLoad2(final String idClient, final List<String> pagms) {
  ...
  public final void checkCreate(final ServiceContract contrat,
    ...
    if (StringUtils.isEmpty(contrat.getIdPki())
      ...
      throw new IllegalArgumentException(ResourceMessagesUtils.loadMessage(
                                                                           ARG_REQUIRED,
                                                                           "le nom de la PKI ou la liste des PKI"));
    }
   ...
   */
  @Before(CHECK_METHOD)
  public final void checkExists(final String idClient) {
   ...
   */
  @Before(GET_METHOD)
  public final void checkGetServiceContract(final String idClient) {
  ...
  public final void checkAddPagm(final String idClient, final Pagm pagm) {
