...
public class EcdeFileServiceValidation {
  ...
  public final void convertFileToURI(final File ecdeFile, final EcdeSource... sources) {
    ...
    for (final EcdeSource variable : sources) {
  ...
  public final void convertURIToFile(final URI ecdeURL, final EcdeSource... sources) {
  ...
  private void verifierEcdeSource(final EcdeSource variable, final int curseur) {
