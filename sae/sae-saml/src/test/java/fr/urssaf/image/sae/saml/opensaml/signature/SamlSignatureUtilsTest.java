...
public class SamlSignatureUtilsTest {
  ...
  public void getPublicKey_test02() throws SamlKeyInfoException {
    ...
    final Signature signature = TuUtils.loadSignature(
  ...
  public void getPublicKey_test05() throws SamlKeyInfoException, CertificateException {
    ...
    // Appel de la méthode à tester
    final X509Certificate certificat = SamlSignatureUtils.getPublicKey(signature);

    // Vérifications du résultat
    final java.security.cert.X509Certificate certNatif = KeyInfoHelper.getCertificate(certificat);
    assertEquals(
