...
public class SamlSignatureValidateService {
   ...
   protected void verifierIssuerPki(String idPki,
         SamlSignatureVerifParams signVerifParams, String issuer)
   ...
   private void verifierCryptographie(Signature signature,
