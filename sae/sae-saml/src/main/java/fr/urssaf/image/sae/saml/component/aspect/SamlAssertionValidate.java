...
public class SamlAssertionValidate {
  ...
  public final void assertionCreate(final JoinPoint joinPoint) {

    // récupération des paramétres de la méthode genererAssertion
    final SamlAssertionParams assertionParams = (SamlAssertionParams) joinPoint
                                                                               .getArgs()[0];
    final KeyStore keyStore = (KeyStore) joinPoint.getArgs()[1];
    final String alias = (String) joinPoint.getArgs()[2];
    final String password = (String) joinPoint.getArgs()[INDEX_3];
   ...
   */
  @Before(READ_METHODE)
  public final void assertionExtraction(final JoinPoint joinPoint) {

    // récupération des paramétres de la méthode extraitDonnnees
    final Element assertionSaml = (Element) joinPoint.getArgs()[0];
  ...
  public final void assertionVerification(final JoinPoint joinPoint) {

    // récupération des paramétres de la méthode verifierAssertion
    final Element assertionSaml = (Element) joinPoint.getArgs()[0];
    final SamlSignatureVerifParams signVerifParams = (SamlSignatureVerifParams) joinPoint.getArgs()[1];
  ...
  private void notNullValidate(final Object obj, final String name, final String message) {
  ...
  private void notNullValidate(final String obj, final String name, final String message) {
