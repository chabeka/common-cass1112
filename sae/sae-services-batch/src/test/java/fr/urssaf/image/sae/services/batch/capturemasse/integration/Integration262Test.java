...
public class Integration262Test {
   ...
   private static final String LOG_WARN = "Le fichier document "
         + "doc_inexistant.pdf est introuvable";
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/262/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/262/documents/doc132.PDF");
      ...
      resAttestation1 = new ClassPathResource(
            "testhautniveau/262/documents/doc70.PDF");
      fileAttestation1 = new File(repEcde, "doc70.PDF");
      FileUtils.copyURLToFile(resAttestation1.getURL(), fileAttestation1);

      resAttestation1 = new ClassPathResource(
            "testhautniveau/262/documents/doc77.PDF");
   ...
   private void checkFiles() throws IOException {
      ...
      String sha1Attendu = "332f9cb0fcfdc65db7774b7a4b5ca696c6b92510";
   ...
   private void checkTracabilite(UUID idTdm, URI urlSommaire) {
      ...
      traceAssertUtils
            .verifieTraceCaptureMasseDansRegTechnique(
                  ...
                  urlSommaire,
                  Arrays
                        .asList("fr.urssaf.image.sae.services.batch.capturemasse.exception.CaptureMasseSommaireDocumentNotFoundException: Le fichier document doc_inexistant.pdf est introuvable"));
