...
public class ResultatsFileFailureTransfertTaskletTest {
   ...
   public void testLancementStep() throws IOException {
      ...
      index.add(3);
      ConcurrentLinkedQueue<String> exceptions = new ConcurrentLinkedQueue<String>();
      ...
      launcherTransfert.launchStep("finErreurTransfert", context);
