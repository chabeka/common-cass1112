...
public class Integration252Test {
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/252/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/252/documents/doc132.PDF");
      ...
      resAttestation1 = new ClassPathResource(
            "testhautniveau/252/documents/doc70.PDF");
      fileAttestation1 = new File(repEcde, "doc70.PDF");
      FileUtils.copyURLToFile(resAttestation1.getURL(), fileAttestation1);

      resAttestation1 = new ClassPathResource(
            "testhautniveau/252/documents/doc77.PDF");
   ...
   private void checkFiles() throws IOException {
      ...
      String sha1Attendu = "692a20f144f60d1b8cb0d03eb0ee30f7cb9c9840";
   ...
   private void checkLogs() {
      ...
      Assert.assertEquals("le log doit être de niveau WARNING", Level.WARN,
            event.getLevel());
