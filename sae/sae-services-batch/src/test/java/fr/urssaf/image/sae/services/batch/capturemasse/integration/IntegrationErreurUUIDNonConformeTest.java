...
public class IntegrationErreurUUIDNonConformeTest {
  ...
  public void init() {
    ...
    final String[] roles = new String[] {"ROLE_modification_masse"};
  ...
  public void testLancement() throws ConnectionServiceEx, DeletionServiceEx,
    ...
    final ExitTraitement exitStatus = service.modificationMasse(urlSommaire, idTdm, "c30166dc2396f2997bff518d871dc9bd3b510791", "SHA-1");
  ...
  private void initDatas() throws IOException {
    ...
    final ClassPathResource resSommaire = new ClassPathResource(
                                                                "testhautniveau/erreurUUIDNonConforme/sommaire.xml");
    ...
    final ClassPathResource resAttestation1 = new ClassPathResource(
                                                                    "testhautniveau/erreurUUIDNonConforme/documents/doc1.PDF");
  ...
  private void checkFiles() throws IOException {
    ...
    final ClassPathResource resultatAttendu = new ClassPathResource(
                                                                    "testhautniveau/erreurUUIDNonConforme/resultats-attendu.xml");
  ...
  private void checkLogs() {
    ...
    erreurLogginMap.put(0, Arrays.asList(Level.WARN, "erreur lors de la conversion vers un objet métier UntypedDocument"));
    ...
    erreurLogginMap.put(2, Arrays.asList(Level.WARN, "erreur lors de la conversion vers un objet métier UntypedDocument"));
    ...
    erreurLogginMap.put(4, Arrays.asList(Level.WARN, "erreur lors de la conversion vers un objet métier UntypedDocument"));
    ...
    Assert.assertEquals("un message attendu", 6, logginEvents.size());
  ...
  private void checkTracabilite(final UUID idTdm, final URI urlSommaire) {
    ...
    final List<String> traceValueList = Arrays.asList(StringUtils.replace(traceValue, "{UUID}", "7A78BC2D-42E3-4EF4-8438-1C2F47D9423Dnva"),
                                                      StringUtils.replace(traceValue, "{UUID}", "A5A704C6-224E-4B63-9756-599174AED6A8nva"),
                                                      StringUtils.replace(traceValue, "{UUID}", "8510A1FE-5B2C-4843-B5D7-A9D3506FFDA1cmo"),
                                                      traceValue2,
                                                      traceValue2,
                                                      traceValue2);
    traceAssertUtils
                    .verifieTraceModificationMasseDansRegTechnique(
                                                                   idTdm,
                                                                   urlSommaire,
                                                                   traceValueList,
                                                                   "c30166dc2396f2997bff518d871dc9bd3b510791",
                                                                   "SHA-1");
