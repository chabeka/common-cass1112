...
public class CaptureMasseCompressionSupportTest {
   ...
   public void init() {
      ...
      } catch (final EcdeRuntimeException e) {
   ...
   public void isDocumentToBeCompress_droits() {
      ...
      final List<SaePagm> pagms = new ArrayList<SaePagm>();
   ...
   public void isDocumentToBeCompress_fichierTif() {
      ...
      // Cas 1 : le fichier est full image
      final boolean compressionActive = captureMasseCompressionSupport.isDocumentToBeCompress(document, ecdeDirectory);
      Assert.assertFalse("La compression aurait du être inactive", compressionActive);
      EasyMock.reset(saeDroitService);
   ...
   @Test
   @Ignore("TODO : plante sur jenkins")
   ...
   public void compresserDocument_error() throws CompressionException {
      ...
      final CompressedDocument compressedDoc = captureMasseCompressionSupport.compresserDocument(document, ecdeDirectory);
   ...
   @Test
   @Ignore("TODO : plante sur jenkins : Une autre exception était attendue expected:<java.[security.NoSuchAlgorithm]Exception> but was:<java.[io.FileNotFound]Exception")
