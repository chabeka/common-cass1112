 ...
 * 
 */
package fr.urssaf.image.sae.services.batch.capturemasse.support.controle.validation;
 ...
 * {@link fr.urssaf.image.sae.services.batch.capturemasse.support.controle.CaptureMasseControleSupport}
...
public class CaptureMasseControleSupportValidation {
   ...
   private static final String CONTROLE = "execution(fr.urssaf.image.sae.services.batch.capturemasse.support.controle.model.CaptureMasseControlResult fr.urssaf.image.sae.services.batch.capturemasse.support.controle.CaptureMasseControleSupport.controleSAEDocument(*,*))"
         + " && args(document,ecdeDirectory)";

   private static final String CONTROLE_STCK = "execution(void fr.urssaf.image.sae.services.batch.capturemasse.support.controle.CaptureMasseControleSupport.controleSAEDocumentStockage(*))"
         + " && args(document)";

   private static final String CONTROLE_FICHIER = "execution(void fr.urssaf.image.sae.services.batch.capturemasse.support.controle.CaptureMasseControleSupport.controleFichier(*,*))"
         + " && args(reference,ecdeDirectory)";

   private static final String CONTROLE_VIRTUEL = "execution(void fr.urssaf.image.sae.services.batch.capturemasse.support.controle.CaptureMasseControleSupport.controleSAEMetadatas(*))"
         + " && args(document)";

   private static final String CONTROLE_STCK_VRTL = "execution(void fr.urssaf.image.sae.services.batch.capturemasse.support.controle.CaptureMasseControleSupport.controleSAEVirtualDocumentStockage(*))"
         + " && args(document)";
