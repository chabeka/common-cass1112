 ...
 * {@link fr.urssaf.image.sae.services.batch.capturemasse.support.stockage.interruption.InterruptionTraitementMasseSupport}
 * .<br>
...
public class InterruptionTraitementSupportValidation {
  ...
  private static final String CLASS = "fr.urssaf.image.sae.services.batch.capturemasse.support.stockage.interruption.InterruptionTraitementMasseSupport";
  ...
  private void validate(final InterruptionTraitementConfig interruptionConfig) {
  ...
  private void validate(final DateTime currentDate) {
   ...
   * {@link fr.urssaf.image.sae.services.batch.capturemasse.support.stockage.interruption.InterruptionTraitementMasseSupport#interruption}
   * 
   * @param currentDate
   *          doit être renseigné
  ...
  public final void hasInterrupted(final DateTime currentDate,
                                   final InterruptionTraitementConfig interruptionConfig) {
