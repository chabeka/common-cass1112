   ...
   private void checkTracabilite(UUID idTdm, URI urlSommaire) {
      ...
      traceAssertUtils
            .verifieTraceCaptureMasseDansRegTechnique(
                  ...
                  urlSommaire,
                  Arrays
                        .asList("fr.urssaf.image.sae.services.capturemasse.exception.CaptureMasseSommaireDocumentNotFoundException: Le fichier document attestation1.pdf est introuvable"));
