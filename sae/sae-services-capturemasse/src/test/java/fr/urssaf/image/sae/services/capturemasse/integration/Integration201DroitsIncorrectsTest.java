...
public class Integration201DroitsIncorrectsTest {
   ...
   public void init() {
      ...
      Prmd prmd = new Prmd();
      prmd.setLucene("CodeRND:2.3.1.1.8");
      Map<String, List<String>> metadata = new HashMap<String, List<String>>();
      metadata.put("CodeRND", Arrays.asList(new String[] { "2.3.1.1.8" }));
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/201/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/201/documents/doc1.PDF");
   ...
   private void checkLogs() {
      ...
      Assert.assertTrue("au moins un message d'erreur ou warn attendu",
