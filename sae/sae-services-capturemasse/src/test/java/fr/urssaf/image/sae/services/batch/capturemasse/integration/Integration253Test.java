...
public class Integration253Test {
   ...
   private static final String LOG_WARN = "La ou les métadonnées suivantes, "
         ...
         + "CodeOrganismeProprietaire, CodeRND";
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/253/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/253/documents/doc132.PDF");
      ...
      resAttestation1 = new ClassPathResource(
            "testhautniveau/253/documents/doc70.PDF");
      fileAttestation1 = new File(repEcde, "doc70.PDF");
      FileUtils.copyURLToFile(resAttestation1.getURL(), fileAttestation1);

      resAttestation1 = new ClassPathResource(
            "testhautniveau/253/documents/doc77.PDF");
