...
public class Integration258Test {
   ...
   private static final String LOG_WARN = "La ou les métadonnées suivantes "
         + "ne sont pas autorisées à l'archivage : "
         + "CodeFonction, DureeConservation";
   ...
   private void initDatas() throws IOException {
      ...
      ClassPathResource resSommaire = new ClassPathResource(
            "testhautniveau/258/sommaire.xml");
      ...
      ClassPathResource resAttestation1 = new ClassPathResource(
            "testhautniveau/258/documents/doc132.PDF");
      ...
      resAttestation1 = new ClassPathResource(
            "testhautniveau/258/documents/doc70.PDF");
      fileAttestation1 = new File(repEcde, "doc70.PDF");
      FileUtils.copyURLToFile(resAttestation1.getURL(), fileAttestation1);

      resAttestation1 = new ClassPathResource(
            "testhautniveau/258/documents/doc77.PDF");
   ...
   private void checkFiles() throws IOException {
      ...
      String sha1Attendu = "1956bf35440c09c833c5a59b75a35d937823bbb0";
   ...
   private void checkTracabilite(UUID idTdm, URI urlSommaire) {
      ...
      traceAssertUtils
            .verifieTraceCaptureMasseDansRegTechnique(
                  ...
                  urlSommaire,
                  Arrays
                        .asList("fr.urssaf.image.sae.services.exception.capture.NotSpecifiableMetadataEx: La ou les métadonnées suivantes ne sont pas autorisées à l'archivage : CodeFonction, DureeConservation"));
