...
public interface StorageDocumentService {
  ...
  void updateStorageDocument(UUID uuid,
                             ...
                             List<StorageMetadata> deletedMetadatas)
      throws UpdateServiceEx;
  ...
  /**
   * Réalise la suppression d'un StorageDocument, suite à un transfert, à partir du
   ...
   *           Une exception est levée lors de la recherche
   */
  PaginatedStorageDocuments searchStorageDocumentsInRecycleBean(PaginatedLuceneCriteria paginatedLuceneCriteria)
      throws SearchingServiceEx, QueryParseServiceEx;
   ...
   * @param paginatedLuceneCriteria
   * @param bestIndex
   *          Index à utiliser (liste des codes courts des métadonnées composant l'index)
   * @return
   * @throws SearchingServiceEx
   * @throws QueryParseServiceEx
   */
  PaginatedStorageDocuments searchPaginatedStorageDocumentsWithBestIndex(PaginatedLuceneCriteria paginatedLuceneCriteria, List<String> bestIndex)
      throws SearchingServiceEx, QueryParseServiceEx;

  /**
   * Méthode permettant de récupérer l'ensemble des indexes composites contenus dans DFCe
   * 
   * @return l'ensemble des indexes composites contenus dans DFCe
   */
  Set<CompositeIndex> getAllCompositeIndex();

  /**
   * Permet de récupérer l'ensemble des indexes composites contenus dans DFCe
   * 
   * @return
   */
  Set<CompositeIndex> getAllIndexComposite();
}
