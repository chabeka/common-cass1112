...
display_help() {
    ...
    echo "   --updateToVersion NUM_VERSION         Enchaine les mise à jour jusqu'à la version passée en paramètre"
    ...
    echo "   --changeToVersion NUM_VERSION  Force le numéro de version inscrit en bdd"
