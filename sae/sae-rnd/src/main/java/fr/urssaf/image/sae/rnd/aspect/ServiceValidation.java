...
public class ServiceValidation {
   ...
   */
  @Before(RND_SERVICE)
  public final void validationRndService(final String codeRnd) {
  ...
  public final void validationArgUpdateVersionRnd(final VersionRnd versionRnd) {
    if (versionRnd == null) {
      throw new IllegalArgumentException(
   ...
   */
  @Before(AJOUTER_RND)
  public final void validationArgAjouterRnd(final TypeDocument typeDoc, final long clock) {
  ...
  public final void validationArgAjouterCorrespondance(
                                                       final Correspondance correspondance, final long clock) {
