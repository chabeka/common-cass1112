...
public class MajRndServiceTest {
   ...
   private void initComposantsADRN() throws Exception {
      ...
      // --------------------------------------
      final List<TypeDocument> listeTypeDoc = new ArrayList<TypeDocument>();
      ...
      // -------------------------
      final Map<String, String> listeCorrespondances = new TreeMap<String, String>();
      ...
      // ---------------------------
      final List<TypeDocument> listeCodesTempo = new ArrayList<TypeDocument>();
