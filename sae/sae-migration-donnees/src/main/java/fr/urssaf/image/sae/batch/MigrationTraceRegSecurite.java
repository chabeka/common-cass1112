...
public class MigrationTraceRegSecurite extends MigrationTrace {
  ...
  public void migrationFromThriftToCql() {
    ...
    final Iterator<GenericType> listT = genericdao.iterablefindAll("TraceRegSecurite", keyspace);
  ...
  public void migrationFromCqlToThrift() {
    ...
    while (tracej.hasNext()) {
      final TraceRegSecurite traceTrhift = createTraceThriftFromCqlTrace(tracej.next());
  ...
  public void migrationIndexFromThriftToCql() {
    ...
    for (final Date d : dates) {
      final Iterator<TraceRegSecuriteIndex> it = supportThrift.findByDateIterator(d);
      List<TraceRegSecuriteIndexCql> listTemp = new ArrayList<>();
      while (it.hasNext()) {
        final TraceRegSecuriteIndexCql trace = createTraceIndexFromThriftToCql(it.next());
        listTemp.add(trace);
  ...
  public void migrationIndexFromCqlToThrift() {
    ...
    while (it.hasNext()) {
      final TraceRegSecuriteIndex index = createTraceIndexFromCqlToThrift(it.next());
