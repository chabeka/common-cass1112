...
public class MigrationTraceRegTechnique extends MigrationTrace {
  ...
  public int migrationFromThriftToCql() {
    ...
    final Iterator<GenericType> listT = genericdao.iterablefindAll("TraceRegTechnique", keyspace);
  ...
  public int migrationFromCqlToThrift() {
    ...
    while (tracej.hasNext()) {
      final TraceRegTechnique traceTrhift = createTraceThriftFromCqlTrace(tracej.next());
  ...
  public void migrationIndexFromThriftToCql() {
    ...
    for (final Date d : dates) {
      ...
      while (it.hasNext()) {
        final TraceRegTechniqueIndexCql trace = createTraceIndexFromThriftToCql(it.next());
        listTemp.add(trace);
