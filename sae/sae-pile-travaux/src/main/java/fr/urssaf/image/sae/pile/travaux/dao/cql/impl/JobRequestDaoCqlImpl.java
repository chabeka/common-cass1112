 ...
 */
// @Repository
public class JobRequestDaoCqlImpl {
   ...
   */
  @Autowired
  public JobRequestDaoCqlImpl(final Keyspace keyspace) {
  ...
  private void addColumn(final ColumnFamilyUpdater<UUID, String> updater,
    ...
    final HColumn<String, Object> column = HFactory.createColumn(colName,
                                                                 value,
                                                                 nameSerializer,
                                                                 valueSerializer);
  ...
  public final void ecritColonneCreationDate(
    ...
    addColumn(updater,
              JR_CREATION_DATE_COLUMN,
              dSlz.toBytes(creationDate),
              StringSerializer.get(),
              bSlz,
              clock);
  ...
  public final void ecritColonneReservationDate(
    ...
    addColumn(updater,
              JR_RESERVATION_DATE_COLUMN,
              dSlz
                  .toBytes(reservationDate),
              StringSerializer.get(),
              bSlz,
              clock);
  ...
  public final void ecritColonneStartingDate(
    ...
    addColumn(updater,
              JR_STARTING_DATE_COLUMN,
              dSlz.toBytes(startingDate),
              StringSerializer.get(),
              bSlz,
              clock);
  ...
  public final void ecritColonneEndingDate(
    ...
    addColumn(updater,
              JR_ENDING_DATE_COLUMN,
              dSlz.toBytes(endingDate),
              StringSerializer.get(),
              bSlz,
              clock);
