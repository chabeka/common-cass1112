...
public class JobQueueServiceEndingJobTest {
  ...
  public void endingJob_success_endingBySuccess()
    ...
    Assert.assertEquals("l'état est inattendu", JobState.SUCCESS, jobRequest.getState());
  ...
  public void endingJob_success_endingByFailure()
    ...
    // vérification de JobRequest
    final JobRequest jobRequest = jobLectureService.getJobRequest(idJob);
    Assert.assertEquals("l'état est inattendu", JobState.FAILURE, jobRequest.getState());
