...
public class JobQueueServiceRenseignerDocCountJobCqlTest {
  ...
  public void renseignerDocCountJob_success() throws JobInexistantException {
    ...
    Assert.assertEquals("le nombre de message est inattendu", 3, histories.size());

    Assert.assertEquals("le message de l'ajout d'un traitement est inattendu", "DOC_COUNT RENSEIGNE", histories.get(2).getTrace());
