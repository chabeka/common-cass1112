...
@DirtiesContext
public class JobQueueServiceRenseignerPidJobTest {
   ...
   public void renseignerPidJob_success() throws JobInexistantException {
      ...
      Assert.assertEquals(
            "le message de l'ajout d'un traitement est inattendu",
            "PID RENSEIGNE", histories.get(2).getTrace());
