...
public class ListeUuidType implements org.apache.axis2.databinding.ADBBean {
   ...
   */
  protected void validateUuid(final fr.cirtil.www.saeservice.UuidType[] param) {
   ...
   * @param param Uuid
   */
  public void setUuid(final fr.cirtil.www.saeservice.UuidType[] param) {
    validateUuid(param);
   ...
   */
  public void addUuid(final fr.cirtil.www.saeservice.UuidType param) {
    if (localUuid == null) {
    ...
    list.add(param);
    localUuid = (fr.cirtil.www.saeservice.UuidType[]) list.toArray(new fr.cirtil.www.saeservice.UuidType[list.size()]);
  }
    ...
    public static ListeUuidType parse(
      ...
      try {
        ...
        if (reader.getAttributeValue(
          ...
          if (fullTypeName != null) {
            ...
            if (!"listeUuidType".equals(type)) {
              ...
              return (ListeUuidType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                                                                            type, reader);
            }
          }
        }
        ...
        if (reader.isStartElement() &&
          ...
          list1.add(fr.cirtil.www.saeservice.UuidType.Factory.parse(
                                                                    reader));
          ...
          object.setUuid((fr.cirtil.www.saeservice.UuidType[]) org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                                                                               fr.cirtil.www.saeservice.UuidType.class, list1));
