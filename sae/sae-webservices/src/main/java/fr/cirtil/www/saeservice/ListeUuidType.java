...
public class ListeUuidType implements org.apache.axis2.databinding.ADBBean {
    ...
    public void addUuid(fr.cirtil.www.saeservice.UuidType param) {
        ...
        java.util.List list = org.apache.axis2.databinding.utils.ConverterUtil.toList(localUuid);
        list.add(param);
        this.localUuid = (fr.cirtil.www.saeservice.UuidType[]) list.toArray(new fr.cirtil.www.saeservice.UuidType[list.size()]);
    }
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localUuid != null) {
            for (int i = 0; i < localUuid.length; i++) {
                if (localUuid[i] != null) {
                    localUuid[i].serialize(new javax.xml.namespace.QName(
    ...
    public static class Factory {
        ...
        public static ListeUuidType parse(
            ...
            ListeUuidType object = new ListeUuidType();
