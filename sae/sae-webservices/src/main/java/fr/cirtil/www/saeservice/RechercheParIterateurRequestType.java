...
public class RechercheParIterateurRequestType implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public void setRequetePrincipale(
        fr.cirtil.www.saeservice.RequetePrincipaleType param) {
     ...
     */
    public void setIdentifiantPage(
        fr.cirtil.www.saeservice.IdentifiantPageType param) {
     ...
     */
    public void setMetadonnees(
        fr.cirtil.www.saeservice.ListeMetadonneeCodeType param) {
    ...
    public static class Factory {
        ...
        public static RechercheParIterateurRequestType parse(
            ...
            RechercheParIterateurRequestType object = new RechercheParIterateurRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"rechercheParIterateurRequestType".equals(type)) {
                            ...
                            return (RechercheParIterateurRequestType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setRequetePrincipale(fr.cirtil.www.saeservice.RequetePrincipaleType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setFiltres(fr.cirtil.www.saeservice.FiltreType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.cirtil.fr/saeService", "identifiantPage").equals(
                            reader.getName())) {
                    object.setIdentifiantPage(fr.cirtil.www.saeservice.IdentifiantPageType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setMetadonnees(fr.cirtil.www.saeservice.ListeMetadonneeCodeType.Factory.parse(
                            reader));
