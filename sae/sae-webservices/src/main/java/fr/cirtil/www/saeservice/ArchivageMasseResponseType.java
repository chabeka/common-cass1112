/**
 * ArchivageMasseResponseType.java
 *
...
public class ArchivageMasseResponseType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":archivageMasseResponseType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
        ...
        public static ArchivageMasseResponseType parse(
            ...
            ArchivageMasseResponseType object = new ArchivageMasseResponseType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"archivageMasseResponseType".equals(type)) {
                            ...
                            return (ArchivageMasseResponseType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
