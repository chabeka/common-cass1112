...
public class ArchivageUnitairePJRequestType implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setArchivageUnitairePJRequestTypeChoice_type0(
        fr.cirtil.www.saeservice.ArchivageUnitairePJRequestTypeChoice_type0 param) {
    ...
    public static class Factory {
        ...
        public static ArchivageUnitairePJRequestType parse(
            ...
            ArchivageUnitairePJRequestType object = new ArchivageUnitairePJRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"archivageUnitairePJRequestType".equals(type)) {
                            ...
                            return (ArchivageUnitairePJRequestType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setMetadonnees(fr.cirtil.www.saeservice.ListeMetadonneeType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement()) {
                    object.setArchivageUnitairePJRequestTypeChoice_type0(fr.cirtil.www.saeservice.ArchivageUnitairePJRequestTypeChoice_type0.Factory.parse(
                            reader));
                } // End of if for expected property start element
