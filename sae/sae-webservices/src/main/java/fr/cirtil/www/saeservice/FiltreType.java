...
public class FiltreType implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public void setRangeFilter(
        fr.cirtil.www.saeservice.ListeRangeMetadonneeType param) {
     ...
     */
    public void setNotInRangeFilter(
        fr.cirtil.www.saeservice.ListeRangeMetadonneeType param) {
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localEqualFilterTracker) {
            ...
            localEqualFilter.serialize(new javax.xml.namespace.QName(
                    "http://www.cirtil.fr/saeService", "equalFilter"), xmlWriter);
        }
        ...
        if (localRangeFilterTracker) {
            ...
            localRangeFilter.serialize(new javax.xml.namespace.QName(
                    "http://www.cirtil.fr/saeService", "rangeFilter"), xmlWriter);
        }
    ...
    public static class Factory {
         ...
         */
        public static FiltreType parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            FiltreType object = new FiltreType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"filtreType".equals(type)) {
                            ...
                            return (FiltreType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setEqualFilter(fr.cirtil.www.saeservice.ListeMetadonneeType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.cirtil.fr/saeService", "notEqualFilter").equals(
                            reader.getName())) {
                    object.setNotEqualFilter(fr.cirtil.www.saeservice.ListeMetadonneeType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setRangeFilter(fr.cirtil.www.saeservice.ListeRangeMetadonneeType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setNotInRangeFilter(fr.cirtil.www.saeservice.ListeRangeMetadonneeType.Factory.parse(
                            reader));
