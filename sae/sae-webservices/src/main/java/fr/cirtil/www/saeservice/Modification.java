...
public class Modification implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setModification(
        fr.cirtil.www.saeservice.ModificationRequestType param) {
    ...
    public static class Factory {
        ...
        public static Modification parse(
            ...
            Modification object = new Modification();
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setModification(fr.cirtil.www.saeservice.ModificationRequestType.Factory.parse(
                                    reader));
