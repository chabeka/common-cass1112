...
public class ListeMetadonneeCodeType implements org.apache.axis2.databinding.ADBBean {
  ...
  protected void validateMetadonneeCode(
                                        final fr.cirtil.www.saeservice.MetadonneeCodeType[] param) {
  }
  ...
  public void addMetadonneeCode(
    ...
    list.add(param);
    localMetadonneeCode = (fr.cirtil.www.saeservice.MetadonneeCodeType[]) list.toArray(new fr.cirtil.www.saeservice.MetadonneeCodeType[list.size()]);
  }
