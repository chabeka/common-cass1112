...
public class Consultation implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setConsultation(
        fr.cirtil.www.saeservice.ConsultationRequestType param) {
    ...
    public static class Factory {
        ...
        public static Consultation parse(
            ...
            Consultation object = new Consultation();
                ...
                while (!reader.isEndElement()) {
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                            ...
                            object.setConsultation(fr.cirtil.www.saeservice.ConsultationRequestType.Factory.parse(
                                    reader));
