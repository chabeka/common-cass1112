...
@SuppressWarnings({"unchecked",
                   "unused", "pmd:MethodReturnsInternalArray"
})
public class ListeTraitementsMasseType implements org.apache.axis2.databinding.ADBBean {
  ...
  protected void validateTraitementMasse(
                                         final fr.cirtil.www.saeservice.TraitementMasseType[] param) {
  }
  ...
  public void addTraitementMasse(
    ...
    list.add(param);
    localTraitementMasse = (fr.cirtil.www.saeservice.TraitementMasseType[]) list.toArray(new fr.cirtil.www.saeservice.TraitementMasseType[list.size()]);
  }
