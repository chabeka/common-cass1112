...
public class RechercheParIterateurResponseType implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setResultats(
        fr.cirtil.www.saeservice.ListeResultatRechercheType param) {
     ...
     */
    public void setIdentifiantPageSuivante(
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (localIdentifiantPageSuivanteTracker) {
            ...
            localIdentifiantPageSuivante.serialize(new javax.xml.namespace.QName(
                    "http://www.cirtil.fr/saeService", "identifiantPageSuivante"),
                xmlWriter);
        }
    ...
    public static class Factory {
        ...
        public static RechercheParIterateurResponseType parse(
            ...
            RechercheParIterateurResponseType object = new RechercheParIterateurResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"rechercheParIterateurResponseType".equals(type)) {
                            ...
                            return (RechercheParIterateurResponseType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            ...
                            reader.getName())) {
                    object.setResultats(fr.cirtil.www.saeservice.ListeResultatRechercheType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.cirtil.fr/saeService",
                            "identifiantPageSuivante").equals(reader.getName())) {
                    object.setIdentifiantPageSuivante(fr.cirtil.www.saeservice.IdentifiantPageType.Factory.parse(
                            reader));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName(
                            "http://www.cirtil.fr/saeService", "dernierePage").equals(
                            reader.getName())) {
