...
/**
 *  ConsultationRequestType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultationRequestType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
        ...
        public static ConsultationRequestType parse(
            ...
            ConsultationRequestType object = new ConsultationRequestType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultationRequestType".equals(type)) {
                            ...
                            return (ConsultationRequestType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
