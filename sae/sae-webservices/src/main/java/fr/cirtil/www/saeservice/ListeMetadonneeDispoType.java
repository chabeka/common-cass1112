...
public class ListeMetadonneeDispoType implements org.apache.axis2.databinding.ADBBean {
  ...
  protected void validateMetadonnee(
                                    final fr.cirtil.www.saeservice.MetadonneeDispoType[] param) {
  }
  ...
  public void addMetadonnee(
    ...
    list.add(param);
    localMetadonnee = (fr.cirtil.www.saeservice.MetadonneeDispoType[]) list.toArray(new fr.cirtil.www.saeservice.MetadonneeDispoType[list.size()]);
  }
