...
/**
 *  ModificationRequestType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ModificationRequestType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
        ...
        public static ModificationRequestType parse(
            ...
            ModificationRequestType object = new ModificationRequestType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"modificationRequestType".equals(type)) {
                            ...
                            return (ModificationRequestType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
