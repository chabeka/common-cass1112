...
public class ListeMetadonneeType implements org.apache.axis2.databinding.ADBBean {
  ...
  protected void validateMetadonnee(
                                    final fr.cirtil.www.saeservice.MetadonneeType[] param) {
  }
   ...
   */
  public void setMetadonnee(final fr.cirtil.www.saeservice.MetadonneeType[] param) {
   ...
   */
  public void addMetadonnee(final fr.cirtil.www.saeservice.MetadonneeType param) {
    ...
    list.add(param);
    localMetadonnee = (fr.cirtil.www.saeservice.MetadonneeType[]) list.toArray(new fr.cirtil.www.saeservice.MetadonneeType[list.size()]);
  }
