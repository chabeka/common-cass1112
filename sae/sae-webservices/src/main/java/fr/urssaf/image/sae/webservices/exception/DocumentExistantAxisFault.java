...
public class DocumentExistantAxisFault extends AxisFault {
    ...
    */
   public DocumentExistantAxisFault(String localPart, String message, Throwable cause) {
    ...
    *           message de l'exception
    */
   public DocumentExistantAxisFault(String localPart, String message) {
