...
public class TracesWsSupport {
  ...
  public final void traceEchecWs(final MessageContext msgCtx, final String soapRequest,
    ...
    try {
      ...
      final String nomOperation = msgCtx.getAxisOperation().getName()
          .getLocalPart();
      ...
      final String codeEvt = getCodeEvtPourTrace(nomOperation);
  ...
  private String getCodeEvtPourTrace(final String nomOperation) {
  ...
  public final void traceEchec(final String codeEvt, final String nomOperation,
                               final String soapRequest, final Exception exception, final String clientIP) {
   ...
   */
  @SuppressWarnings("PMD.AvoidCatchingThrowable")
  public final void traceChargementCertAcRacine(final List<String> fichiers) {
   ...
   */
  @SuppressWarnings("PMD.AvoidCatchingThrowable")
  public final void traceChargementCRL(final List<String> fichiers) {
   ...
   */
  @SuppressWarnings("PMD.AvoidCatchingThrowable")
  public final void traceErreurChargementCRL(final List<String> fichiers) {
  ...
  private void traceChargementFichiers(final String codeEvt, final String contexte,
