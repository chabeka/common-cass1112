...
public class SuppressionMasseFailureTest {
   ...
   @Test
   public void suppressionMasse_failure_RuntimeException() throws AxisFault {
      ...
      try {
         ...
         Assert
               .fail("l'appel de la suppression en masse doit lever une exception AxisFault");

      } catch (AxisFault axisFault) {

         assertAxisFault(axisFault, "ErreurInterneSuppression",
