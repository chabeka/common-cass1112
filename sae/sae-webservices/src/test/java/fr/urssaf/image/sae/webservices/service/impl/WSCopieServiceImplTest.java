...
public class WSCopieServiceImplTest {

   @Autowired
   private WSCopieServiceImpl copieService;
   ...
   @Test
   public void copie_success() throws ParseException,
         ...
         ConnectionServiceEx, IOException {
      ...
      EasyMock.reset(saeCopieService);
