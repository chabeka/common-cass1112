...
public class WSRechercheServiceImplTest {
  ...
  @After
  public void after() {
    EasyMock.reset(indexCompositeService);
  }

  @Test
  public void testListeNullMDDesired_success() {
    final List<String> values = WSRechercheServiceImpl.recupererListMDDesired(null);
  ...
  public void testListeVideMDDesired_success() {
    final List<String> values = WSRechercheServiceImpl
  ...
  public void rechercheParIterateur_erreur_filtres()
    ...
    EasyMock.expect(
                    saeService.searchPaginated(EasyMock.anyObject(),
                                               EasyMock.anyObject(),
                                               EasyMock.anyObject(),
                                               EasyMock.anyObject(),
                                               EasyMock
    ...
    try {
      ...
      assertEquals("Le message d'erreur n'est pas celui attendu",
                   "test-unitaire : filtres incorrects",
                   ex.getMessage());
      assertEquals("La cause de l'exception n'est pas la bonne",
                   UnknownFiltresMetadataEx.class.getName(),
                   ex.getCause()
                     .getClass()
                     .getName());
  ...
  public void rechercheParIterateur_erreur_lucene()
    ...
    try {
      ...
      assertEquals("Le message d'erreur n'est pas celui attendu",
                   "test-unitaire : lucene incorrecte",
                   ex.getMessage());
      assertEquals("La cause de l'exception n'est pas la bonne",
                   SyntaxLuceneEx.class.getName(),
                   ex.getCause()
                     .getClass()
                     .getName());
      assertEquals("La partie local du code de l'erreur n'est pas le bon",
                   "SyntaxeLuceneNonValide",
                   ex.getFaultCode().getLocalPart());
    }
  ...
  public void rechercheParIterateur_erreur_meta_non_recherchable()
    ...
    try {
      ...
      assertEquals("Le message d'erreur n'est pas celui attendu",
                   ...
                   ex.getMessage());
      assertEquals("La cause de l'exception n'est pas la bonne",
                   MetaDataUnauthorizedToSearchEx.class.getName(),
                   ex.getCause()
                     .getClass()
                     .getName());
      assertEquals("La partie local du code de l'erreur n'est pas le bon",
  ...
  public void rechercheParIterateur_erreur_pendant_recherche()
    ...
    try {
      ...
      assertEquals("Le message d'erreur n'est pas celui attendu",
                   ...
                   ex.getMessage());
      assertEquals("La cause de l'exception n'est pas la bonne",
                   SAESearchServiceEx.class.getName(),
                   ex.getCause()
                     .getClass()
                     .getName());
      assertEquals("La partie local du code de l'erreur n'est pas le bon",
  ...
  public void rechercheParIterateur_meta_souhaitee()
    ...
    try {
      ...
      assertEquals("Le message d'erreur n'est pas celui attendu",
                   ...
                   ex.getMessage());
      assertEquals("La cause de l'exception n'est pas la bonne",
                   UnknownDesiredMetadataEx.class.getName(),
                   ex.getCause()
                     .getClass()
                     .getName());
      assertEquals("La partie local du code de l'erreur n'est pas le bon",
                   "ConsultationMetadonneesInconnues",
                   ex.getFaultCode()
                     .getLocalPart());
    }
  ...
  private RechercheParIterateur creationRequest() {
    final RechercheParIterateur request = new RechercheParIterateur();
    request.setRechercheParIterateur(new RechercheParIterateurRequestType());
    request.getRechercheParIterateur()
           .setIdentifiantPage(
    ...
    request.getRechercheParIterateur()
           .setRequetePrincipale(
                                 new RequetePrincipaleType());

    request.getRechercheParIterateur()
           .getRequetePrincipale()
    ...
    request.getRechercheParIterateur()
           .getRequetePrincipale()
           .getFixedMetadatas()
           .addMetadonnee(metaType);
    final RangeMetadonneeType rangeMeta = new RangeMetadonneeType();
  ...
  public void rechercheParIterateur_erreur_meta_non_consultable()
    ...
    try {
      ...
      assertEquals("Le message d'erreur n'est pas celui attendu",
                   ...
                   ex.getMessage());
      assertEquals("La cause de l'exception n'est pas la bonne",
                   MetaDataUnauthorizedToConsultEx.class.getName(),
                   ex.getCause()
                     .getClass()
                     .getName());
      assertEquals("La partie local du code de l'erreur n'est pas le bon",
                   "ConsultationMetadonneesInterdite",
                   ex.getFaultCode()
                     .getLocalPart());
    }
  ...
  public void rechercheParIterateur_erreur_meta_filtre_doublon()
    ...
    try {
      ...
      assertEquals("Le message d'erreur n'est pas celui attendu",
                   ...
                   ex.getMessage());
      assertEquals("La cause de l'exception n'est pas la bonne",
                   DoublonFiltresMetadataEx.class.getName(),
                   ex.getCause()
                     .getClass()
                     .getName());
      assertEquals("La partie local du code de l'erreur n'est pas le bon",
                   "RechercheMetadonneesDoublons",
                   ex.getFaultCode()
                     .getLocalPart());
    }
