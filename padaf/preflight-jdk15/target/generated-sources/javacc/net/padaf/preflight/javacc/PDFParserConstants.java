...
public interface PDFParserConstants {
  ...
  int FULL_LINE = 28;
  /** RegularExpression Id. */
  int SUBSECTION_START = 29;
  /** RegularExpression Id. */
  int SUBSECTION_ENTRIES = 30;
  /** RegularExpression Id. */
  int FIRST_OBJECT_NUMBER = 31;
  /** RegularExpression Id. */
  int TRAILER_TAG = 32;
  /** RegularExpression Id. */
  int START_DICTONNARY = 33;
  /** RegularExpression Id. */
  int END_DICTONNARY = 34;
  /** RegularExpression Id. */
  int END_LITERAL = 35;
  /** RegularExpression Id. */
  int INNER_START_LIT = 36;
  /** RegularExpression Id. */
  int STARTXREF_TAG = 37;
  /** RegularExpression Id. */
  int OBJ_NUMBER = 38;
  /** RegularExpression Id. */
  int EOF_TRAILER_TAG = 39;
