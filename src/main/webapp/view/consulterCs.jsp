...
<form:form method="post" modelAttribute="csForm" action="lancerConsultCs.do">
      ...
      <table class="tableForm">
         <tr class="tableForm">
            <td colspan="2" class="tableFormGauche">
               ...
               <label for="modeTous">Afficher tous les contrats de service</label>
            </td>
         </tr>
         <tr class="tableForm">
            <td class="tableFormGauche">
               <form:radiobutton id="modeIdentifiant" path="modeRecherche" value="modeIdentifiant" />
               <label for="modeIdentifiant">Par identifiant de contrat de service : </label>
            </td>
            <td class="tableFormGauche">
...
<c:if test="${not empty listeCs}">
   ...
   <display:table
      ...
      <display:column title="Détails">
         <a href="detailCs.do?identifiant=${csRow.codeClient}" title="Voir le détail">Détail</a>
      </display:column>
   </display:table>
</c:if>
