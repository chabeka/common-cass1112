...
<form:form method="post" modelAttribute="sessionForm">
	...
	<form:select cssClass="inputSelect" id="choixConfig" path="configuration" onchange="submit();">
...
<table style=" text-align:center; margin-top: 20px;">
	...
	<tr><td>URL DFCE : </td><td>${detailConfig.dfceAddress}</td></tr>
	<tr><td>Base : </td><td>${detailConfig.dfceBaseName}</td></tr>
</table>
