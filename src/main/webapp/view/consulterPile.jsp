...
<form:form name="formulaireConsultation" method="post"
	...
	<c:if test="${stacktrace !=null}">
       <p><textarea class="stacktrace" rows="15" cols="160"><c:out value="${stacktrace}"/></textarea></p>
   	</c:if>
	...
	<c:if test="${listeJobAffiches != null}">
		<input id="boutonActualiser" type="submit" value="Rafraîchir" name="bouton_validation" onclick="rafraichirDonnees()"/>
	</c:if>
