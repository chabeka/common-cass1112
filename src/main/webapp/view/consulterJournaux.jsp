...
<script type="text/javascript">
   ...
   function verificationForm() {
      ...
      if (document.getElementById("modeIdentifiantJournal").checked == true) {
         if (document.getElementById("journalUuid").value == "") {
   			document.getElementById("erreur").innerHTML = "L'identifiant du journal doit être renseigné";	
   			return false;
   		}
...
<c:if test="${listeJournaux != null}">
	...
	<display:table name="listeJournaux" id="journalRow" requestURI="/lancerConsultJournaux.do"
		...
		<display:column property="taille" title="Taille du journal" sortable="true"/>
