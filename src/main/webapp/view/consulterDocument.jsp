...
<body>
	...
	<form:form method="post" modelAttribute="consultationForm"
		...
		<p>
			<label for="identifiant">Identifiant du document :</label>
			<form:input cssClass="inputText" id="identifiant" path="identifiant" />
		</p>
		...
		<c:if test="${resRecherche != null}">
			<p>
				<a
					href="telecharger.do?idConsult=<c:out value="${consultationForm.identifiant}"/>">Ouvrir/Télécharger
					le document</a>
			</p>
