...
public class JobExecutionCqlForMig implements Serializable, Comparable<JobExecutionCqlForMig>{
  ...
  public void setExecutionContext(final ByteBuffer executionContext) {
    this.executionContext = executionContext;
  }

  @Override
  public int compareTo(final JobExecutionCqlForMig job) {
  ...
  public boolean equals(final Object obj) {
    ...
    final JobExecutionCqlForMig other = (JobExecutionCqlForMig) obj;
  ...
  public String toString() {
    return "JobExecutionCqlForMig [jobExecutionId=" + jobExecutionId + ", jobInstanceId=" + jobInstanceId + ", jobName=" + jobName + ", creationTime="
        + creationTime + ", executionContext=" + executionContext + ", version=" + version + ", startTime=" + startTime + ", endTime=" + endTime + ", status="
        + status + ", exitCode=" + exitCode + ", exitMessage=" + exitMessage + ", lastUpdated=" + lastUpdated + "]";
  }
