 ...
 * 
 */
public class TermInfoRangeStringColumn {
   ...
   /**
    * 
    * @param categoryValue la catégorie
    */
   ...
   /**
    * 
    * @param documentUUID l'identifiant unique du document
    */
   ...
   /**
    * 
    * @param documentVersion la version du document
    */
