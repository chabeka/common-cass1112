...
public interface DFCEServices {
    ...
    */
   Document storeDocument(Document paramDocument, StoreOptions paramStoreOptions, byte[] paramArrayOfByte, InputStream paramInputStream)
   ...
   /**
    * @see net.docubase.toolkit.service.administration.JobAdministrationService#startNextInstance(String)
    */
   ...
   /**
    * @see net.docubase.toolkit.service.administration.JobAdministrationService#start(String, String)
    */
   Long start(String jobName, String parameters) throws NoSuchDfceJobException, DfceJobInstanceAlreadyExistsException, DfceJobParametersInvalidException;

   /**
    * @see net.docubase.toolkit.service.administration.IndexAdministrationService#getIndexesOverLimitInBase(Integer, UUID)
    */
   List<IndexInformation> getIndexesOverLimitInBase(Integer limit, UUID baseUUID);

   /**
    * @see net.docubase.toolkit.service.administration.IndexAdministrationService#getIndexesInBase(UUID)
    */
   List<IndexInformation> getIndexesInBase(UUID baseUUID);

   /**
    * @see net.docubase.toolkit.service.administration.JobAdministrationService#getSummaryAsMap(long)
    */
   Map<String, String> getSummaryAsMap(long executionId) throws NoSuchDfceJobExecutionException;

   /**
    * @see net.docubase.toolkit.service.administration.JobAdministrationService#restart(long)
    */
   Long restart(long executionId) throws DfceJobInstanceAlreadyCompleteException, NoSuchDfceJobExecutionException, NoSuchDfceJobException,
         DfceJobRestartException, DfceJobParametersInvalidException;

   /**
    * @see net.docubase.toolkit.service.ged.ArchiveService#isDocumentLogsArchiveRunning()
    */
   boolean isDocumentLogsArchiveRunning();

   /**
    * @see net.docubase.toolkit.service.ged.ArchiveService#getLastDocumentLogsArchiveUUID()
    */
   UUID getLastDocumentLogsArchiveUUID();

   /**
    * @see net.docubase.toolkit.service.ged.ArchiveService#getLastSucessfulDocumentLogsArchiveRunDate()
    */
   Date getLastSucessfulDocumentLogsArchiveRunDate();

   /**
    * @see net.docubase.toolkit.service.ged.ArchiveService#getLastSystemLogsArchiveUUID()
    */
   UUID getLastSystemLogsArchiveUUID();

   /**
    * @see net.docubase.toolkit.service.ged.ArchiveService#getLastSucessfulSystemLogsArchiveRunDate()
    */
   Date getLastSucessfulSystemLogsArchiveRunDate();
