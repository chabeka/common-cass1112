 ...
 * 
 */
public class SearchSyntaxIT extends AbstractTestBase {
   ...
   public static final String BASE_NAME = SearchSyntaxIT.class.getSimpleName();
   ...
   public static void prepareTestData() throws ObjectAlreadyExistsException, FileNotFoundException,
      ...
      newBase = ToolkitFactory.getInstance().createBase(SearchSyntaxIT.class.getSimpleName());
