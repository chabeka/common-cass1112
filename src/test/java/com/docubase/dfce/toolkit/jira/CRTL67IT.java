...
public class CRTL67IT extends AbstractCRTLIT {
   ...
   public void testArchivageDateDate() throws ExceededSearchLimitException,
      ...
      String formattedArchivageDate = serviceProvider.getSearchService()
            .formatDate(documentArchivageDate, DateFormat.DATETIME).substring(0, 8);

      SortedSearchQuery query = toolkitFactory.createMonobasePagedQuery("srn:" + SRN_VALUE
            + " AND " + SystemFieldName.SM_ARCHIVAGE_DATE + ":" + formattedArchivageDate, 10, base);

      SearchResult searchResult = serviceProvider.getSearchService().search(query);
      assertEquals(1, searchResult.getTotalHits());
   }

   @Test
   public void testArchivageDateDateTime() throws ExceededSearchLimitException,
         SearchQueryParseException {

      String formattedArchivageDate = serviceProvider.getSearchService().formatDate(
            documentArchivageDate, DateFormat.DATETIME);
   ...
   public void testArchivageDateRange() throws ExceededSearchLimitException,
         SearchQueryParseException {
      SortedSearchQuery query = toolkitFactory.createMonobasePagedQuery("srn:" + SRN_VALUE
            + " AND " + SystemFieldName.SM_ARCHIVAGE_DATE + ":[20000101 TO 20121231]", 10, base);
   ...
   @Test
   public void testLifeCycleReferenceDateDate() throws ExceededSearchLimitException,
         SearchQueryParseException {
      SortedSearchQuery query = toolkitFactory.createMonobasePagedQuery("srn:" + SRN_VALUE
            + " AND " + SystemFieldName.SM_LIFE_CYCLE_REFERENCE_DATE + ":20111013", 10, base);
   ...
   @Test
   public void testLifeCycleReferenceDateDateTime() throws ExceededSearchLimitException,
         SearchQueryParseException {
      SortedSearchQuery query = toolkitFactory.createMonobasePagedQuery("srn:" + SRN_VALUE
            + " AND " + SystemFieldName.SM_LIFE_CYCLE_REFERENCE_DATE + ":201110132010", 10, base);
   ...
   @Test
   public void testLifeCycleReferenceDateRange() throws ExceededSearchLimitException,
         SearchQueryParseException {

      SortedSearchQuery query = toolkitFactory.createMonobasePagedQuery("srn:" + SRN_VALUE
            + " AND " + SystemFieldName.SM_LIFE_CYCLE_REFERENCE_DATE + ":[20111013 TO 20111014]",
            10, base);
   ...
   public void testCreationDateDate() throws ExceededSearchLimitException,
         SearchQueryParseException {
      String formattedCreationDate = serviceProvider.getSearchService()
            .formatDate(CREATION_DATE, DateFormat.DATETIME).substring(0, 8);

      SortedSearchQuery query = toolkitFactory.createMonobasePagedQuery("srn:" + SRN_VALUE
            + " AND " + SystemFieldName.SM_CREATION_DATE + ":" + formattedCreationDate, 10, base);
   ...
   public void testCreationDateDateTime() throws ExceededSearchLimitException,
         SearchQueryParseException {
      String formattedCreationDate = serviceProvider.getSearchService().formatDate(CREATION_DATE,
            DateFormat.DATETIME);
   ...
   public void testCreationDateRange() throws ExceededSearchLimitException,
      ...
      SortedSearchQuery query = toolkitFactory.createMonobasePagedQuery("srn:" + SRN_VALUE
            + " AND " + SystemFieldName.SM_CREATION_DATE + ":[20090618 TO 20090621]", 10, base);
