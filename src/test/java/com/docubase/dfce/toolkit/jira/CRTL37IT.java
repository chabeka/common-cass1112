...
public class CRTL37IT {
   ...
   private static ServiceProvider serviceProvider = ServiceProvider.newServiceProvider();

   @Test
   public void getBaseMultiThread() {
      serviceProvider.connect(ADM_LOGIN, ADM_PASSWORD, AbstractTestBase.SERVICE_URL);
