...
public class CRTL65IT extends AbstractCRTLIT {
   ...
   private void storeDocuments() {
      ...
      document.addCriterion(NCE, NCE_VALUE);
      document.addCriterion(DATE, new GregorianCalendar(2011, 9, 17).getTime());
   ...
   @Test
   public void testDate() throws ExceededSearchLimitException, SearchQueryParseException {
   ...
   public void testDateFormattedDate() throws ExceededSearchLimitException,
      ...
      Calendar calendar = Calendar.getInstance();
      calendar.set(2011, 9, 17);
      String formattedDate = serviceProvider.getSearchService().formatDate(calendar.getTime(),
            DateFormat.DATE);
   ...
   @Test
   public void testDateFormattedTimeZonedDate() throws ExceededSearchLimitException,
         SearchQueryParseException {
