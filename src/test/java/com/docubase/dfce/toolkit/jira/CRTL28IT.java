...
public class CRTL28IT extends AbstractTestCaseCreateAndPrepareBase {
   ...
   public CRTL28IT(int input, int expected) {
      this.nbThread = input;
   ...
   class SearchThenExtractTask implements Callable<File> {
      ...
      private final ServiceProvider localServiceProvider = ServiceProvider.newServiceProvider();
      ...
      public File call() throws Exception {
         ...
         SearchResult result = localServiceProvider.getSearchService().search(luceneQuery, 100,
               base, null);
         ...
         if (result != null && result.getDocuments() != null) {
            ...
            for (Document document : result.getDocuments()) {
               extractedDoc = localServiceProvider.getStoreService().getDocumentFile(document);
            }
         } else {
