...
public class CRTL54IT extends AbstractTestCaseCreateAndPrepareBase {
   ...
   @Test
   public void testDeindexDocument() throws ExceededSearchLimitException, FrozenDocumentException,
      ...
      List<Document> docs = searchService.search(c1Query, 10, base).getDocuments();
      ...
      Document documentByUUID = searchService.getDocumentByUUID(base, document.getUuid());
      assertNull(documentByUUID);
   }

   @Test
   public void testUpdateDocument() throws ExceededSearchLimitException, FrozenDocumentException,
      ...
      serviceProvider.getStoreService().deleteDocument(documentByUUID.getUuid());
   }

   @Test
   public void testDeindexDocumentMultiBase() throws ExceededSearchLimitException,
      ...
      assertNotNull(searchService.getDocumentByUUIDMultiBase(document.getUuid()));
      List<Document> docs = searchService.multiBaseSearch(c1Query, 10).getDocuments();
      assertEquals(1, docs.size());
      assertEquals(document.getUuid(), docs.get(0).getUuid());
   ...
   public void testDeindexOneOutOfTwo() throws ExceededSearchLimitException,
      ...
      document2 = storeDocument(document2, TestUtils.getFile("doc1.pdf"), true);

      assertNotNull(searchService.getDocumentByUUID(base, document.getUuid()));
      assertNotNull(searchService.getDocumentByUUID(base, document2.getUuid()));
      assertNotSame(document.getUuid(), document2.getUuid());

      List<Document> documents = searchService.search(c1Query, 10, base).getDocuments();
   ...
   @Test
   public void testDeindexVirtualDocument() throws ExceededSearchLimitException,
         FrozenDocumentException, TagControlException, SearchQueryParseException {
      Document document = toolkitFactory.createDocumentTag(base);
      document.addCriterion(category0, "testDeindexVirtualDocument");
      document.addCriterion(category1, "index1");

      FileReference fileReference = serviceProvider.getStorageAdministrationService()
            .createFileReference("doc1", "pdf", inputStream);
      document = serviceProvider.getStoreService().storeVirtualDocument(document, fileReference, 1,
            1);
   ...
   @Test
   public void testUpdateVirtualDocument() throws ExceededSearchLimitException,
         FrozenDocumentException, TagControlException, SearchQueryParseException {
      Document document = toolkitFactory.createDocumentTag(base);
      document.addCriterion(category0, "testDeindex");
      document.addCriterion(category1, "index1");
   ...
   @Test
   public void testDeindexVirtualDocumentMultiBase() throws ExceededSearchLimitException,
         FrozenDocumentException, TagControlException, SearchQueryParseException {
      Document document = toolkitFactory.createDocumentTag(base);
      document.addCriterion(category0, "testDeindex");
      document.addCriterion(category1, "index1");
   ...
   @Test
   public void testDeindexOneOutOfTwoVirtuals() throws ExceededSearchLimitException,
         FrozenDocumentException, TagControlException, SearchQueryParseException {
      Document document = toolkitFactory.createDocumentTag(base);
      document.addCriterion(category0, "testDeindexVirtualDocument");
      document.addCriterion(category1, "index1");
      ...
      document2.addCriterion(category0, "testDeindex2");
      document2.addCriterion(category1, "index1");
      FileReference fileReference2 = serviceProvider.getStorageAdministrationService()
            .createFileReference("doc1", "pdf", inputStream);
      document2 = serviceProvider.getStoreService().storeVirtualDocument(document2, fileReference2,
            1, 1);
