...
public class VirtualDocumentIT extends AbstractTestCaseCreateAndPrepareBase {
    ...
    */
   private static Document insertVirtualDocument(FileReference fileReference, int startPage,
         int endPage, String name) throws TagControlException {
      ...
      Document documentStored = serviceProvider.getStoreService().storeVirtualDocument(document,
   ...
   public void test_EndPage_Smaller_Than_StartPage() throws TagControlException {
      ...
      serviceProvider.getStoreService().storeVirtualDocument(documentTag, fileReference, 2, 1);
   }
   ...
   public void test_StartPage_Smaller_Than_1() throws TagControlException {
      ...
      serviceProvider.getStoreService().storeVirtualDocument(documentTag, fileReference, 0, 5);
   }
    ...
    */
   @Test
   public void testInsertAndExtractVirtualDocument() throws IOException, TagControlException,
         NoSuchAlgorithmException {
      logger.info("Start testVirtualDocument()...");
      int startPage = 3;
      int endPage = 5;

      Document document = insertVirtualDocument(fileReference, startPage, endPage, "VirtualDoc.pdf");
   ...
   public void test_Modify_StartPage() throws IOException, TagControlException,
      ...
      Document document = insertVirtualDocument(fileReference, startPage, endPage, "StartPage3.pdf");
   ...
   @Test
   public void testDelete() throws TagControlException, FrozenDocumentException, IOException {
      Document documentToDelete = insertVirtualDocument(fileReference, 1, 3, "dv1");
      Document document = insertVirtualDocument(fileReference, 2, 4, "dv2");

      serviceProvider.getStoreService().deleteDocument(documentToDelete.getUuid());
