...
public class CompositeQueriesIT extends AbstractTestCaseCreateAndPrepareBase {
   @BeforeClass
   public static void setup() throws TagControlException {
      ...
      serviceProvider.getStoreService().storeDocument(document, "doc1", "pdf", inputStream);
      ...
      serviceProvider.getStoreService().storeDocument(document, "doc2", "pdf", inputStream);
      ...
      inputStream = TestUtils.getInputStream("doc1.pdf");
      serviceProvider.getStoreService().storeDocument(document, "doc3", "pdf", inputStream);
      ...
      inputStream = TestUtils.getInputStream("doc1.pdf");
      serviceProvider.getStoreService().storeDocument(document, "doc4", "pdf", inputStream);
   }

   @Test
   public void testSubQueriesAndRange() throws ExceededSearchLimitException,
         SearchQueryParseException {
      String query = "(" + category1.getName() + ":" + "c11" + " AND " + category2.getName() + ":"
            + "c21" + ") OR (" + category1.getName() + ":" + "c12" + " AND " + category2.getName()
            + ":" + "c*" + ")";

      SearchResult searchResult = serviceProvider.getSearchService().search(query, 500, base);
   ...
   @Test
   public void testDeepQuery() throws ExceededSearchLimitException, SearchQueryParseException {
      String c0 = category0.getName();
      String c1 = category1.getName();
      String c2 = category2.getName();
      String cI = categoryInteger.getName();
      ...
      String query = c0Term + " OR ((" + cITerm + " AND (" + c2Term + ")) AND (" + c1Term + "))";
   ...
   @Test
   public void testDeepQueryANDNot() throws ExceededSearchLimitException, SearchQueryParseException {
      String c0 = category0.getName();
      String c1 = category1.getName();
      String c2 = category2.getName();
      String cI = categoryInteger.getName();
   ...
   @Test
   public void testDeepQueryORNot() throws ExceededSearchLimitException, SearchQueryParseException {
      String c0 = category0.getName();
      String c1 = category1.getName();
      String c2 = category2.getName();
      String cI = categoryInteger.getName();
