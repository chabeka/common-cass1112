...
public class TypedCategoryIT extends AbstractTestCaseCreateAndPrepareBase {
   ...
   @Test
   public void testTypedBoolean() throws ExceededSearchLimitException, SearchQueryParseException {
      ...
      Document actual = storeDocument(document, TestUtils.getFile("doc1.pdf"), true);
   ...
   @Test
   public void testTypedInteger() throws ExceededSearchLimitException, SearchQueryParseException {
      BaseCategory stringCategory = base.getBaseCategory(catNames[0]);
      ...
      Document storeDoc = storeDocument(document, TestUtils.getFile("doc1.pdf"), true);
   ...
   @Test
   public void testTypedDecimal() throws ExceededSearchLimitException, SearchQueryParseException {
      BaseCategory stringCategory = base.getBaseCategory(catNames[0]);
   ...
   @Test
   public void testTypedDate() throws ExceededSearchLimitException, SearchQueryParseException {
      // Type DATE
      ...
      assertEquals((new DateTime(currDate.getTime())).toDateMidnight().toDate(), new DateTime(
            ((Date) dateCriterion.getWord()).getTime()).toDateMidnight().toDate());
   ...
   @Test
   public void testTypedDateTime() throws ExceededSearchLimitException, SearchQueryParseException {
   ...
   @Test
   public void testMixTyped() throws ExceededSearchLimitException, SearchQueryParseException {
      BaseCategory stringCategory = base.getBaseCategory(catNames[0]);
      BaseCategory booleanCategory = base.getBaseCategory(catNames[3]);
      BaseCategory integerCategory = base.getBaseCategory(catNames[4]);
      BaseCategory decimalBaseCategory = base.getBaseCategory(catNames[5]);
   ...
   @Test
   public void testWildcard() throws ExceededSearchLimitException, SearchQueryParseException {
      BaseCategory stringCategory = base.getBaseCategory(catNames[0]);
