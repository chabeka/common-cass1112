...
public class SecurityIT extends AbstractTestCaseCreateAndPrepareBase {
   ...
   public void testMalformedURL() {
      serviceProvider.connect(AbstractTestBase.ADM_LOGIN, AbstractTestBase.ADM_PASSWORD,
            "malformed" + AbstractTestBase.SERVICE_URL);
   }

   @Test(expected = RuntimeException.class)
   public void testRoleUserOperationAdmin() {
      serviceProvider.connect(SIMPLE_USER_NAME, SIMPLE_USER_PASSWORD, AbstractTestBase.SERVICE_URL);
