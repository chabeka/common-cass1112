...
public abstract class AbstractTestBase {
   ...
   public static ServiceProvider serviceProvider = ServiceProvider.newServiceProvider();

   /** The Constant toolkitFactory. */
   public static final ToolkitFactory toolkitFactory = ToolkitFactory.getInstance();
    ...
    * @return the base
    */
   protected static Base createBase(String baseId, BaseCategory... baseCategories) {
      ...
      logger.info("Base " + baseId + " created with categories:" + baseCategories);
      return base;
   }

   protected static BaseCategory createBaseCategory(String name, CategoryDataType type,
         boolean indexed) {
      Category category = serviceProvider.getStorageAdministrationService().findOrCreateCategory(
            name, type);
      BaseCategory baseCategory = toolkitFactory.createBaseCategory(category, indexed);
      return baseCategory;
   }
    ...
    */
   protected static BaseCategory createBaseCategory(String name, CategoryDataType type,
         boolean indexed, boolean dictionnary, int min, int max, boolean single) {
      Category category = serviceProvider.getStorageAdministrationService().findOrCreateCategory(
            name, type);
      BaseCategory baseCategory = toolkitFactory.createBaseCategory(category, indexed);
    ...
    */
   protected static Document storeDocument(Document document, File file, boolean expectStore) {
