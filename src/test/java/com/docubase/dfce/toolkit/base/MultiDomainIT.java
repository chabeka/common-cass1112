...
public class MultiDomainIT extends AbstractTestBase {
   private static final Map<String, String> catValues = new HashMap<String, String>();

   private static final Logger LOGGER = Logger.getLogger(MultiDomainIT.class);
   ...
   public void testDifferentDomains() throws Exception {
      ...
      docs = searchMulti(base3, base3.getBaseCategory(CATA).getName() + ":" + catValues.get(CATA),
            1000, null);
       ...
       */
      docs = searchMulti(base2, base2.getBaseCategory(CATA).getName() + ":" + catValues.get(CATA),
            1000, null);
      assertNotNull(docs);
      assertEquals(2, docs.size());
   ...
   private static List<Document> searchMulti(Base target, String queryTxt, int limit,
         Integer nbExpectedResults) throws ExceededSearchLimitException, SearchQueryParseException {
