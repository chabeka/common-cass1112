...
public class IndexCompositeIT extends AbstractTestCaseCreateAndPrepareBase {
   ...
   public void testCompositeSearch() throws ExceededSearchLimitException,
         SearchQueryParseException, InterruptedException, NoSuchJobException,
      ...
      Category category1 = serviceProvider.getStorageAdministrationService().getCategory(
            catNames[1]);
      Category category2 = serviceProvider.getStorageAdministrationService().getCategory(
            catNames[2]);
      CompositeIndex compositeIndex = serviceProvider.getStorageAdministrationService()
            .findOrCreateCompositeIndex(category1, category2);
      ...
      String query = category1.getName() + ":TestComposite10 AND " + category2.getName()
            + ":Joker10";

      SearchResult search = serviceProvider.getSearchService().search(query, 10000, base);
