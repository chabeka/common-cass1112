...
public class LifeCycleReferentialTest extends AbstractTestCaseCreateAndPrepareBase {
   ...
   public void testCreateLifeCycleRule() throws ObjectAlreadyExistsException {
      ...
      LifeCycleRule newLifeCycleRule = serviceProvider.getStorageAdministrationService()
            .createNewLifeCycleRule(documentType, 12, LifeCycleLengthUnit.YEAR);

      assertEquals(documentType, newLifeCycleRule.getDocumentType());
      assertEquals(12, newLifeCycleRule.getLifeCycleLength());
      assertEquals(LifeCycleLengthUnit.YEAR, newLifeCycleRule.getLifeCycleLengthUnit());
   }

   @Test(expected = ObjectAlreadyExistsException.class)
   public void testCreateLifeCycleRuleAlreadyExists() throws ObjectAlreadyExistsException {
      String documentType = "documentType" + UUID.randomUUID().toString();
      serviceProvider.getStorageAdministrationService().createNewLifeCycleRule(documentType, 12,
            LifeCycleLengthUnit.YEAR);

      serviceProvider.getStorageAdministrationService().createNewLifeCycleRule(documentType, 1,
   ...
   public void testGetLifeCycleRule() throws ObjectAlreadyExistsException {
      ...
      assertEquals(LifeCycleLengthUnit.MONTH, lifeCycleRule.getLifeCycleLengthUnit());
   }
   ...
   public void testGetAllLifeCycleRules() throws ObjectAlreadyExistsException {
      ...
      Set<LifeCycleRule> allLifeCycleRules = serviceProvider.getStorageAdministrationService()
   ...
   public void testGetAllTypes() throws ObjectAlreadyExistsException {
      ...
      Set<String> allDocumentTypes = serviceProvider.getStorageAdministrationService()
            .getAllDocumentTypes();
