...
public class FormatConversionUtilsTest {
   ...
   public void testSuccess() throws FormatConversionParametrageException {
      ...
      Assert.assertEquals("Le numero de page de fin devrait etre 12", 12, param.getNumeroPageFin());
      ...
      Assert.assertEquals("Le numero de page de fin devrait etre 10", 10, param.getNumeroPageFin());
      ...
      Assert.assertEquals("Le numero de page de fin devrait etre 20", 20, param.getNumeroPageFin());
      ...
      param = FormatConversionUtils.getParametresConversion(null, Integer.valueOf(-10), 20);
      Assert.assertEquals("Le numero de page de debut devrait etre 11", 11, param.getNumeroPageDebut());
      Assert.assertEquals("Le numero de page de fin devrait etre 20", 20, param.getNumeroPageFin());
      ...
      Assert.assertEquals("Le numero de page de debut devrait etre 1", 1, param.getNumeroPageDebut());
      Assert.assertEquals("Le numero de page de fin devrait etre 2", 2, param.getNumeroPageFin());
      ...
      // Cas de test 11 : 10 pages a partir de la page 10
      param = FormatConversionUtils.getParametresConversion(Integer.valueOf(10), Integer.valueOf(10), 20);
      Assert.assertEquals("Le numero de page de debut devrait etre 10", 10, param.getNumeroPageDebut());
      Assert.assertEquals("Le numero de page de fin devrait etre 19", 19, param.getNumeroPageFin());
      
      // Cas de test 12 : -9 pages a partir de la page 10
      param = FormatConversionUtils.getParametresConversion(Integer.valueOf(10), Integer.valueOf(-9), 20);
      Assert.assertEquals("Le numero de page de debut devrait etre 2", 2, param.getNumeroPageDebut());
      Assert.assertEquals("Le numero de page de fin devrait etre 10", 10, param.getNumeroPageFin());
