...
public class SessionToolsTest {
   ...
   public void constructeurPrive() throws TestConstructeurPriveException {
      Boolean result = TestsUtils
            .testConstructeurPriveSansArgument(SessionTools.class);
    ...
    */
   @Test
   public void maquetteConfig() throws MaquetteThemeException {
      ...
      assertNull(
            "L'objet MaquetteConfig n'aurait pas dû être stocké en session",
            maquetteFilterConfigSess);
      ...
      maquetteFilterConfigSess = SessionTools.getFilterConfig(request);
      assertNotNull("L'objet MaquetteConfig aurait dû être stocké en session",
            maquetteFilterConfigSess);
   ...
   public void selectedMenu() {
      ...
      assertNull("Le menu en cours n'aurait pas dû être stocké en session",
            selectedMenuSess);
      ...
      selectedMenuSess = SessionTools.getSelectedMenu(request);
      assertNotNull("Le menu en cours aurait dû être stocké en session",
            selectedMenuSess);
