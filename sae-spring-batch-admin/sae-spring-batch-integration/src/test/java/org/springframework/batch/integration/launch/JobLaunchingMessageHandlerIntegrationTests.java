...
public class JobLaunchingMessageHandlerIntegrationTests {
  ...
  public void testNoReply() {
    final GenericMessage<JobLaunchRequest> trigger = new GenericMessage<>(new JobLaunchRequest(job,
                                                                                                               new JobParameters()));
    try {
    ...
    final Message<JobExecution> executionMessage = (Message<JobExecution>) responseChannel.receive(1000);
  ...
  public void testReply() {
    ...
    final JobExecution execution = executionMessage.getPayload();
