 ...
 * "restoreMasse"<br>
 * <br>
 * Un objet de cette classe s'associe au tag "restoreMasse.tag" (attribut
 * "objetFormulaire")
 */
public class RestoreMasseFormulaire extends GenericForm {
...
//   private ModeConsultationEnum modeConsult = ModeConsultationEnum.AncienServiceSansMtom;
    ...
    * @param parent
    */
   public RestoreMasseFormulaire(TestWsParentFormulaire parent) {
      super(parent);
   }
