...
import fr.urssaf.image.sae.integration.ihmweb.saeservice.modele.SaeServiceStub.GetDocFormatOrigineResponse;
...
/**
 * Service de test de l'opération "getDocFormatOrigine" du service web SaeService
 */
@SuppressWarnings( { "PMD.CyclomaticComplexity", "PMD.NPathComplexity",
      "PMD.ExcessiveMethodLength" })
@Service
public class GetDocFormatOrigineTestService {
   ...
   private GetDocFormatOrigineResultat appelWsOpGetDocFormatOrigine(String urlServiceWeb,
         ViStyle viStyle, ViFormulaire viParams,
         GetDocFormatOrigineFormulaire formulaire, WsTestListener wsListener) {

      // Initialise le résultat
      GetDocFormatOrigineResultat result = null;
      ...
      SaeServiceLogUtils.logAppelGetDocFormatOrigine(log, formulaire);
    ...
    try {
      ...
      GetDocFormatOrigine paramsService = SaeServiceObjectFactory
          .buildGetDocFormatOrigineRequest(formulaire.getIdArchivage());   

      // Appel de l'opération getDocFormatOrigine
      GetDocFormatOrigineResponse response = 
         service.getDocFormatOrigine(paramsService);

      // Transtypage de l'objet de la couche ws vers l'objet du modèle
      result = fromGetDocFormatOrigineAncienService(response);
    ...
    log
          .appendLogLn("Détails de la réponse obtenue de l'opération \"getDocFormatOrigine\" :");
    SaeServiceLogUtils.logResultatGetDocFormatOrigine(resultatTest, result);
   ...
   /**
    * Test libre de l'appel à l'opération "getDocFormatOrigine" du service web
    * SaeService.<br>
    * 
    * @param urlServiceWeb
    ...
    *           le formulaire
    */
   public final void appelWsOpGetDocFormatOrigineTestLibre(String urlServiceWeb,
         GetDocFormatOrigineFormulaire formulaire) {

      appelWsOpGetDocFormatOrigineTestLibre(urlServiceWeb, formulaire, null);
    ...
    */
   public final void appelWsOpGetDocFormatOrigineTestLibre(String urlServiceWeb,
         GetDocFormatOrigineFormulaire formulaire, ViFormulaire viParams) {
      ...
      appelWsOpGetDocFormatOrigine(urlServiceWeb, ViStyle.VI_OK, viParams, formulaire,
            testLibre);

   }

   /**
    * Test d'appel à l'opération "getDocFormatOrigine" du service web SaeService.<br>
    ...
    *           attendue
    */
   public final void appelWsOpGetDocFormatOrigineSoapFault(String urlServiceWeb,
         GetDocFormatOrigineFormulaire formulaire, ViFormulaire viParams) {
      ...
      // Appel de la méthode "générique" de test
      appelWsOpGetDocFormatOrigine(urlServiceWeb, ViStyle.VI_OK, viParams, formulaire, testLibre);
    ...
    */
   public final void appelWsOpGetDocFormatOrigineSoapFault(String urlServiceWeb,
         GetDocFormatOrigineFormulaire formulaire, ViStyle viStyle,
      ...
      // Appel de la méthode "générique" de test
      appelWsOpGetDocFormatOrigine(urlServiceWeb, viStyle, null, formulaire, testAuth);
    ...
    */
   public final void appelWsOpGetDocFormatOrigineSoapFault(String urlServiceWeb,
         GetDocFormatOrigineFormulaire formulaire, ViStyle viStyle, ViFormulaire viParams,
         String idSoapFaultAttendu, final Object[] argsMsgSoapFault) {
      ...
      // Appel de la méthode "générique" de test
      appelWsOpGetDocFormatOrigine(urlServiceWeb, viStyle, viParams, formulaire, testAuth);

   }

   private void wsVerifieRetour(GetDocFormatOrigineFormulaire formulaire,
         GetDocFormatOrigineResultat response, String sha1attendu,
    ...
    * @return la réponse de l'opération "getDocFormatOrigine", ou null si une exception
    *         s'est produite
    */
   public final GetDocFormatOrigineResultat appelWsOpGetDocFormatOrigineReponseCorrecteAttendue(
         String urlServiceWeb, GetDocFormatOrigineFormulaire formulaire,
         String sha1attendu) {

      return appelWsOpGetDocFormatOrigineReponseCorrecteAttendue(urlServiceWeb,
   ...
   public final GetDocFormatOrigineResultat appelWsOpGetDocFormatOrigineReponseCorrecteAttendue(
      ...
      // Appel de la méthode "générique" de test
      GetDocFormatOrigineResultat response = appelWsOpGetDocFormatOrigine(urlServiceWeb,
   ...
   private GetDocFormatOrigineResultat fromGetDocFormatOrigineAncienService(
         GetDocFormatOrigineResponse response) {

      // Création de l'objet résultat
      GetDocFormatOrigineResultat result = new GetDocFormatOrigineResultat();

      // Extrait le contenu (DataHandler)
      DataHandler contenu = response.getGetDocFormatOrigineResponse().getContenu();
      result.setContenu(contenu);
      
      // Extrait les métadonnées
      ListeMetadonneeType metadonnees = response.getGetDocFormatOrigineResponse()
            .getMetadonnees();
...
//   private DocFormatOrigineResultat fromDocFormatOrigineNouveauService(
//         DocFormatOrigineMTOMResponse response) {
//
//      // Création de l'objet résultat
//      DocFormatOrigineResultat result = new DocFormatOrigineResultat();
//
//      // Extrait le contenu (DataHandler)
//      DataHandler contenu = response.getDocFormatOrigineMTOMResponse().getContenu();
//      result.setContenu(contenu);
//
//      // Extrait les métadonnées
//      ListeMetadonneeType metadonnees = response.getDocFormatOrigineMTOMResponse()
//            .getMetadonnees();
//      result.setMetadonnees(metadonnees);
//
//      // Renvoie du résultat
