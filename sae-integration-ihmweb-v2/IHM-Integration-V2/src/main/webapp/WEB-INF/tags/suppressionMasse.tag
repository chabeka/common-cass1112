...
<%@ attribute name="objetFormulaire" required="true" type="fr.urssaf.image.sae.integration.ihmweb.formulaire.SuppressionMasseFormulaire" %>
...
Etape <c:out value="${numeroEtape}"/> : Appel du service web de suppression de masse
</h4>
...
<input
   ...
   type="submit"
   value="Appel du service web de supressionMasse"
