...
//import fr.urssaf.image.sae.integration.ihmweb.modele.RestoreMasseResultat;
...
//import fr.urssaf.image.sae.integration.ihmweb.modele.ModeRestoreMasseEnum;
...
import fr.urssaf.image.sae.integration.ihmweb.saeservice.modele.SaeServiceStub.RestoreMasseResponse;
...
/**
 * Service de test de l'opération "restoreMasse" du service web SaeService
 */
@SuppressWarnings( { "PMD.CyclomaticComplexity", "PMD.NPathComplexity",
      "PMD.ExcessiveMethodLength" })
@Service
public class RestoreMasseTestService {
   ...
   private RestoreMasseResponse appelWsOpRestoreMasse(String urlServiceWeb,
         ViStyle viStyle, ViFormulaire viParams,
         RestoreMasseFormulaire formulaire, WsTestListener wsListener) {


      // Initialise le résultat
      RestoreMasseResponse response = null;
      ...
      SaeServiceLogUtils.logAppelRestoreMasseSimple(log, formulaire);
 ...
 //        System.out.println("formulaire.getRequeteLucene() : " +formulaire.getRequeteLucene());
         ...
         RestoreMasse paramsService = SaeServiceObjectFactory
               .buildRestoreMasseRequest(formulaire.getIdArchivage());
                     
         // Appel du service web
         response = service.restoreMasse(paramsService);
         ...
         log.appendLogLn("Détails de la réponse obtenue de l'opération \"RestoreMasse\" :");
         log.appendLogLn(response.getRestoreMasseResponse().getUuid());
         SaeServiceLogUtils.logResultatRestoreMasse(log, response.getRestoreMasseResponse());
...
//      
//      // Initialise le résultat
//      RestoreMasseResponse result = null;
//
//      // Vide le résultat du test précédent
//      ResultatTest resultatTest = formulaire.getResultats();
//      resultatTest.clear();
...
//      // Ajout d'un log de résultat
//      SaeServiceLogUtils.logAppelRestoreMasseSimple(log, formulaire);
//      SaeServiceLogUtils.logAppelRestoreMasse(log, formulaire);
//
//      // Récupération du stub du service web
//      SaeServiceStub service = saeServiceStubUtils.getServiceStub(
//            urlServiceWeb, viStyle, viParams);
...
//      try {
//            
//            //        System.out.println("formulaire.getIdArchivage() : " +formulaire.getIdArchivage());
//            // Construction du paramètre d'entrée de l'opération
//            RestoreMasse paramsService = SaeServiceObjectFactory
//                  .buildSuppressionMasseRequest(formulaire.getIdArchivage());
//
//            // Appel du service web
//            response = service.restoreMasse(paramsService);
//            
...
//      return result;
   ...
   /**
    * Test libre de l'appel à l'opération "restoreMasse" du service web
    * SaeService.<br>
    * 
    * @param urlServiceWeb
    ...
    *           le formulaire
    */
   public final void appelWsOpRestoreMasseTestLibre(String urlServiceWeb,
         RestoreMasseFormulaire formulaire) {

      appelWsOpRestoreMasseTestLibre(urlServiceWeb, formulaire, null);
    ...
    */
   public final void appelWsOpRestoreMasseTestLibre(String urlServiceWeb,
         RestoreMasseFormulaire formulaire, ViFormulaire viParams) {
      ...
      appelWsOpRestoreMasse(urlServiceWeb, ViStyle.VI_OK, viParams, formulaire,
            testLibre);

   }

   /**
    * Test d'appel à l'opération "restoreMasse" du service web SaeService.<br>
    ...
    *           attendue
    */
   public final void appelWsOpRestoreMasseSoapFault(String urlServiceWeb,
         RestoreMasseFormulaire formulaire, ViFormulaire viParams) {
      ...
      // Appel de la méthode "générique" de test
      appelWsOpRestoreMasse(urlServiceWeb, ViStyle.VI_OK, viParams, formulaire, testLibre);
    ...
    */
   public final void appelWsOpRestoreMasseSoapFault(String urlServiceWeb,
         RestoreMasseFormulaire formulaire, ViStyle viStyle,
      ...
      // Appel de la méthode "générique" de test
      appelWsOpRestoreMasse(urlServiceWeb, viStyle, null, formulaire, testAuth);
    ...
    */
   public final void appelWsOpRestoreMasseSoapFault(String urlServiceWeb,
         RestoreMasseFormulaire formulaire, ViStyle viStyle, ViFormulaire viParams,
         String idSoapFaultAttendu, final Object[] argsMsgSoapFault) {
      ...
      // Appel de la méthode "générique" de test
      appelWsOpRestoreMasse(urlServiceWeb, viStyle, viParams, formulaire, testAuth);

   }

//   private void wsVerifieRetour(RestoreMasseFormulaire formulaire,
//         RestoreMasseResultat response, String sha1attendu,
...
//    * @return la réponse de l'opération "restoreMasse", ou null si une exception
//    *         s'est produite
//    */
//   public final RestoreMasseResultat appelWsOpRestoreMasseReponseCorrecteAttendue(
//         String urlServiceWeb, RestoreMasseFormulaire formulaire,
//         String sha1attendu) {
//
//      return appelWsOpRestoreMasseReponseCorrecteAttendue(urlServiceWeb,
...
//
//      // Appel de la méthode "générique" de test
//      RestoreMasseResultat response = appelWsOpRestoreMasse(urlServiceWeb,
...
//   }
//
//   private RestoreMasseResultat fromRestoreMasseAncienService(
//         RestoreMasseResponse response) {
//
//      // Création de l'objet résultat
//      RestoreMasseResultat result = new RestoreMasseResultat();
//
//      // Extrait le contenu (DataHandler)
//      DataHandler contenu = response.getRestoreMasseResponse()
//            .getObjetNumerique()
//            .getObjetNumeriqueRestoreMasseTypeChoice_type0().getContenu();
//      result.setContenu(contenu);
//
//      // Extrait les métadonnées
//      ListeMetadonneeType metadonnees = response.getRestoreMasseResponse()
//            .getMetadonnees();
