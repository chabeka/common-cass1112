...
public class Test2300Controller extends AbstractTestWsController<TestWsRechercheParIterateurFormulaire> {
   ...
   private void recherche(String urlWebService, RechercheParIterateurFormulaire formulaire, ViFormulaire viForm) {
      getRechercheParIterateurTestService().appelWsOpRechercheParIterateurTestLibre(urlWebService, formulaire, viForm);
   }
}
