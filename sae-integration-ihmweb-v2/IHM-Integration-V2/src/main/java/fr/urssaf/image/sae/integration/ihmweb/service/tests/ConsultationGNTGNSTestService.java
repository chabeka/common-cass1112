...
import fr.urssaf.image.sae.integration.ihmweb.saeservice.modele.SaeServiceStub.ConsultationGNTGNSResponse;
...
@Service
public class ConsultationGNTGNSTestService {
   ...
   private ConsultationResultat appelWsOpConsultation(String urlServiceWeb,
         ...
         ConsultationGNTGNSFormulaire formulaire, WsTestListener wsListener) {
      ...
      SaeServiceLogUtils.logAppelConsultationGNTGNS(log, formulaire);
      ...
      try {
            ...
            ConsultationGNTGNS paramsService = SaeServiceObjectFactory
                  .buildConsultationGNTGNSRequest(formulaire.getIdArchivage(),
                        formulaire.getCodeMetadonnees());

            // Appel du service web
            ConsultationGNTGNSResponse response = service
                  .consultationGNTGNS(paramsService);
    ...
    */
   public final void appelWsOpConsultationTestLibre(String urlServiceWeb,
         ConsultationGNTGNSFormulaire formulaire, ViFormulaire viParams) {
   ...
   public final void appelWsOpConsultationSoapFault(String urlServiceWeb,
      ...
      // Appel de la méthode "générique" de test
      appelWsOpConsultation(urlServiceWeb, ViStyle.VI_OK, viParams, formulaire, testLibre);
    ...
    */
   public final void appelWsOpConsultationSoapFault(String urlServiceWeb,
         ConsultationGNTGNSFormulaire formulaire, ViStyle viStyle,
    ...
    */
   public final void appelWsOpConsultationSoapFault(String urlServiceWeb,
         ConsultationGNTGNSFormulaire formulaire, ViStyle viStyle, ViFormulaire viParams,
         String idSoapFaultAttendu, final Object[] argsMsgSoapFault) {
   ...
   private void wsVerifieRetour(ConsultationGNTGNSFormulaire formulaire,
   ...
   public final ConsultationResultat appelWsOpConsultationReponseCorrecteAttendue(
         String urlServiceWeb, ConsultationGNTGNSFormulaire formulaire,
         String sha1attendu) {
   ...
   private ConsultationResultat fromConsultationNouveauService(
         ConsultationGNTGNSResponse response) {
