...
public class DeblocageTestService {
   ...
   private DeblocageResultat appelWsOpDeblocage(String urlServiceWeb,
      ...
      try {
         ...
         Deblocage paramsService = new Deblocage();
         if (formulaire.getIdJob().size() != 0)
            paramsService = SaeServiceObjectFactory
                  .buildDeblocageRequest(formulaire.getIdJob().get(0));
         else
            paramsService = SaeServiceObjectFactory.buildDeblocageRequest("");
   ...
   public final DeblocageResultat appelWsOpDeblocageTestLibre(
         String urlServiceWeb, DeblocageFormulaire formulaire,
      ...
      return appelWsOpDeblocage(urlServiceWeb, ViStyle.VI_OK, viParams,
