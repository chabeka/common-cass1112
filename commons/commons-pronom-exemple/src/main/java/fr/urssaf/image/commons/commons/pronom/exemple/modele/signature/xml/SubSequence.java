...
/**
 * Une SubSequence est une longue chaine d'octet à faire correspondre.
 * 
 * Elle doit inclure au moins une séquence d'octets sans ambiguïté ou 
 * <br/>des ensembles d'octets, qui peut être recherchée en utilisant 
 * <br/>le BoyerMooreHorpsool (BMH) algorithme. Ceci est aussi connu sous l '"ancre" séquence.
 * 
 */
public class SubSequence extends SimpleElement {
     ...
     */
    public final boolean isInvalidSubSequence() {
