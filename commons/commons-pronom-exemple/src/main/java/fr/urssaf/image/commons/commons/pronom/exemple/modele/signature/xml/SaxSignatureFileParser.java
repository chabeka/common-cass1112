...
import fr.urssaf.image.commons.commons.pronom.exemple.exception.ErrorCode;
...
public class SaxSignatureFileParser implements SignatureParser {
     ...
     */
    @Override
   public final void formats(FormatCallback callback) throws SignatureFileException {
