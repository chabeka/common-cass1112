...
public final class ResourceUtils {
    ...
    private static final int UNSIGNED_R_4 = 4;
    private static final int UNSIGNED_R_11 = 11;
    private static final int UNSIGNED_R_18 = 18;
    private static final int UNSIGNED_R_25 = 25;    
    ...
    public static int readBuffer(InputStream input, byte[] buffer) throws IOException {
        ...
        while (totalBytesRead < bytesToRead) {
            int numRead = input.read(buffer, totalBytesRead, bytesToRead - totalBytesRead);
            if (numRead == -1) { break; }
    ...
    public static String getBase128Integer(long value) {
        ...
        int curseur = 0;
        values[curseur++] = (char) printableValue((value >>> UNSIGNED_R_25) & HEX_7F); // bits 26-32
        values[curseur++] = (char) printableValue((value >>> UNSIGNED_R_18) & HEX_7F); // bits 19-25
        values[curseur++] = (char) printableValue((value >>> UNSIGNED_R_11) & HEX_7F); // bits 12-18
        values[curseur++] = (char) printableValue((value >>> UNSIGNED_R_4) & HEX_7F); // bits 5-11
        values[curseur++] = (char) printableValue(value & HEX_F); // bits 1-4
