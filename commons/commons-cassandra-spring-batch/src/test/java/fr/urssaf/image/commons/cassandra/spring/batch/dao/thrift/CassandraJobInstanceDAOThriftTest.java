...
public class CassandraJobInstanceDAOThriftTest {
  ...
  private static final Logger LOGGER = LoggerFactory
                                                    .getLogger(CassandraJobInstanceDAOThriftTest.class);
  ...
  public void testGetJobInstanceByNameAndParameters() {
    ...
    // paramètres
    final JobInstance jobInstance = jobInstanceDao.getJobInstance(MY_JOB_NAME, myJobParameters);
  ...
  public void testGetJobInstanceByNonExistentName() {
    final JobInstance jobInstance3 = jobInstanceDao.getJobInstance(MY_JOB_NAME, myJobParameters);
    validateJobInstance(jobInstance3);

    final JobInstance jobInstance4 = jobInstanceDao.getJobInstance("job qui n'existe pas", myJobParameters);
  ...
  public void testGetJobInstances() {
    ...
    final List<JobInstance> jobInstances = jobInstanceDao.getJobInstances(MY_JOB_NAME, 0, 150);
    ...
    final List<JobInstance> jobInstances1 = jobInstanceDao.getJobInstances(MY_JOB_NAME, 0, 5);
    final List<JobInstance> jobInstances2 = jobInstanceDao.getJobInstances(MY_JOB_NAME, 5, 150);
  ...
  private void validateJobInstance(final JobInstance jobInstance) {
    ...
    Assert.assertEquals("test1", jobInstance.getJobParameters().getString("premier_parametre"));
    Assert.assertEquals("test2", jobInstance.getJobParameters().getString("deuxieme_parametre"));
    Assert.assertEquals(122L, jobInstance.getJobParameters().getLong("troisieme_parametre"));
  }
