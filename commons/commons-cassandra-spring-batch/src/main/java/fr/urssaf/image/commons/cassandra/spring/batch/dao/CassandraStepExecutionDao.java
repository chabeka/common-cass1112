...
public class CassandraStepExecutionDao implements SearchableStepExecutionDao {
   ...
   public CassandraStepExecutionDao(final IJobStepExecutionDaoCql daoCqlparam, final CassandraStepExecutionDaoThrift daoThriftparam) {
      super();
      this.daoCql = daoCqlparam;
      this.daoThrift = daoThriftparam;
   }
   ...
   public final void addStepExecutions(final JobExecution jobExecution) {
      ...
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         this.daoCql.addStepExecutions(jobExecution);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         this.daoThrift.addStepExecutions(jobExecution);
   ...
   public final StepExecution getStepExecution(final JobExecution jobExecution,
      ...
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         return this.daoCql.getStepExecution(jobExecution, stepExecutionId);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         return this.daoThrift.getStepExecution(jobExecution, stepExecutionId);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
   ...
   public final void saveStepExecution(final StepExecution stepExecution) {
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         this.daoCql.saveStepExecution(stepExecution);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         this.daoThrift.saveStepExecution(stepExecution);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
   ...
   public final void updateStepExecution(final StepExecution stepExecution) {
      ...
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         this.daoCql.updateStepExecution(stepExecution);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         this.daoThrift.updateStepExecution(stepExecution);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
   ...
   public final void deleteStepExecution(final Long stepExecutionId) {
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         this.daoCql.deleteStepExecution(stepExecutionId);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         this.daoThrift.deleteStepExecution(stepExecutionId);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
   ...
   public final void deleteStepsOfExecution(final JobExecution jobExecution) {
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         this.daoCql.deleteStepsOfExecution(jobExecution);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         this.daoThrift.deleteStepsOfExecution(jobExecution);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
   ...
   public final int countStepExecutions(final String jobNamePattern, final String stepNamePattern) {
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         return this.daoCql.countStepExecutions(jobNamePattern, stepNamePattern);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         return this.daoThrift.countStepExecutions(jobNamePattern, stepNamePattern);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
   ...
   public final Collection<StepExecution> findStepExecutions(final String jobNamePattern,
      ...
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         return this.daoCql.findStepExecutions(jobNamePattern, stepNamePattern, start, count);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         return this.daoThrift.findStepExecutions(jobNamePattern, stepNamePattern, start, count);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
   ...
   public final Collection<String> findStepNamesForJobExecution(final String jobName,
      ...
      final String modeApi = ModeGestionAPI.getModeApiCf(cfName);
      if (ModeGestionAPI.MODE_API.DATASTAX.equals(modeApi)) {
         return this.daoCql.findStepNamesForJobExecution(jobName, excludesPattern);
      } else if (ModeGestionAPI.MODE_API.HECTOR.equals(modeApi)) {
         return this.daoThrift.findStepNamesForJobExecution(jobName, excludesPattern);
      } else if (ModeGestionAPI.MODE_API.DUAL_MODE.equals(modeApi)) {
         // Pour exemple
         // Dans le cas d'une lecture aucun intérêt de lire dans les 2 modes et donc dans 2 CF différentes
      }
