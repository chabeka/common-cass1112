 ...
 */
public class CassandraStepExecutionDaoThrift extends AbstractCassandraDAO{
    ...
    */
   public CassandraStepExecutionDaoThrift(Keyspace keyspace, IdGenerator idGenerator) {
      super(keyspace);
