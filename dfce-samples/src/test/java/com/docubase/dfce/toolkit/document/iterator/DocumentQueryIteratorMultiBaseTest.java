...
public class DocumentQueryIteratorMultiBaseTest extends AbstractTestCaseCreateAndPrepareBase {
   ...
   public static void createBase2() {
      ...
      BaseCategory c1Base2 = factory.createBaseCategory(c1.getCategory(), true);
