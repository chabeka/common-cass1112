...
import fr.urssaf.astyanaxtest.dao.CategoriesReferenceCF;

public class CategoriesReferenceDaoTest {
   /**
   ...
   @Test
   public void testCreateDns() throws Exception {
      final MutationBatch batch = keyspace.prepareMutationBatch();
      final String key = "dns";
      batch.withRow(CategoriesReferenceCF.get(), key).putColumn("TYPE_ATTRIBUTE_NAME", "com.docubase.dfce.core.impl.CategoryReferenceModel");
      batch.withRow(CategoriesReferenceCF.get(), key).putColumn("categoryTypeENUM_ATTRIBUTE_TYPE_SUFFIXE", "com.docubase.dfce.core.CategoryDataType");
      batch.withRow(CategoriesReferenceCF.get(), key).putColumn("categoryTypeENUM_ATTRIBUTE_VALUE_SUFFIXE", "DATE");
      batch.withRow(CategoriesReferenceCF.get(), key).putColumn("name", "dns");
