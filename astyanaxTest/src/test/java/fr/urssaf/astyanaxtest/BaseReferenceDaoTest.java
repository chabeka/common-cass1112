...
public class BaseReferenceDaoTest {
	/**
	...
	@Test
	public void testWriteBaseUUID() throws Exception {
		BasesReferenceDao.setBaseUUID(keyspace, "SAE-PROD", UUID.fromString("f573ae93-ac6a-4615-a23b-150fd621b5a0"));
