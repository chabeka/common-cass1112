...
public class ConvertHelper {
    ...
    * @throws Exception
    */
   public static byte[] getBytesFromReadableUTF8String(String s)
         throws Exception {
         ...
         if (s.charAt(i) == '\\' && s.charAt(i + 1) == 'x') {
            ...
            if ((c1 >= '0' && c1 <= '9') || (c1 >= 'a' && c1 <= 'f')) {
               if ((c2 >= '0' && c2 <= '9') || (c2 >= 'a' && c2 <= 'f')) {
                  byte b = (byte) ((Character.digit(c1, 16) << 4) + Character
                        .digit(c2, 16));
                  list.add(b);
                  i += 3;
                  continue;
    ...
    * @return
    */
   public static byte[] stringToBytesWithDocubaseDelimiter(String str)
         throws UnsupportedEncodingException {
   ...
   public static String normalizeMetaValue(String metaValue) {
