...
public class RechercheParIterateurTestV2 {
    ...
    */
   @Test
   public void rechercheParIterateurV2_success() throws RemoteException {
      ...
      RechercheParIterateurV2 paramsEntree = Axis2ObjectFactory
            .contruitParamsEntreeRechercheParIterateurV2(listeMetasFixes,
      ...
      RechercheParIterateurResponse reponse = saeService.rechercheParIterateurV2(paramsEntree);
