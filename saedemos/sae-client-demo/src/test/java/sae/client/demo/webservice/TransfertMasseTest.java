...
public class TransfertMasseTest {
   ...
   public void transfertMasse_success() throws RemoteException {
      ...
      final String urlEcdeSommaire = "ecde://cnp69intgnsecde.gidn.recouv/CS_DEV_TOUTES_ACTIONS/20170217/Traitement001_TransfertMasse/sommaire.xml";

      // Hash SHA-1 du fichier sommaire.xml
      final String typeHash = "SHA-1";
      final String hash = "2afa38ae6610eb0507760198f02d81268e269761";
      ...
      final TransfertMasse paramsEntree = Axis2ObjectFactory
      ...
      // le SAE
      final TransfertMasseResponse reponse = saeService.transfertMasse(paramsEntree);
      final String idTraitementSae = reponse.getTransfertMasseResponse().getUuid();
