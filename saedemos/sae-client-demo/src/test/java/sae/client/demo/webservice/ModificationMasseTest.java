...
public class ModificationMasseTest {
   ...
   public void modificationMasse_success() throws RemoteException {
      ...
      // "ecde://cnp69intgnsecde.gidn.recouv/CS_DEV_TOUTES_ACTIONS/20120120/Traitement002_ArchivageMasse/sommaire.xml";
      final String urlEcdeSommaire = "ecde://cnp69devecde.cer69.recouv/doc_5000_AUG/CS_DEV_TOUTES_ACTIONS/20170426/Traitement001_ModificationMasse_passant/sommaire.xml";

      // Hash SHA-1 du fichier sommaire.xml
      final String typeHash = "SHA-1";
      final String hash = "29ff24a0ec2474463f1c904ddf1e8a3c671198e9";
      ...
      final ModificationMasse paramsEntree = Axis2ObjectFactory
                                                               .contruitParamsEntreeModificationMasse(urlEcdeSommaire,
                                                                                                      typeHash,
                                                                                                      hash,
                                                                                                      codeTraitement);
