...
public class ModificationMasseTest {
   ...
   public void modificationMasse_success() throws RemoteException {
      ...
      // "ecde://cnp69intgnsecde.gidn.recouv/CS_DEV_TOUTES_ACTIONS/20120120/Traitement002_ArchivageMasse/sommaire.xml";
      String urlEcdeSommaire = "ecde://cnp.nicolas/doc_5000_AUG/CS_DEV_TOUTES_ACTIONS/20170316/Traitement002_ModificationMasse_non_passant/sommaire.xml";
      
      // Hash SHA-1 du fichier sommaire.xml
      String typeHash = "SHA-1";
      String hash = "c1e07795e8430026c8e0ae1033b9408c6f100f7b";
      String codeTraitement = "847";
   ...
   public void modificationMasse_failure() {
      ...
      try {
         ...
         TestUtils.assertSoapFault(
               ...
               "Le hash du fichier sommaire.xml attendu : HASHPASBON est différent de celui obtenu : c1e07795e8430026c8e0ae1033b9408c6f100f7b (type de hash : SHA-1)");
