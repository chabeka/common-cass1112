...
public class RechercheNbResTest {
   ...
   public void rechercheNbRes_success() throws RemoteException {
      ...
      final String requeteRecherche = "Siren:123456789";
      ...
      final List<String> codesMetasSouhaitess = new ArrayList<>();
      codesMetasSouhaitess.add("CodeRND");
      ...
      final RechercheNbRes paramsEntree = Axis2ObjectFactory.contruitParamsEntreeRechercheNbRes(
                                                                                                requeteRecherche,
                                                                                                codesMetasSouhaitess);

      // Appel du service web de recherche
      final RechercheNbResResponse reponse = saeService.rechercheNbRes(paramsEntree);
   ...
   private void afficheResultatsRecherche(
                                          final RechercheNbResResponse reponse) {

      final RechercheNbResResponseType rechercheNbResResponse = reponse.getRechercheNbResResponse();
      ...
      if ((rechercheNbResResponse.getResultats() == null) ||
         ...
         final ResultatRechercheType[] tabResRecherche = rechercheNbResResponse.getResultats().getResultat();
   ...
   public void rechercheNbRes_failure() {
      ...
      // Requête de recherche
      final String requeteRecherche = "Toto:123456789";

      // Métadonnées souhaitées dans les résultats de recherche
      final List<String> codesMetasSouhaitess = null;
