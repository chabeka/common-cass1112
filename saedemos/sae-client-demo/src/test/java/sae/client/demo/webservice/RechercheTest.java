...
public class RechercheTest {
   ...
   public void recherche_success() throws RemoteException {
      ...
      final Recherche paramsEntree = Axis2ObjectFactory.contruitParamsEntreeRecherche(
                                                                                      requeteRecherche,
                                                                                      codesMetasSouhaitess);

      // Appel du service web de recherche
      final RechercheResponse reponse = saeService.recherche(paramsEntree);
   ...
   private void afficheResultatsRecherche(
                                          final RechercheResponse reponse) {

      final RechercheResponseType rechercheResponse = reponse.getRechercheResponse();
      ...
      if ((rechercheResponse.getResultats() == null) ||
         ...
         final ResultatRechercheType[] tabResRecherche = rechercheResponse.getResultats().getResultat();
