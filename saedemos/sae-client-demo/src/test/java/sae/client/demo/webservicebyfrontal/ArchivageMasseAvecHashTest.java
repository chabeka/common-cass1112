...
public class ArchivageMasseAvecHashTest {
   ...
   public void archivageMasseAvecHash_success() throws RemoteException {
      ...
      final String typeHash = "SHA-1";
      final String hash = "428fea120ddb49eee2a9e2d4fde1b9d26dbd2195";
      ...
      final ArchivageMasseAvecHash paramsEntree = Axis2ObjectFactory.contruitParamsEntreeArchivageMasseAvecHash(
                                                                                                                prop.getProperty("URLECDE_SOM_ARCHIMASS_SUCCES"),
                                                                                                                typeHash,
                                                                                                                hash);

      // Appel de l'opération archivageMasseAvecHash
      // => en attendu, l'identifiant unique de traitement de masse affecté par le SAE
      final ArchivageMasseAvecHashResponse reponse = saeService.archivageMasseAvecHash(paramsEntree);
      final String idTraitementSae = reponse.getArchivageMasseAvecHashResponse().getUuid();
   ...
   public void archivageMasse_failure() {
      ...
      try {
         ...
         TestUtils.assertSoapFault(
                                   ...
                                   "Le hash du fichier sommaire.xml attendu : HASHPASBON est différent de celui obtenu : "
                                         + prop.getProperty("HASH_ARCH_MASSE_AVEC_HASH") + " (type de hash : SHA-1)");
