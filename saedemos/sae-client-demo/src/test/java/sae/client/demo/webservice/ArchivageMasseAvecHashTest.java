...
public class ArchivageMasseAvecHashTest {
   ...
   public void archivageMasseAvecHash_success() throws RemoteException {
      ...
      final String urlEcdeSommaire = "ecde://cnp69intgnsecde.gidn.recouv/CS_DEV_TOUTES_ACTIONS/20120120/Traitement002_ArchivageMasse/sommaire.xml";

      // Hash SHA-1 du fichier sommaire.xml
      final String typeHash = "SHA-1";
      final String hash = "bbf4df5e743c1dace7f50034c4f3863d9a9f0d43";
