...
public class CSCTCTest {

   private static final Logger LOG = LoggerFactory.getLogger(CSCTCTest.class);

   private static final String ISSUER = "CS_CTC_ACCROCHAGE";

   private static final String PAGM_ARCH_UNI = "CTC_SEPA_ARCHIVAGE_UNITAIRE";

   private static final String PAGM_CONS_RECH = "CTC_SEPA_RECHERCHE_CONSULTATION";
   ...
   public void mandatSEPA_success() throws IOException {
      ...
      metadatas.add(ObjectModelFactory.createMetadata("RUM", "98748348"));
      // autres méta
