...
public class JobQueueServiceEndingJobTest {
  ...
  @Test
  public void endingJob_success_endingBySuccess() throws JobDejaReserveException, JobInexistantException, LockTimeoutException {
    ...
    jobQueueService.endingJob(idJob, true, dateFinTraitement, "traitement a réussi", null);
  ...
  @Test
  public void endingJob_success_endingByFailure() throws JobDejaReserveException, JobInexistantException, LockTimeoutException {
  ...
  @Test
  public void endingJob_success_withoutmessage() throws JobDejaReserveException, JobInexistantException, LockTimeoutException {
