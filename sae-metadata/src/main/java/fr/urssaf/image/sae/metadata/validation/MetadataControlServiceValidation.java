...
public class MetadataControlServiceValidation {
  ...
  private void validateSaeDocument(final SAEDocument saeDocument) {
    Validate.notNull(saeDocument,
                     MetadataMessageHandler.getMessage(
                                                       "document.required",
                                                       SAEDocument.class.getName()));
    Validate.notNull(saeDocument.getMetadatas(),
  ...
  private void validateUntypedDocument(final UntypedDocument untypedDoc) {
    Validate.notNull(untypedDoc,
                     MetadataMessageHandler.getMessage(
                                                       "document.required",
                                                       UntypedDocument.class.getName()));
    Validate.notNull(untypedDoc.getUMetadatas(),
                     MetadataMessageHandler
  ...
  public final void checkConvertLongCodeToShortCode(
    ...
    Validate.notNull(listCodeMetadata,
                     MetadataMessageHandler.getMessage(
                                                       "metadatas.required",
                                                       List.class.getName()));
