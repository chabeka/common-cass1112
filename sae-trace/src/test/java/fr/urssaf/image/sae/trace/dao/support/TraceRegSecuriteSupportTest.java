...
public class TraceRegSecuriteSupportTest {
  ...
  public void testCreateFindSuccess() {
    ...
    final TraceRegSecurite securite = support.find(uuid);
    checkBean(securite, uuid);

    final List<TraceRegSecuriteIndex> list = support.findByDate(DATE);
  ...
  public void testCreateFindByPlageSuccess() {
    ...
    final TraceRegSecurite exploitation = support.find(uuid);
  ...
  private void checkBean(final TraceRegSecurite securite, final UUID uuid) {
  ...
  private void checkBeanIndex(final TraceRegSecuriteIndex index, final UUID uuid) {
