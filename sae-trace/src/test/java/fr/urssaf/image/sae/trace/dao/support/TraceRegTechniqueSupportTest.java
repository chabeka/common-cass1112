...
public class TraceRegTechniqueSupportTest {
  ...
  public void testCreateFindSuccess() {
    ...
    final TraceRegTechnique technique = support.find(uuid);
    checkBean(technique, uuid);

    final List<TraceRegTechniqueIndex> list = support.findByDate(DATE);
  ...
  public void testDelete() {
    ...
    final long nbTracesPurgees = support.delete(new Date(), new Date().getTime(), 500);
  ...
  public void testCreateFindByPlageSuccess() {
    ...
    final TraceRegTechnique exploitation = support.find(uuid);
  ...
  private void checkBean(final TraceRegTechnique technique, final UUID uuid) {
  ...
  private void checkBeanIndex(final TraceRegTechniqueIndex index, final UUID uuid) {
