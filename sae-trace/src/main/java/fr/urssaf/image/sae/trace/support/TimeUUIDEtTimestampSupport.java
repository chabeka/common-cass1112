...
public final class TimeUUIDEtTimestampSupport {
    ...
    */
   public long getTimestampFromDate(final Date date) {
    ...
    */
   public UUID buildUUIDFromTimestamp(final long timestamp) {
    ...
    * @return le TimeUUID
    */
   public UUID buildUUIDFromDate(final Date date) {
      final long microsecDivDix = (date.getTime() * CENT);
      return TimeUUIDUtils.getTimeUUID(microsecDivDix);
   }

   private long getTimestampEnMicroSecDivDix(final Date date) {
      return date.getTime() * CENT;
   }
    ...
    * @return le TimeUUID
    */
   public UUID buildUUIDFromDateBorneSup(final Date date) {
   ...
   public UUID buildUUIDFromCurrentTimestamp() {
      final long timestampMicroDivDix = getCurrentTimestamp();
    ...
    */
   public Date getDateFromTimestamp(final long timestamp) {
