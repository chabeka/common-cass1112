...
public class StatusServiceValidation {
  ...
  public final void purgeIsRunning(final PurgeType type) {
  ...
  public final void journalisationIsRunning(final JournalisationType type) {
  ...
  public final void updatePurge(final PurgeType type, final Boolean value) {
  ...
  public final void updateJournalisation(final JournalisationType type, final Boolean value) {
