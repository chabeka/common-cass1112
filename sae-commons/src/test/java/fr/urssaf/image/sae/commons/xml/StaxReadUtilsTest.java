...
public class StaxReadUtilsTest {
  ...
  IOException {
    ...
    final int nombreElements = StaxReadUtils.compterElements(resource.getFile(),
        "nom");
  ...
  XMLStreamException, IOException {
    final ClassPathResource resource = new ClassPathResource(
        "xml/fichierLecture.xml");
    final String value = StaxReadUtils.getElementValue(resource.getFile(), "nom");
  ...
  XMLStreamException, IOException {
    final ClassPathResource resource = new ClassPathResource(
        "xml/fichierLecture.xml");
    final String value = StaxReadUtils.getElementValue(resource.getFile(),
        "element");
