...
public class DocumentIteratorTest {
   ...
   public void documentIterator_Test() throws Exception {
      // final DFCEServices dfceServices = getDfceServices("hwi69progednatgntcot1boappli3.cer69.recouv", "GNT-PROD", 8080);
   ...
   public void documentIterator_TestHubert() throws Exception {
      final DFCEServices dfceServices = getDfceServices("hwi31dev2gntboappli1.gidn.recouv", "GNT-DEV2", 8080);
