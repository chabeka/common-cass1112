...
public class TestDateUtil extends TestCase {
   ...
   */
  public TestDateUtil(final String name) throws IOException {
    super(name);
  }
  ...
  public void testExtract()
    ...
    try {
      ...
      gc1.setTime(sdf1.parse("05/12/2005"));
      assertEquals(DateConverter.toCalendar("D:05/12/2005"), gc1);

      sdf1 = new SimpleDateFormat("MM/dd/yyyy hh:mm:ss", Locale.ENGLISH);
      gc1 = new GregorianCalendar();
      gc1.setTime(sdf1.parse("5/12/2005 15:57:16"));
      assertEquals(DateConverter.toCalendar("5/12/2005 15:57:16"), gc1);
    }
    finally {
  ...
  private void assertDate(final String expected, final String date) throws Exception {
    final Calendar calendar = DateConverter.toCalendar(date);
  ...
  public static void main(final String[] args) {
    final String[] arg = {TestDateUtil.class.getName()};
