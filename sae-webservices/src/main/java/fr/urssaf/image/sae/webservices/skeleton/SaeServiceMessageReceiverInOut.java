...
public class SaeServiceMessageReceiverInOut extends
      ...
      try {
         ...
         if ((op.getName() != null)
            ...
            if ("rechercheParIterateur".equals(methodName)) {
               ...
               fr.cirtil.www.saeservice.RechercheParIterateurResponse rechercheParIterateurResponse34 = null;
               ...
               rechercheParIterateurResponse34 = skel
            ...
            if ("restoreMasse".equals(methodName)) {
               ...
               fr.cirtil.www.saeservice.RestoreMasseResponse restoreMasseResponse38 = null;
               fr.cirtil.www.saeservice.RestoreMasse wrappedParam = (fr.cirtil.www.saeservice.RestoreMasse) fromOM(
                     msgContext.getEnvelope().getBody().getFirstElement(),
            ...
            if ("suppressionMasse".equals(methodName)) {
               ...
               fr.cirtil.www.saeservice.SuppressionMasseResponse suppressionMasseResponse39 = null;
               fr.cirtil.www.saeservice.SuppressionMasse wrappedParam = (fr.cirtil.www.saeservice.SuppressionMasse) fromOM(
                     msgContext.getEnvelope().getBody().getFirstElement(),
               ...
               fr.cirtil.www.saeservice.Copie wrappedParam = (fr.cirtil.www.saeservice.Copie) fromOM(
                     msgContext.getEnvelope().getBody().getFirstElement(),
               ...
               envelope = toEnvelope(getSOAPFactory(msgContext), copieResponse,
                     false, new javax.xml.namespace.QName(
                           "http://www.cirtil.fr/saeService", "copieResponse"));
            } else if ("documentExistant".equals(methodName)) {
               fr.cirtil.www.saeservice.DocumentExistantResponse documentExistantResponse = null;
               fr.cirtil.www.saeservice.DocumentExistant wrappedParam = (fr.cirtil.www.saeservice.DocumentExistant) fromOM(
                     msgContext.getEnvelope().getBody().getFirstElement(),
               ...
               modificationMasseResponse31 =

               skel.modificationMasseSecure(wrappedParam, callerIP);
               ...
               envelope = toEnvelope(getSOAPFactory(msgContext),
                  ...
                  fr.cirtil.www.saeservice.TransfertMasseResponse transfertMasseResponse = null;
                  fr.cirtil.www.saeservice.TransfertMasse wrappedParam = (fr.cirtil.www.saeservice.TransfertMasse) fromOM(
                        msgContext.getEnvelope().getBody().getFirstElement(),
                  ...
                  transfertMasseResponse = skel.transfertMasseSecure(wrappedParam, callerIP);
                  ...
                  fr.cirtil.www.saeservice.DeblocageResponse deblocageResponse = null;
                  fr.cirtil.www.saeservice.Deblocage wrappedParam = (fr.cirtil.www.saeservice.Deblocage) fromOM(
                        msgContext.getEnvelope().getBody().getFirstElement(),
                  ...
                  deblocageResponse = skel.deblocageSecure(wrappedParam, callerIP);
                  ...
                  fr.cirtil.www.saeservice.Reprise wrappedParam = (fr.cirtil.www.saeservice.Reprise) fromOM(
                        msgContext.getEnvelope().getBody().getFirstElement(),
   ...
   private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
      ...
      try {
         ...
         emptyEnvelope.getBody().addChild(
               param.getOMElement(
                     fr.cirtil.www.saeservice.DeblocageResponse.MY_QNAME,
                     factory));
   ...
   private org.apache.axiom.soap.SOAPEnvelope toEnvelope(
      ...
      try {
         ...
         emptyEnvelope.getBody().addChild(
               param.getOMElement(
                     fr.cirtil.www.saeservice.RepriseResponse.MY_QNAME,
                     factory));
   ...
   private java.lang.Object fromOM(org.apache.axiom.om.OMElement param,
      ...
      try {
         ...
         if (fr.cirtil.www.saeservice.StockageUnitaire.class.equals(type)) {
            ...
            return fr.cirtil.www.saeservice.StockageUnitaire.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());
         }

         if (fr.cirtil.www.saeservice.StockageUnitaireResponse.class
               .equals(type)) {
         ...
         if (fr.cirtil.www.saeservice.GetDocFormatOrigine.class.equals(type)) {
            ...
            return fr.cirtil.www.saeservice.GetDocFormatOrigine.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());
         }

         if (fr.cirtil.www.saeservice.GetDocFormatOrigineResponse.class
               .equals(type)) {
         ...
         if (fr.cirtil.www.saeservice.CopieResponse.class.equals(type)) {
            ...
            return fr.cirtil.www.saeservice.CopieResponse.Factory.parse(param
                  .getXMLStreamReaderWithoutCaching());
         }

         if (fr.cirtil.www.saeservice.Copie.class.equals(type)) {

            return fr.cirtil.www.saeservice.Copie.Factory.parse(param
                  .getXMLStreamReaderWithoutCaching());
         }
         if (fr.cirtil.www.saeservice.DocumentExistantResponse.class.equals(type)) {

            return fr.cirtil.www.saeservice.DocumentExistantResponse.Factory.parse(param
                  .getXMLStreamReaderWithoutCaching());
         }
         ...
         if (fr.cirtil.www.saeservice.ModificationMasse.class.equals(type)) {
            ...
            return fr.cirtil.www.saeservice.ModificationMasse.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());

         }
         if (fr.cirtil.www.saeservice.ModificationMasseResponse.class.equals(type)) {

            return fr.cirtil.www.saeservice.ModificationMasseResponse.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());
         }
         if (fr.cirtil.www.saeservice.TransfertMasse.class.equals(type)) {

            return fr.cirtil.www.saeservice.TransfertMasse.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());

         }
         if (fr.cirtil.www.saeservice.TransfertMasseResponse.class
               .equals(type)) {

            return fr.cirtil.www.saeservice.TransfertMasseResponse.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());

         }
         if (fr.cirtil.www.saeservice.Deblocage.class.equals(type)) {

            return fr.cirtil.www.saeservice.Deblocage.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());

         }
         if (fr.cirtil.www.saeservice.DeblocageResponse.class
               .equals(type)) {

            return fr.cirtil.www.saeservice.DeblocageResponse.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());

         }
         if (fr.cirtil.www.saeservice.Reprise.class.equals(type)) {

            return fr.cirtil.www.saeservice.Reprise.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());

         }
         if (fr.cirtil.www.saeservice.RepriseResponse.class
               .equals(type)) {

            return fr.cirtil.www.saeservice.RepriseResponse.Factory
                  .parse(param.getXMLStreamReaderWithoutCaching());
