...
/**
 * Exception levée dans de le service de déblocage
 * 
 * 
 */
public class DeblocageAxisFault extends AxisFault {
    ...
    */
   public DeblocageAxisFault(String localPart, String message, Throwable cause) {
    ...
    *           message de l'exception
    */
   public DeblocageAxisFault(String localPart, String message) {
