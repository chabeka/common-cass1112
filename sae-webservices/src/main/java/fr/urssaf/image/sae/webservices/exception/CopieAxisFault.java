...
public class CopieAxisFault extends AxisFault {
    ...
    */
   public CopieAxisFault(String localPart, String message, Throwable cause) {
    ...
    *           message de l'exception
    */
   public CopieAxisFault(String localPart, String message) {
