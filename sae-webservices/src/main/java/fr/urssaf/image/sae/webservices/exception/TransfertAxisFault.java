...
/**
 * Exception levée dans de le service de transfert
 * 
 * 
 */
public class TransfertAxisFault extends AxisFault {
    ...
    */
   public TransfertAxisFault(String localPart, String message, Throwable cause) {
    ...
    *           message de l'exception
    */
   public TransfertAxisFault(String localPart, String message) {
