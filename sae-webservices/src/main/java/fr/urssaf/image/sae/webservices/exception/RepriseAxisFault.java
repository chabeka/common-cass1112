...
/**
 * Exception levée dans de le service de reprise des traitements de masse
 * 
 * 
 */
public class RepriseAxisFault extends AxisFault {
    ...
    */
   public RepriseAxisFault(String localPart, String message, Throwable cause) {
    ...
    *           message de l'exception
    */
   public RepriseAxisFault(String localPart, String message) {
