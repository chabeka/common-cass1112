...
/**
 * Exception levée dans de le service de restore
 * 
 * 
 */
public class RestoreAxisFault extends AxisFault {
    ...
    */
   public RestoreAxisFault(String localPart, String message, Throwable cause) {
    ...
    *           message de l'exception
    */
   public RestoreAxisFault(String localPart, String message) {
