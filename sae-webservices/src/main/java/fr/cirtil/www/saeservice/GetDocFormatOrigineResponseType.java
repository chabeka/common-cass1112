...
@SuppressWarnings("all")
                ...
                java.lang.String namespace = null;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       ...
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "getDocFormatOrigineResponseType",
                           xmlWriter);
                   }
    ...
    public static class Factory{
        ...
        */
        public static GetDocFormatOrigineResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            GetDocFormatOrigineResponseType object =
                new GetDocFormatOrigineResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"getDocFormatOrigineResponseType".equals(type)){
                                ...
                                return (GetDocFormatOrigineResponseType)fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
