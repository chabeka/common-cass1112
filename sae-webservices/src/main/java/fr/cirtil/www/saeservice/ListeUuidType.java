 ...
 */
            ...
            /**
            *  ListeUuidType bean class
            */
// CHECKSTYLE:OFF
@SuppressWarnings("all")
        
        public  class ListeUuidType
                        ...
                        */
                           ...
                           */
                           public  fr.cirtil.www.saeservice.UuidType[] getUuid(){
                             ...
                             * @param param fr.cirtil.www.saeservice.UuidType
                             */
                             public void addUuid(fr.cirtil.www.saeservice.UuidType param){
                                   if (localUuid == null){
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localUuid);
                               list.add(param);
                               this.localUuid =
                             (fr.cirtil.www.saeservice.UuidType[])list.toArray(
                            new fr.cirtil.www.saeservice.UuidType[list.size()]);
                           ...
                           xmlWriter);
                                       ...
                                       if (localUuid!=null){
                                            for (int i = 0;i < localUuid.length;i++){
                                                if (localUuid[i] != null){
                                                 localUuid[i].serialize(new javax.xml.namespace.QName("http://www.cirtil.fr/saeService","uuid"),
                                                           xmlWriter);
                                                } else {
    ...
    public static class Factory{
        ...
        */
        public static ListeUuidType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ListeUuidType object =
                new ListeUuidType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"listeUuidType".equals(type)){
                                ...
                                return (ListeUuidType)fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list1 = new java.util.ArrayList();
                                    ...
                                    list1.add(fr.cirtil.www.saeservice.UuidType.Factory.parse(reader));
                                                        ...
                                                        while(!loopDone1){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://www.cirtil.fr/saeService","uuid").equals(reader.getName())){
                                                                    list1.add(fr.cirtil.www.saeservice.UuidType.Factory.parse(reader));
                                                        ...
                                                        object.setUuid((fr.cirtil.www.saeservice.UuidType[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                fr.cirtil.www.saeservice.UuidType.class,
                                                                list1));
