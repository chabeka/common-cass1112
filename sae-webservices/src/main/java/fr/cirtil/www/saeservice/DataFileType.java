...
public class DataFileType implements org.apache.axis2.databinding.ADBBean {
    ...
    public static class Factory {
        ...
        public static DataFileType parse(
            ...
            DataFileType object = new DataFileType();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"dataFileType".equals(type)) {
                            ...
                            return (DataFileType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
