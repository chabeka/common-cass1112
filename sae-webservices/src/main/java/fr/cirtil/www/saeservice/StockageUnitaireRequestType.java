...
public class StockageUnitaireRequestType implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setStockageUnitaireRequestTypeChoice_type0(
        fr.cirtil.www.saeservice.StockageUnitaireRequestTypeChoice_type0 param) {
    ...
    public void setStockageUnitaireRequestTypeChoice_type1(
        fr.cirtil.www.saeservice.StockageUnitaireRequestTypeChoice_type1 param) {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":stockageUnitaireRequestType", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
        ...
        public static StockageUnitaireRequestType parse(
            ...
            StockageUnitaireRequestType object = new StockageUnitaireRequestType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"stockageUnitaireRequestType".equals(type)) {
                            ...
                            return (StockageUnitaireRequestType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement()) {
                    object.setStockageUnitaireRequestTypeChoice_type0(fr.cirtil.www.saeservice.StockageUnitaireRequestTypeChoice_type0.Factory.parse(
                            reader));
                } // End of if for expected property start element
                ...
                try {
                    if (reader.isStartElement()) {
                        object.setStockageUnitaireRequestTypeChoice_type1(fr.cirtil.www.saeservice.StockageUnitaireRequestTypeChoice_type1.Factory.parse(
                                reader));
                    } // End of if for expected property start element
