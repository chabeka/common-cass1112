/**
 * ConsultationAffichableResponseType.java
 *
...
/**
 *  ConsultationAffichableResponseType bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ConsultationAffichableResponseType implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":consultationAffichableResponseType",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
        ...
        public static ConsultationAffichableResponseType parse(
            ...
            ConsultationAffichableResponseType object = new ConsultationAffichableResponseType();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"consultationAffichableResponseType".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ConsultationAffichableResponseType) fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
