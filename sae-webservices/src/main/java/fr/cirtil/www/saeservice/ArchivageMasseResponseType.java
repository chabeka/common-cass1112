...
@SuppressWarnings("all")
    ...
    public static class Factory{
        ...
        */
        public static ArchivageMasseResponseType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ArchivageMasseResponseType object =
                new ArchivageMasseResponseType();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"archivageMasseResponseType".equals(type)){
                                ...
                                return (ArchivageMasseResponseType)fr.cirtil.www.saeservice.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
