...
public class ConsultationResponse implements org.apache.axis2.databinding.ADBBean {
     ...
     */
    public void setConsultationResponse(
        fr.cirtil.www.saeservice.ConsultationResponseType param) {
    ...
    public static class Factory {
        ...
        public static ConsultationResponse parse(
            ...
            ConsultationResponse object = new ConsultationResponse();
                    ...
                    if (reader.isStartElement()) {
                        if (reader.isStartElement() &&
                                new javax.xml.namespace.QName(
                                    ...
                                    reader.getName())) {
                            object.setConsultationResponse(fr.cirtil.www.saeservice.ConsultationResponseType.Factory.parse(
                                    reader));
