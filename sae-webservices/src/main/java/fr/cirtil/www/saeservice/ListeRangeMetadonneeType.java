...
public class ListeRangeMetadonneeType implements org.apache.axis2.databinding.ADBBean {
  ...
  protected void validateRangeMetadonnee(
                                         final fr.cirtil.www.saeservice.RangeMetadonneeType[] param) {
  }
  ...
  public void addRangeMetadonnee(
    ...
    list.add(param);
    localRangeMetadonnee = (fr.cirtil.www.saeservice.RangeMetadonneeType[]) list.toArray(new fr.cirtil.www.saeservice.RangeMetadonneeType[list.size()]);
  }
