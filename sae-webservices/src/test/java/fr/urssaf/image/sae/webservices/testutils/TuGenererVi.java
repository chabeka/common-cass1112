...
public class TuGenererVi {
   ...
   public static final List<String> PAGM_OK_PING_SECURE = Arrays
         .asList("ROLE_TOUS;FULL");

   public static final List<String> PAGM_KO_PING_SECURE = Arrays
         .asList("ROLE_INCONNU;FULL");
   ...
   @Test
   @Ignore
   public void vi_failure_accessDenied() throws KeyStoreException,
         NoSuchAlgorithmException, CertificateException, IOException,
         URISyntaxException, NoSuchProviderException {
   ...
   private static void debugVi(Logger logger, Element vi) {
