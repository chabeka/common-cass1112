...
public interface SAEModificationService {
	 ...
	 *             Au moins une des métadonnées fournies n'est pas du bon type
	 *             ou du bon format
	 ...
	 * @param metadonnees
	 *            Metadonnées à controler
	 * @param trcPrefix
	 *            Trace prefixe
	 * @param actionUnitaire
	 *            action unitaire du service appelant
	 ...
	 */
	public List<StorageMetadata> controlerMetaDocumentModifie(UUID idArchive, List<UntypedMetadata> metadonnees,
			String trcPrefix, String actionUnitaire)
	 ...
	 * 
	 * @param document
	 *            Le documents à modifier (Metas modifiées et metas supprimées)
	 * @param metadonnees
	 *            Metadonnées à modifier
	 * @param trcPrefix
	 *            Trace prefixe
	 * @throws ModificationException
	 * 			@{@link ModificationException}
	 * @throws UpdateServiceEx
	 * 			@{@link UpdateServiceEx}
	 */
	public void modificationMetaDocument(StorageDocument document, String trcPrefix)
			throws ModificationException, UpdateServiceEx;

	/**
	 * Permet la séparation des metadonnées en 2 listes de metadonnées (metas à
	 * supprimer et metas à modifier)
	 * 
	 * @param idArchive
	 *            Identifiant du document
	 * @param listeStorageMetaDocument
	 *            Liste des metadonnées du document
	 * @param metadonnees
	 *            Liste de metadonnées à modifier ou supprimer
	 * @param trcPrefix
	 *            Prefix de trace
	 ...
	 * 			@{@link ModificationException}
	 */
	public StorageDocument separationMetaDocumentModifie(UUID idArchive, List<StorageMetadata> listeStorageMetaDocument,
			...
			NotModifiableMetadataEx, MetadataValueNotInDictionaryEx, ModificationException;
