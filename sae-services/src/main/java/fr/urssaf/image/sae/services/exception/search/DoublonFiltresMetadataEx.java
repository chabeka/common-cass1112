 ...
 * 
 */
public class DoublonFiltresMetadataEx extends Exception {
   private static final long serialVersionUID = 5812830110677764248L;

   /**
    * Construit une nouvelle {@link DoublonFiltresMetadataEx } avec un
    ...
    */
   public DoublonFiltresMetadataEx(final String message, final Throwable cause) {
      super(message, cause);
   }
    ...
    */
   public DoublonFiltresMetadataEx(final String message) {
      super(message);
   }
}