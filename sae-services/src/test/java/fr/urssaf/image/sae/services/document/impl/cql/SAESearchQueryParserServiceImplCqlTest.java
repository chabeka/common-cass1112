...
public class SAESearchQueryParserServiceImplCqlTest extends AbstractServiceCqlTest {
  ...
  private void parse(final SAESearchQueryParserResult attendu)
      throws SyntaxLuceneEx, SAESearchServiceEx,
      SAESearchQueryParseException {

    final SAESearchQueryParserResult obtenu = queryParseService
  ...
  SAESearchQueryParseException {
    ...
    final SAESearchQueryParserResult attendu = new SAESearchQueryParserResult();
